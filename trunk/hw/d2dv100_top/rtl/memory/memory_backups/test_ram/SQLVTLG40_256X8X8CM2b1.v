...
module SQLVTLG40_256X8X8CM2b1 (A,DO,DI,DVSE,DVS,WEB,CK,CSB);
  ...
  parameter  TOH                  = (7.7:10.7:16.6);  
  parameter  TOH_2                = (7.7:10.7:16.6);  
  parameter  TOH_3                = (7.7:10.7:16.6);  
  parameter  TOH_4                = (7.7:10.7:16.6);  
  parameter  TWDX                 = (7.7:10.7:16.6);  
  parameter  TWDX_2               = (7.7:10.7:16.6);  
  parameter  TWDX_3               = (7.7:10.7:16.6);  
  parameter  TWDX_4               = (7.7:10.7:16.6);  
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (27.7:41.3:72.1); 
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (39.1:58.9:95.7);
      specparam TAA_2  = (41.0:61.8:100.9);
      specparam TAA_3  = (39.1:58.9:95.7);
      specparam TAA_4  = (38.2:57.4:93.0);
      specparam TWDV    = (39.1:58.9:95.7);
      specparam TWDV_2  = (41.0:61.8:100.9);
      specparam TWDV_3  = (39.1:58.9:95.7);
      specparam TWDV_4  = (38.2:57.4:93.0);
      specparam TRC    = (27.7:41.3:72.1);
      specparam TRC_2    = (29.6:44.2:77.2);
      specparam TRC_3    = (27.7:41.3:72.1);
      specparam TRC_4    = (26.7:39.7:69.3);
      specparam THPW   = (6.9:10.3:18.0);
      specparam TLPW   = (6.9:10.3:18.0);
      specparam TAS    = (28.4:28.8:36.3);
      specparam TAH    = (12.0:15.0:22.1);
      specparam TWS    = (10.3:12.0:19.6);
      specparam TWH    = (12.0:15.0:22.1);
      specparam TDS    = (11.2:12.9:22.8);
      specparam TDH    = (11.2:14.3:20.8);
      specparam TCSS   = (28.4:28.8:36.3);
      specparam TCSH   = (15.3:24.2:42.2);
      specparam TDVSES  = (5.3:4.5:6.5);
      specparam TDVSEH  = (32.2:45.4:72.9);
      specparam TDVSS   = (5.3:4.5:6.5);
      specparam TDVSH   = (32.2:45.4:72.9);
