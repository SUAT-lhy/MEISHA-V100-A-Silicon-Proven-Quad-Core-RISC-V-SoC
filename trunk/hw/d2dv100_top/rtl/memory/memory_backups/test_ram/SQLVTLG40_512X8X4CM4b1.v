...
module SQLVTLG40_512X8X4CM4b1 (A,DO,DI,DVSE,DVS,WEB,CK,CSB);
  ...
  parameter  TOH                  = (7.8:10.8:16.9);  
  parameter  TOH_2                = (7.8:10.8:16.9);  
  parameter  TOH_3                = (7.8:10.8:16.9);  
  parameter  TOH_4                = (7.8:10.8:16.9);  
  parameter  TWDX                 = (7.8:10.8:16.9);  
  parameter  TWDX_2               = (7.8:10.8:16.9);  
  parameter  TWDX_3               = (7.8:10.8:16.9);  
  parameter  TWDX_4               = (7.8:10.8:16.9);  
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (27.4:40.6:70.7); 
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (41.0:61.0:97.6);
      specparam TAA_2  = (42.8:63.7:102.4);
      specparam TAA_3  = (41.0:61.0:97.6);
      specparam TAA_4  = (40.1:59.5:95.0);
      specparam TWDV    = (41.0:61.0:97.6);
      specparam TWDV_2  = (42.8:63.7:102.4);
      specparam TWDV_3  = (41.0:61.0:97.6);
      specparam TWDV_4  = (40.1:59.5:95.0);
      specparam TRC    = (27.4:40.6:70.7);
      specparam TRC_2    = (29.3:43.4:75.6);
      specparam TRC_3    = (27.4:40.6:70.7);
      specparam TRC_4    = (26.4:39.1:68.0);
      specparam THPW   = (6.9:10.2:17.7);
      specparam TLPW   = (6.9:10.2:17.7);
      specparam TAS    = (28.1:28.4:35.8);
      specparam TAH    = (11.9:15.0:21.8);
      specparam TWS    = (8.6:9.8:16.8);
      specparam TWH    = (11.9:15.0:21.8);
      specparam TDS    = (10.5:11.7:21.0);
      specparam TDH    = (11.7:15.0:21.6);
      specparam TCSS   = (28.1:28.4:35.8);
      specparam TCSH   = (15.0:23.9:42.1);
      specparam TDVSES  = (5.3:4.4:6.5);
      specparam TDVSEH  = (31.9:45.1:72.1);
      specparam TDVSS   = (5.3:4.4:6.5);
      specparam TDVSH   = (31.9:45.1:72.1);
