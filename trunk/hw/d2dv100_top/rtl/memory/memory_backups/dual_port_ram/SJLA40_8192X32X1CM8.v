...
module SJLA40_8192X32X1CM8 (DOA0,DOA1,DOA2,DOA3,DOA4,DOA5,DOA6,DOA7,DOA8,
                            ...
                            A2,A3,A4,A5,A6,A7,A8,A9,A10,A11,A12,B0,B1,B2,
                            B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,DIA0,DIA1,DIA2,
                            ...
                            DIB29,DIB30,DIB31,WEAN,WEBN,CSAN,CSBN,
                            CKA,DVSE,DVS0,DVS1,DVS2,DVS3,CKB,NAP);
  ...
  parameter  Tr2w                 = (193.5:336.2:692.5);
  parameter  Tw2r                 = (193.5:336.3:694.2);
  parameter  TOH                  = (167.8:287.9:617.3);
  parameter  TOH_1                = (207.4:361.2:782.6);
  parameter  TOH_2                = (167.8:287.9:617.3);
  parameter  TOH_3                = (148.8:253.7:542.6);
  parameter  TWDX                 = (92.0:185.5:437.4);
  parameter  TWDX_1               = (92.0:185.4:437.3);
  parameter  TWDX_2               = (92.0:185.5:437.4);
  parameter  TWDX_3               = (92.0:185.6:430.6);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (193.5:336.3:694.2);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (195.5:332.0:687.8);
      specparam TAA_1  = (233.9:402.8:844.9);
      specparam TAA_2  = (195.5:332.0:687.8);
      specparam TAA_3  = (175.8:295.2:606.3);
      specparam TWDV    = (144.8:328.3:617.8);
      specparam TWDV_1  = (144.8:386.7:616.7);
      specparam TWDV_2  = (144.8:328.3:617.8);
      specparam TWDV_3  = (144.8:291.8:596.8);
      specparam TRC  = (193.5:336.3:694.2);
      specparam TRC_1    = (232.6:408.0:855.9);
      specparam TRC_2    = (193.5:336.3:694.2);
      specparam TRC_3    = (173.6:299.0:610.4);
      specparam THPW = (23.1:32.3:45.1);
      specparam TLPW = (31.4:52.3:81.9);
      specparam TAS  = (12.5:23.2:41.9);
      specparam TAH  = (14.7:20.3:28.4);
      specparam TWS  = (16.3:26.4:42.0);
      specparam TWH  = (2.0:0.8:1.1);
      specparam TDS  = (4.9:9.8:20.7);
      specparam TDH  = (11.8:14.4:18.3);
      specparam TCSS = (23.3:39.7:65.2);
      specparam TCSH = (26.1:33.0:48.1);
      specparam TNAPH  = (16.9:30.9:53.5);
      specparam TNAP_CSH  = (135.1:214.5:340.2);
      specparam TDVSES  = (12.5:23.2:41.9);
      specparam TDVSEH  = (187.9:320.9:660.3);
      specparam TDVSS   = (12.5:23.2:41.9);
      specparam TDVSH   = (187.9:320.9:660.3);
