...
____________________________________________________________________________________________________________________
       ...
       Rom Code Version   :  A                                                                                      
       Rom Code Format    :  bin                                                                                    
       Rom Code File      :  /home/autumn/pdk/memory/ftclib/SPLB40_2048X32BM1b1A/SPLB40_2048X32BM1b1A_All0.romcode  
       Output Loading     :  0.3                                                                                    
...
module SPLB40_2048X32BM1b1A (A,DO,DVSE,DVS,CK,CS);
  `define    TRUE                 (1'b1)              
  `define    FALSE                (1'b0)              

  parameter  SYN_CS               = `TRUE;            
  parameter  NO_SER_TOH           = `FALSE;           
  parameter  ROMCODE              = "/home/autumn/pdk/memory/ftclib/SPLB40_2048X32BM1b1A/SPLB40_2048X32BM1b1A_All0.romcode";
  parameter  DVSize               = 4;                
