...
module SQLVTLG40_512X8X8CM4b1 (A,DO,DI,DVSE,DVS,VCC, GND, WEB,CK,CSB);
  ...
  parameter  TOH                  = (8.3:11.5:18.0);  
  parameter  TOH_2                = (8.3:11.5:18.0);  
  parameter  TOH_3                = (8.3:11.5:18.0);  
  parameter  TOH_4                = (8.3:11.5:18.0);  
  parameter  TWDX                 = (8.3:11.5:18.0);  
  parameter  TWDX_2               = (8.3:11.5:18.0);  
  parameter  TWDX_3               = (8.3:11.5:18.0);  
  parameter  TWDX_4               = (8.3:11.5:18.0);  
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (30.0:45.4:78.8); 
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (43.9:65.1:104.5);
      specparam TAA_2  = (45.7:68.1:109.9);
      specparam TAA_3  = (43.9:65.1:104.5);
      specparam TAA_4  = (43.4:64.3:103.0);
      specparam TWDV    = (43.9:65.1:104.5);
      specparam TWDV_2  = (45.7:68.1:109.9);
      specparam TWDV_3  = (43.9:65.1:104.5);
      specparam TWDV_4  = (43.4:64.3:103.0);
      specparam TRC    = (30.0:45.4:78.8);
      specparam TRC_2    = (31.9:48.5:84.3);
      specparam TRC_3    = (30.0:45.4:78.8);
      specparam TRC_4    = (29.5:44.6:77.3);
      specparam THPW   = (7.5:11.4:19.7);
      specparam TLPW   = (7.5:11.4:19.7);
      specparam TAS    = (28.1:28.4:35.8);
      specparam TAH    = (11.9:15.0:21.8);
      specparam TWS    = (9.3:10.8:18.4);
      specparam TWH    = (11.9:15.0:21.8);
      specparam TDS    = (10.3:11.4:20.5);
      specparam TDH    = (12.5:16.2:23.6);
      specparam TCSS   = (28.1:28.4:35.8);
      specparam TCSH   = (15.0:23.9:42.1);
      specparam TDVSES  = (5.3:4.4:6.6);
      specparam TDVSEH  = (38.0:52.8:83.2);
      specparam TDVSS   = (5.3:4.4:6.6);
      specparam TDVSH   = (38.0:52.8:83.2);
      ...
      if (NODELAY4 == 0 && con_dvs2 && read4)  (posedge CK => (DO[32] :1'bx)) = TAA_2;
      if (NODELAY4 == 0 && con_dvs2 && read4)  (posedge CK => (DO[33] :1'bx)) = TAA_2;
      if (NODELAY4 == 0 && con_dvs2 && read4)  (posedge CK => (DO[34] :1'bx)) = TAA_2;
      if (NODELAY4 == 0 && con_dvs2 && read4)  (posedge CK => (DO[35] :1'bx)) = TAA_2;
      if (NODELAY4 == 0 && con_dvs2 && read4)  (posedge CK => (DO[36] :1'bx)) = TAA_2;
      if (NODELAY4 == 0 && con_dvs2 && read4)  (posedge CK => (DO[37] :1'bx)) = TAA_2;
      if (NODELAY4 == 0 && con_dvs2 && read4)  (posedge CK => (DO[38] :1'bx)) = TAA_2;
      if (NODELAY4 == 0 && con_dvs2 && read4)  (posedge CK => (DO[39] :1'bx)) = TAA_2;
      ...
      if (NODELAY4 == 0 && con_dvs4 && read4)  (posedge CK => (DO[32] :1'bx)) = TAA_4;
      if (NODELAY4 == 0 && con_dvs4 && read4)  (posedge CK => (DO[33] :1'bx)) = TAA_4;
      if (NODELAY4 == 0 && con_dvs4 && read4)  (posedge CK => (DO[34] :1'bx)) = TAA_4;
      if (NODELAY4 == 0 && con_dvs4 && read4)  (posedge CK => (DO[35] :1'bx)) = TAA_4;
      if (NODELAY4 == 0 && con_dvs4 && read4)  (posedge CK => (DO[36] :1'bx)) = TAA_4;
      if (NODELAY4 == 0 && con_dvs4 && read4)  (posedge CK => (DO[37] :1'bx)) = TAA_4;
      if (NODELAY4 == 0 && con_dvs4 && read4)  (posedge CK => (DO[38] :1'bx)) = TAA_4;
      if (NODELAY4 == 0 && con_dvs4 && read4)  (posedge CK => (DO[39] :1'bx)) = TAA_4;
      ...
      if (NODELAY5 == 0 && con_dvs2 && read5)  (posedge CK => (DO[40] :1'bx)) = TAA_2;
      if (NODELAY5 == 0 && con_dvs2 && read5)  (posedge CK => (DO[41] :1'bx)) = TAA_2;
      if (NODELAY5 == 0 && con_dvs2 && read5)  (posedge CK => (DO[42] :1'bx)) = TAA_2;
      if (NODELAY5 == 0 && con_dvs2 && read5)  (posedge CK => (DO[43] :1'bx)) = TAA_2;
      if (NODELAY5 == 0 && con_dvs2 && read5)  (posedge CK => (DO[44] :1'bx)) = TAA_2;
      if (NODELAY5 == 0 && con_dvs2 && read5)  (posedge CK => (DO[45] :1'bx)) = TAA_2;
      if (NODELAY5 == 0 && con_dvs2 && read5)  (posedge CK => (DO[46] :1'bx)) = TAA_2;
      if (NODELAY5 == 0 && con_dvs2 && read5)  (posedge CK => (DO[47] :1'bx)) = TAA_2;
      ...
      if (NODELAY5 == 0 && con_dvs4 && read5)  (posedge CK => (DO[40] :1'bx)) = TAA_4;
      if (NODELAY5 == 0 && con_dvs4 && read5)  (posedge CK => (DO[41] :1'bx)) = TAA_4;
      if (NODELAY5 == 0 && con_dvs4 && read5)  (posedge CK => (DO[42] :1'bx)) = TAA_4;
      if (NODELAY5 == 0 && con_dvs4 && read5)  (posedge CK => (DO[43] :1'bx)) = TAA_4;
      if (NODELAY5 == 0 && con_dvs4 && read5)  (posedge CK => (DO[44] :1'bx)) = TAA_4;
      if (NODELAY5 == 0 && con_dvs4 && read5)  (posedge CK => (DO[45] :1'bx)) = TAA_4;
      if (NODELAY5 == 0 && con_dvs4 && read5)  (posedge CK => (DO[46] :1'bx)) = TAA_4;
      if (NODELAY5 == 0 && con_dvs4 && read5)  (posedge CK => (DO[47] :1'bx)) = TAA_4;
      ...
      if (NODELAY6 == 0 && con_dvs2 && read6)  (posedge CK => (DO[48] :1'bx)) = TAA_2;
      if (NODELAY6 == 0 && con_dvs2 && read6)  (posedge CK => (DO[49] :1'bx)) = TAA_2;
      if (NODELAY6 == 0 && con_dvs2 && read6)  (posedge CK => (DO[50] :1'bx)) = TAA_2;
      if (NODELAY6 == 0 && con_dvs2 && read6)  (posedge CK => (DO[51] :1'bx)) = TAA_2;
      if (NODELAY6 == 0 && con_dvs2 && read6)  (posedge CK => (DO[52] :1'bx)) = TAA_2;
      if (NODELAY6 == 0 && con_dvs2 && read6)  (posedge CK => (DO[53] :1'bx)) = TAA_2;
      if (NODELAY6 == 0 && con_dvs2 && read6)  (posedge CK => (DO[54] :1'bx)) = TAA_2;
      if (NODELAY6 == 0 && con_dvs2 && read6)  (posedge CK => (DO[55] :1'bx)) = TAA_2;
      ...
      if (NODELAY6 == 0 && con_dvs4 && read6)  (posedge CK => (DO[48] :1'bx)) = TAA_4;
      if (NODELAY6 == 0 && con_dvs4 && read6)  (posedge CK => (DO[49] :1'bx)) = TAA_4;
      if (NODELAY6 == 0 && con_dvs4 && read6)  (posedge CK => (DO[50] :1'bx)) = TAA_4;
      if (NODELAY6 == 0 && con_dvs4 && read6)  (posedge CK => (DO[51] :1'bx)) = TAA_4;
      if (NODELAY6 == 0 && con_dvs4 && read6)  (posedge CK => (DO[52] :1'bx)) = TAA_4;
      if (NODELAY6 == 0 && con_dvs4 && read6)  (posedge CK => (DO[53] :1'bx)) = TAA_4;
      if (NODELAY6 == 0 && con_dvs4 && read6)  (posedge CK => (DO[54] :1'bx)) = TAA_4;
      if (NODELAY6 == 0 && con_dvs4 && read6)  (posedge CK => (DO[55] :1'bx)) = TAA_4;
      ...
      if (NODELAY7 == 0 && con_dvs2 && read7)  (posedge CK => (DO[56] :1'bx)) = TAA_2;
      if (NODELAY7 == 0 && con_dvs2 && read7)  (posedge CK => (DO[57] :1'bx)) = TAA_2;
      if (NODELAY7 == 0 && con_dvs2 && read7)  (posedge CK => (DO[58] :1'bx)) = TAA_2;
      if (NODELAY7 == 0 && con_dvs2 && read7)  (posedge CK => (DO[59] :1'bx)) = TAA_2;
      if (NODELAY7 == 0 && con_dvs2 && read7)  (posedge CK => (DO[60] :1'bx)) = TAA_2;
      if (NODELAY7 == 0 && con_dvs2 && read7)  (posedge CK => (DO[61] :1'bx)) = TAA_2;
      if (NODELAY7 == 0 && con_dvs2 && read7)  (posedge CK => (DO[62] :1'bx)) = TAA_2;
      if (NODELAY7 == 0 && con_dvs2 && read7)  (posedge CK => (DO[63] :1'bx)) = TAA_2;
      ...
      if (NODELAY7 == 0 && con_dvs4 && read7)  (posedge CK => (DO[56] :1'bx)) = TAA_4;
      if (NODELAY7 == 0 && con_dvs4 && read7)  (posedge CK => (DO[57] :1'bx)) = TAA_4;
      if (NODELAY7 == 0 && con_dvs4 && read7)  (posedge CK => (DO[58] :1'bx)) = TAA_4;
      if (NODELAY7 == 0 && con_dvs4 && read7)  (posedge CK => (DO[59] :1'bx)) = TAA_4;
      if (NODELAY7 == 0 && con_dvs4 && read7)  (posedge CK => (DO[60] :1'bx)) = TAA_4;
      if (NODELAY7 == 0 && con_dvs4 && read7)  (posedge CK => (DO[61] :1'bx)) = TAA_4;
      if (NODELAY7 == 0 && con_dvs4 && read7)  (posedge CK => (DO[62] :1'bx)) = TAA_4;
      if (NODELAY7 == 0 && con_dvs4 && read7)  (posedge CK => (DO[63] :1'bx)) = TAA_4;
      ...
      if (NODELAY4 == 0 && con_dvs2 && write4)  (posedge CK => (DO[32] :1'bx)) = TWDV_2;
      if (NODELAY4 == 0 && con_dvs2 && write4)  (posedge CK => (DO[33] :1'bx)) = TWDV_2;
      if (NODELAY4 == 0 && con_dvs2 && write4)  (posedge CK => (DO[34] :1'bx)) = TWDV_2;
      if (NODELAY4 == 0 && con_dvs2 && write4)  (posedge CK => (DO[35] :1'bx)) = TWDV_2;
      if (NODELAY4 == 0 && con_dvs2 && write4)  (posedge CK => (DO[36] :1'bx)) = TWDV_2;
      if (NODELAY4 == 0 && con_dvs2 && write4)  (posedge CK => (DO[37] :1'bx)) = TWDV_2;
      if (NODELAY4 == 0 && con_dvs2 && write4)  (posedge CK => (DO[38] :1'bx)) = TWDV_2;
      if (NODELAY4 == 0 && con_dvs2 && write4)  (posedge CK => (DO[39] :1'bx)) = TWDV_2;
      ...
      if (NODELAY4 == 0 && con_dvs4 && write4)  (posedge CK => (DO[32] :1'bx)) = TWDV_4;
      if (NODELAY4 == 0 && con_dvs4 && write4)  (posedge CK => (DO[33] :1'bx)) = TWDV_4;
      if (NODELAY4 == 0 && con_dvs4 && write4)  (posedge CK => (DO[34] :1'bx)) = TWDV_4;
      if (NODELAY4 == 0 && con_dvs4 && write4)  (posedge CK => (DO[35] :1'bx)) = TWDV_4;
      if (NODELAY4 == 0 && con_dvs4 && write4)  (posedge CK => (DO[36] :1'bx)) = TWDV_4;
      if (NODELAY4 == 0 && con_dvs4 && write4)  (posedge CK => (DO[37] :1'bx)) = TWDV_4;
      if (NODELAY4 == 0 && con_dvs4 && write4)  (posedge CK => (DO[38] :1'bx)) = TWDV_4;
      if (NODELAY4 == 0 && con_dvs4 && write4)  (posedge CK => (DO[39] :1'bx)) = TWDV_4;
      ...
      if (NODELAY5 == 0 && con_dvs2 && write5)  (posedge CK => (DO[40] :1'bx)) = TWDV_2;
      if (NODELAY5 == 0 && con_dvs2 && write5)  (posedge CK => (DO[41] :1'bx)) = TWDV_2;
      if (NODELAY5 == 0 && con_dvs2 && write5)  (posedge CK => (DO[42] :1'bx)) = TWDV_2;
      if (NODELAY5 == 0 && con_dvs2 && write5)  (posedge CK => (DO[43] :1'bx)) = TWDV_2;
      if (NODELAY5 == 0 && con_dvs2 && write5)  (posedge CK => (DO[44] :1'bx)) = TWDV_2;
      if (NODELAY5 == 0 && con_dvs2 && write5)  (posedge CK => (DO[45] :1'bx)) = TWDV_2;
      if (NODELAY5 == 0 && con_dvs2 && write5)  (posedge CK => (DO[46] :1'bx)) = TWDV_2;
      if (NODELAY5 == 0 && con_dvs2 && write5)  (posedge CK => (DO[47] :1'bx)) = TWDV_2;
      ...
      if (NODELAY5 == 0 && con_dvs4 && write5)  (posedge CK => (DO[40] :1'bx)) = TWDV_4;
      if (NODELAY5 == 0 && con_dvs4 && write5)  (posedge CK => (DO[41] :1'bx)) = TWDV_4;
      if (NODELAY5 == 0 && con_dvs4 && write5)  (posedge CK => (DO[42] :1'bx)) = TWDV_4;
      if (NODELAY5 == 0 && con_dvs4 && write5)  (posedge CK => (DO[43] :1'bx)) = TWDV_4;
      if (NODELAY5 == 0 && con_dvs4 && write5)  (posedge CK => (DO[44] :1'bx)) = TWDV_4;
      if (NODELAY5 == 0 && con_dvs4 && write5)  (posedge CK => (DO[45] :1'bx)) = TWDV_4;
      if (NODELAY5 == 0 && con_dvs4 && write5)  (posedge CK => (DO[46] :1'bx)) = TWDV_4;
      if (NODELAY5 == 0 && con_dvs4 && write5)  (posedge CK => (DO[47] :1'bx)) = TWDV_4;
      ...
      if (NODELAY6 == 0 && con_dvs2 && write6)  (posedge CK => (DO[48] :1'bx)) = TWDV_2;
      if (NODELAY6 == 0 && con_dvs2 && write6)  (posedge CK => (DO[49] :1'bx)) = TWDV_2;
      if (NODELAY6 == 0 && con_dvs2 && write6)  (posedge CK => (DO[50] :1'bx)) = TWDV_2;
      if (NODELAY6 == 0 && con_dvs2 && write6)  (posedge CK => (DO[51] :1'bx)) = TWDV_2;
      if (NODELAY6 == 0 && con_dvs2 && write6)  (posedge CK => (DO[52] :1'bx)) = TWDV_2;
      if (NODELAY6 == 0 && con_dvs2 && write6)  (posedge CK => (DO[53] :1'bx)) = TWDV_2;
      if (NODELAY6 == 0 && con_dvs2 && write6)  (posedge CK => (DO[54] :1'bx)) = TWDV_2;
      if (NODELAY6 == 0 && con_dvs2 && write6)  (posedge CK => (DO[55] :1'bx)) = TWDV_2;
      ...
      if (NODELAY6 == 0 && con_dvs4 && write6)  (posedge CK => (DO[48] :1'bx)) = TWDV_4;
      if (NODELAY6 == 0 && con_dvs4 && write6)  (posedge CK => (DO[49] :1'bx)) = TWDV_4;
      if (NODELAY6 == 0 && con_dvs4 && write6)  (posedge CK => (DO[50] :1'bx)) = TWDV_4;
      if (NODELAY6 == 0 && con_dvs4 && write6)  (posedge CK => (DO[51] :1'bx)) = TWDV_4;
      if (NODELAY6 == 0 && con_dvs4 && write6)  (posedge CK => (DO[52] :1'bx)) = TWDV_4;
      if (NODELAY6 == 0 && con_dvs4 && write6)  (posedge CK => (DO[53] :1'bx)) = TWDV_4;
      if (NODELAY6 == 0 && con_dvs4 && write6)  (posedge CK => (DO[54] :1'bx)) = TWDV_4;
      if (NODELAY6 == 0 && con_dvs4 && write6)  (posedge CK => (DO[55] :1'bx)) = TWDV_4;
      ...
      if (NODELAY7 == 0 && con_dvs2 && write7)  (posedge CK => (DO[56] :1'bx)) = TWDV_2;
      if (NODELAY7 == 0 && con_dvs2 && write7)  (posedge CK => (DO[57] :1'bx)) = TWDV_2;
      if (NODELAY7 == 0 && con_dvs2 && write7)  (posedge CK => (DO[58] :1'bx)) = TWDV_2;
      if (NODELAY7 == 0 && con_dvs2 && write7)  (posedge CK => (DO[59] :1'bx)) = TWDV_2;
      if (NODELAY7 == 0 && con_dvs2 && write7)  (posedge CK => (DO[60] :1'bx)) = TWDV_2;
      if (NODELAY7 == 0 && con_dvs2 && write7)  (posedge CK => (DO[61] :1'bx)) = TWDV_2;
      if (NODELAY7 == 0 && con_dvs2 && write7)  (posedge CK => (DO[62] :1'bx)) = TWDV_2;
      if (NODELAY7 == 0 && con_dvs2 && write7)  (posedge CK => (DO[63] :1'bx)) = TWDV_2;
      ...
      if (NODELAY7 == 0 && con_dvs4 && write7)  (posedge CK => (DO[56] :1'bx)) = TWDV_4;
      if (NODELAY7 == 0 && con_dvs4 && write7)  (posedge CK => (DO[57] :1'bx)) = TWDV_4;
      if (NODELAY7 == 0 && con_dvs4 && write7)  (posedge CK => (DO[58] :1'bx)) = TWDV_4;
      if (NODELAY7 == 0 && con_dvs4 && write7)  (posedge CK => (DO[59] :1'bx)) = TWDV_4;
      if (NODELAY7 == 0 && con_dvs4 && write7)  (posedge CK => (DO[60] :1'bx)) = TWDV_4;
      if (NODELAY7 == 0 && con_dvs4 && write7)  (posedge CK => (DO[61] :1'bx)) = TWDV_4;
      if (NODELAY7 == 0 && con_dvs4 && write7)  (posedge CK => (DO[62] :1'bx)) = TWDV_4;
      if (NODELAY7 == 0 && con_dvs4 && write7)  (posedge CK => (DO[63] :1'bx)) = TWDV_4;
