...
(
    ...
    ,input           ram_ack_i
    ,input           ram_error_i
    ,input  [ WIDTH_DA-1:0]  ram_read_data_i
    ,output [  3:0]  ram_wr_o
    ,output          ram_rd_o
    //,output [  7:0]  ram_len_o
    ,output [ WIDTH_AD-1:0]  ram_addr_o
    ,output [ WIDTH_DA-1:0]  ram_write_data_o
);
...
(
    ...
    // Output
    .pop_i(resp_accept_w),
    .data_out_o(axi_rdata[WIDTH_DA-1:0]),
