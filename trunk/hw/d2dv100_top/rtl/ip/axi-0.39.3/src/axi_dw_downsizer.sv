...
module axi_dw_downsizer #(
  ...
  localparam TranIdWidth = `IDX_WIDTH_LOG2(AxiMaxReads);
            ...
            if ((idqueue_id == t) && idqueue_valid)
              ...
              if (!slv_r_valid_tran[t] || (slv_r_valid_tran[t] && slv_r_ready_tran[t])) begin
                ...
                if (mst_resp.r_valid) begin
                  automatic addr_t mst_port_offset = AxiMstPortStrbWidth == 1 ? '0 : r_req_q.ar.addr[`IDX_WIDTH_LOG2(AxiMstPortStrbWidth)-1:0];
                  automatic addr_t slv_port_offset = AxiSlvPortStrbWidth == 1 ? '0 : r_req_q.ar.addr[`IDX_WIDTH_LOG2(AxiSlvPortStrbWidth)-1:0];
      ...
      W_PASSTHROUGH, W_INCR_DOWNSIZE, W_SPLIT_INCR_DOWNSIZE: begin
        ...
        if (!w_req_q.aw_valid)
          if (slv_req_i.w_valid) begin
            automatic addr_t mst_port_offset = AxiMstPortStrbWidth == 1 ? '0 : w_req_q.aw.addr[`IDX_WIDTH_LOG2(AxiMstPortStrbWidth)-1:0];
            automatic addr_t slv_port_offset = AxiSlvPortStrbWidth == 1 ? '0 : w_req_q.aw.addr[`IDX_WIDTH_LOG2(AxiSlvPortStrbWidth)-1:0];
