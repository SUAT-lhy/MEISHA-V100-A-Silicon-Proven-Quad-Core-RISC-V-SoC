...
`endif
  ...
  wire  xbar_buffer_auto_out_a_ready;
  wire  xbar_buffer_auto_out_a_valid;
  wire [2:0] xbar_buffer_auto_out_a_bits_opcode;
  wire [2:0] xbar_buffer_auto_out_a_bits_param;
  wire [2:0] xbar_buffer_auto_out_a_bits_size;
  wire [6:0] xbar_buffer_auto_out_a_bits_source;
  wire [31:0] xbar_buffer_auto_out_a_bits_address;
  wire [7:0] xbar_buffer_auto_out_a_bits_mask;
  wire [63:0] xbar_buffer_auto_out_a_bits_data;
  wire  xbar_buffer_auto_out_a_bits_corrupt;
  wire  xbar_buffer_auto_out_c_ready;
  wire  xbar_buffer_auto_out_c_valid;
  wire [2:0] xbar_buffer_auto_out_c_bits_opcode;
  wire [2:0] xbar_buffer_auto_out_c_bits_param;
  wire [2:0] xbar_buffer_auto_out_c_bits_size;
  wire [6:0] xbar_buffer_auto_out_c_bits_source;
  wire [31:0] xbar_buffer_auto_out_c_bits_address;
  wire  xbar_buffer_auto_out_d_ready;
  wire  xbar_buffer_auto_out_d_valid;
  wire [2:0] xbar_buffer_auto_out_d_bits_opcode;
  wire [1:0] xbar_buffer_auto_out_d_bits_param;
  wire [2:0] xbar_buffer_auto_out_d_bits_size;
  wire [6:0] xbar_buffer_auto_out_d_bits_source;
  wire  xbar_buffer_auto_out_d_bits_denied;
  wire [63:0] xbar_buffer_auto_out_d_bits_data;
  wire  xbar_buffer_auto_out_d_bits_corrupt;
  wire  xbar_buffer_auto_out_e_ready;
  wire  xbar_buffer_auto_out_e_valid;
  wire  xbar_buffer_auto_out_e_bits_sink;

  wire        xbar_auto_in_b_ready;
  wire        xbar_auto_in_b_valid;
  wire [2:0]  xbar_auto_in_b_bits_opcode; 
  wire [1:0]  xbar_auto_in_b_bits_param;
  wire [2:0]  xbar_auto_in_b_bits_size;
  wire [7-1:0]  xbar_auto_in_b_bits_source;
  wire [32-1:0] xbar_auto_in_b_bits_address;
  wire [64/8-1:0]  xbar_auto_in_b_bits_mask; 
  wire        xbar_auto_in_b_bits_corrupt;
  wire       xbar_auto_in_c_bits_corrupt;

  wire [64-1:0]  xbar_auto_in_c_bits_data; 
  wire       xbar_auto_in_d_bits_sink;
  
  assign xbar_auto_in_c_bits_data = 64'b0;
  assign xbar_auto_in_c_bits_corrupt = 1'b0;
  assign xbar_auto_in_b_ready = 1'b0;


  wire        xbar_buffer_auto_out_b_ready;
  wire        xbar_buffer_auto_out_b_valid;
  wire [2:0]  xbar_buffer_auto_out_b_bits_opcode; 
  wire [1:0]  xbar_buffer_auto_out_b_bits_param;
  wire [2:0]  xbar_buffer_auto_out_b_bits_size;
  wire [7-1:0]  xbar_buffer_auto_out_b_bits_source;
  wire [32-1:0] xbar_buffer_auto_out_b_bits_address;
  wire [64/8-1:0]  xbar_buffer_auto_out_b_bits_mask; 
  wire        xbar_buffer_auto_out_b_bits_corrupt;
  wire        xbar_buffer_auto_out_d_bits_sink;
  wire [64-1:0]  xbar_buffer_auto_out_c_bits_data; 

  assign xbar_buffer_auto_out_b_valid = 1'b0;
  assign xbar_buffer_auto_out_b_bits_opcode = 3'b0;
  assign xbar_buffer_auto_out_b_bits_param = 2'b0;
  assign xbar_buffer_auto_out_b_bits_size = 3'b0;
  assign xbar_buffer_auto_out_b_bits_source = 7'b0;
  assign xbar_buffer_auto_out_b_bits_address = 32'b0;
  assign xbar_buffer_auto_out_b_bits_mask = 8'b0;
  assign xbar_buffer_auto_out_b_bits_corrupt = 1'b0;
  assign xbar_buffer_auto_out_d_bits_sink = 1'b0;
...
TLBuffer_param #(
    ...
    .SINK_WIDTH(1),
		.DATA_WIDTH(64)
) CHIPLINK_PREFIX_TLXbar_TLBuffer ( 
    .clock(xbar_clock),
    .reset(xbar_reset),
    ...
    .auto_in_b_bits_opcode(xbar_auto_in_b_bits_opcode),
    .auto_in_b_bits_param(xbar_auto_in_b_bits_param),
    .auto_in_b_bits_size(xbar_auto_in_b_bits_size),
    .auto_in_b_bits_source(xbar_auto_in_b_bits_source),
    .auto_in_b_bits_address(xbar_auto_in_b_bits_address),
    .auto_in_b_bits_mask(xbar_auto_in_b_bits_mask),
    .auto_in_b_bits_corrupt(xbar_auto_in_b_bits_corrupt),
    ...
    .auto_in_c_bits_data(xbar_auto_in_c_bits_data),
    ...
    .auto_out_a_ready(xbar_buffer_auto_out_a_ready),
    .auto_out_a_valid(xbar_buffer_auto_out_a_valid),
    .auto_out_a_bits_opcode(xbar_buffer_auto_out_a_bits_opcode),
    .auto_out_a_bits_param(xbar_buffer_auto_out_a_bits_param),
    .auto_out_a_bits_size(xbar_buffer_auto_out_a_bits_size),
    .auto_out_a_bits_source(xbar_buffer_auto_out_a_bits_source),
    .auto_out_a_bits_address(xbar_buffer_auto_out_a_bits_address),
    .auto_out_a_bits_mask(xbar_buffer_auto_out_a_bits_mask),
    .auto_out_a_bits_data(xbar_buffer_auto_out_a_bits_data),
    .auto_out_a_bits_corrupt(xbar_buffer_auto_out_a_bits_corrupt),
    .auto_out_b_ready(xbar_buffer_auto_out_b_ready),
    .auto_out_b_valid(xbar_buffer_auto_out_b_valid),
    .auto_out_b_bits_opcode(xbar_buffer_auto_out_b_bits_opcode),
    .auto_out_b_bits_param(xbar_buffer_auto_out_b_bits_param),
    .auto_out_b_bits_size(xbar_buffer_auto_out_b_bits_size),
    .auto_out_b_bits_source(xbar_buffer_auto_out_b_bits_source),
    .auto_out_b_bits_address(xbar_buffer_auto_out_b_bits_address),
    .auto_out_b_bits_mask(xbar_buffer_auto_out_b_bits_mask),
    .auto_out_b_bits_corrupt(xbar_buffer_auto_out_b_bits_corrupt),
    .auto_out_c_ready(xbar_buffer_auto_out_c_ready),
    .auto_out_c_valid(xbar_buffer_auto_out_c_valid),
    .auto_out_c_bits_opcode(xbar_buffer_auto_out_c_bits_opcode),
    .auto_out_c_bits_param(xbar_buffer_auto_out_c_bits_param),
    .auto_out_c_bits_size(xbar_buffer_auto_out_c_bits_size),
    .auto_out_c_bits_source(xbar_buffer_auto_out_c_bits_source),
    .auto_out_c_bits_address(xbar_buffer_auto_out_c_bits_address),
    .auto_out_c_bits_data(xbar_buffer_auto_out_c_bits_data),
    .auto_out_c_bits_corrupt(xbar_buffer_auto_out_c_bits_corrupt),
    .auto_out_d_ready(xbar_buffer_auto_out_d_ready),
    .auto_out_d_valid(xbar_buffer_auto_out_d_valid),
    .auto_out_d_bits_opcode(xbar_buffer_auto_out_d_bits_opcode),
    .auto_out_d_bits_param(xbar_buffer_auto_out_d_bits_param),
    .auto_out_d_bits_size(xbar_buffer_auto_out_d_bits_size),
    .auto_out_d_bits_source(xbar_buffer_auto_out_d_bits_source),
    .auto_out_d_bits_sink(xbar_buffer_auto_out_d_bits_sink),
    .auto_out_d_bits_denied(xbar_buffer_auto_out_d_bits_denied),
    .auto_out_d_bits_data(xbar_buffer_auto_out_d_bits_data),
    .auto_out_d_bits_corrupt(xbar_buffer_auto_out_d_bits_corrupt),
    .auto_out_e_ready(xbar_buffer_auto_out_e_ready),
    .auto_out_e_valid(xbar_buffer_auto_out_e_valid),
    .auto_out_e_bits_sink(xbar_buffer_auto_out_e_bits_sink)
  );
  ...
  CHIPLINK_PREFIX_TLXbar xbar (
    .clock(xbar_clock),
    .reset(xbar_reset),
    .auto_in_a_ready(xbar_buffer_auto_out_a_ready),
    .auto_in_a_valid(xbar_buffer_auto_out_a_valid),
    .auto_in_a_bits_opcode(xbar_buffer_auto_out_a_bits_opcode),
    .auto_in_a_bits_param(xbar_buffer_auto_out_a_bits_param),
    .auto_in_a_bits_size(xbar_buffer_auto_out_a_bits_size),
    .auto_in_a_bits_source(xbar_buffer_auto_out_a_bits_source),
    .auto_in_a_bits_address(xbar_buffer_auto_out_a_bits_address),
    .auto_in_a_bits_mask(xbar_buffer_auto_out_a_bits_mask),
    .auto_in_a_bits_data(xbar_buffer_auto_out_a_bits_data),
    .auto_in_a_bits_corrupt(xbar_buffer_auto_out_a_bits_corrupt),
    .auto_in_c_ready(xbar_buffer_auto_out_c_ready),
    .auto_in_c_valid(xbar_buffer_auto_out_c_valid),
    .auto_in_c_bits_opcode(xbar_buffer_auto_out_c_bits_opcode),
    .auto_in_c_bits_param(xbar_buffer_auto_out_c_bits_param),
    .auto_in_c_bits_size(xbar_buffer_auto_out_c_bits_size),
    .auto_in_c_bits_source(xbar_buffer_auto_out_c_bits_source),
    .auto_in_c_bits_address(xbar_buffer_auto_out_c_bits_address),
    .auto_in_d_ready(xbar_buffer_auto_out_d_ready),
    .auto_in_d_valid(xbar_buffer_auto_out_d_valid),
    .auto_in_d_bits_opcode(xbar_buffer_auto_out_d_bits_opcode),
    .auto_in_d_bits_param(xbar_buffer_auto_out_d_bits_param),
    .auto_in_d_bits_size(xbar_buffer_auto_out_d_bits_size),
    .auto_in_d_bits_source(xbar_buffer_auto_out_d_bits_source),
    .auto_in_d_bits_denied(xbar_buffer_auto_out_d_bits_denied),
    .auto_in_d_bits_data(xbar_buffer_auto_out_d_bits_data),
    .auto_in_d_bits_corrupt(xbar_buffer_auto_out_d_bits_corrupt),
    .auto_in_e_ready(xbar_buffer_auto_out_e_ready),
    .auto_in_e_valid(xbar_buffer_auto_out_e_valid),
    .auto_in_e_bits_sink(xbar_buffer_auto_out_e_bits_sink),
...
`else
 ...
 // CHIPLINK_PREFIX_AXI4IdIndexer axi4index (
  ...
  assign axi4index_auto_in_rid[4] = 1'b0;
  assign axi4index_auto_in_bid[4] = 1'b0;
  ...
  AXI4IdIndexer_Param #(
    ...
    .auto_in_awid(axi4index_auto_in_awid[3:0]),
    ...
    .auto_in_bid(axi4index_auto_in_bid[3:0]),
    ...
    .auto_in_arprot(3'b0),
    .auto_in_arid(axi4index_auto_in_arid[3:0]),
    ...
    .auto_in_rid(axi4index_auto_in_rid[3:0]),
