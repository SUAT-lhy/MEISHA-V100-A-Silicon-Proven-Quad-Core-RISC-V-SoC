...
`endif
  ...
  dont_touch_tc_clk_mux2 i_test_clk_mux(
...
// Helper Module to generate an N-input clock OR-gate from a tree of dont_touch_tc_clk_or2 cells.
module clk_or_tree #(
  ...
  `endif
    ...
    dont_touch_tc_clk_or2 i_clk_or2 (
      .clk0_i(clks_i[0]),
      .clk1_i(clks_i[1]),
      .clk_o
    );
