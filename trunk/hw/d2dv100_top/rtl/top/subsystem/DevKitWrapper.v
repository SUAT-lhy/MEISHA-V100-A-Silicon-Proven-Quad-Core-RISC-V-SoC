module DevKitWrapper( 
  ...
  output wire  corePLL_clk_out_cpu,
  ...
  output [12:0] auto_topMod_io_out_0_port_ddr3_addr, 
  output [1:0]  auto_topMod_io_out_0_port_ddr3_ba, 
  ...
  output [1:0]  auto_topMod_io_out_0_port_ddr3_dm, 
...
corePLL corePLL ( 
    ...
    .clk_out_ddr(corePLL_clk_out_ddr),
  ...
  ResetGenWrangler_FSM wrangler (
    ...
    .auto_in_ddr_clock(corePLL_clk_out_ddr),
  ...
  DevKitDesign topMod ( 
    ...
    .auto_io_out_0_port_ddr3_addr(auto_topMod_io_out_0_port_ddr3_addr),
    .auto_io_out_0_port_ddr3_ba(auto_topMod_io_out_0_port_ddr3_ba),
    .auto_io_out_0_port_ddr3_ras_n(auto_topMod_io_out_0_port_ddr3_ras_n),
    .auto_io_out_0_port_ddr3_cas_n(auto_topMod_io_out_0_port_ddr3_cas_n),
    .auto_io_out_0_port_ddr3_we_n(auto_topMod_io_out_0_port_ddr3_we_n),
    .auto_io_out_0_port_ddr3_reset_n(auto_topMod_io_out_0_port_ddr3_reset_n),
    .auto_io_out_0_port_ddr3_ck_p(auto_topMod_io_out_0_port_ddr3_ck_p),
    .auto_io_out_0_port_ddr3_ck_n(auto_topMod_io_out_0_port_ddr3_ck_n),
    .auto_io_out_0_port_ddr3_cke(auto_topMod_io_out_0_port_ddr3_cke),
    .auto_io_out_0_port_ddr3_cs_n(auto_topMod_io_out_0_port_ddr3_cs_n),
    .auto_io_out_0_port_ddr3_dm(auto_topMod_io_out_0_port_ddr3_dm),
    .auto_io_out_0_port_ddr3_odt(auto_topMod_io_out_0_port_ddr3_odt),
