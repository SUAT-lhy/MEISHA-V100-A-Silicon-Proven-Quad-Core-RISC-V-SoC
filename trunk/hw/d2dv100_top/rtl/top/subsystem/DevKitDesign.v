module DevKitDesign( 
  ...
  output [12:0] auto_io_out_0_port_ddr3_addr, 
  output [1:0]  auto_io_out_0_port_ddr3_ba, 
  ...
  output [1:0]  auto_io_out_0_port_ddr3_dm, 
  output        auto_io_out_0_port_ddr3_odt,
  input  [15:0] io_port_ddr3_dqs_i,
  output [15:0] io_port_ddr3_dqs_o,
  output        io_port_ddr3_dqs_o_en, 
  ...
  wire [31:0] reset_vector_msb_32_lsys_o;
  ...
  wire   [  31:0] sdram_start_delay;
  wire   [  31:0] sdram_refresh_cycles;
  wire   [  31:0] sdram_trcd_cycles;
  wire   [  31:0] sdram_trp_cycles;
  wire   [  31:0] sdram_trfc_cycles;
  ...
  wire tile_auto_intsink_in_sync_0_to_tile_clock;
  wire tile_1_auto_intsink_in_sync_0_to_tile_clock;
  wire tile_2_auto_intsink_in_sync_0_to_tile_clock;
  wire tile_3_auto_intsink_in_sync_0_to_tile_clock;
  ...
  wire [12:0] mig_io_port_ddr3_addr; 
  wire [1:0] mig_io_port_ddr3_ba; 
  ...
  syncReg #(
      .STAGES(2)
  ) u_debug_mode_config_latch_async (
      .clk_i(clock),
      .serial_i(debug_mode_config),
      .serial_o(debug_mode_config_sync)
  );

  IntSyncCrossingSource_3 intsource_dtm_int_0 ( 
    .clock(tile_clock),
    .reset(all_tile_async_rst),
    .auto_in_0(tile_auto_intsink_in_sync_0),
    .auto_out_sync_0(tile_auto_intsink_in_sync_0_to_tile_clock)
  );
  ...
  RocketTile tile ( 
    ...
    .clock(tile_clock),
    .reset(all_tile_async_rst),
    .auto_intsink_in_sync_0(tile_auto_intsink_in_sync_0_to_tile_clock),
  ...
  IntSyncCrossingSource_3 intsource_dtm_int_1 ( 
    .clock(tile_1_clock),
    .reset(all_tile_async_rst),
    .auto_in_0(tile_1_auto_intsink_in_sync_0),
    .auto_out_sync_0(tile_1_auto_intsink_in_sync_0_to_tile_clock)
  );
  ...
  RocketTile tile_1 ( 
    ...
    .clock(tile_1_clock),
    .reset(all_tile_async_rst),
    .auto_intsink_in_sync_0(tile_1_auto_intsink_in_sync_0_to_tile_clock),
  ...
  IntSyncCrossingSource_3 intsource_dtm_int_2 ( 
    .clock(tile_2_clock),
    .reset(all_tile_async_rst),
    .auto_in_0(tile_2_auto_intsink_in_sync_0),
    .auto_out_sync_0(tile_2_auto_intsink_in_sync_0_to_tile_clock)
  );
  ...
  RocketTile tile_2 ( 
    ...
    .clock(tile_2_clock),
    .reset(all_tile_async_rst),
    .auto_intsink_in_sync_0(tile_2_auto_intsink_in_sync_0_to_tile_clock),
  ...
  IntSyncCrossingSource_3 intsource_dtm_int_3 ( 
    .clock(tile_3_clock),
    .reset(all_tile_async_rst),
    .auto_in_0(tile_3_auto_intsink_in_sync_0),
    .auto_out_sync_0(tile_3_auto_intsink_in_sync_0_to_tile_clock)
  );
  ...
  RocketTile tile_3 ( 
    ...
    .clock(tile_3_clock),
    .reset(all_tile_async_rst),
    .auto_intsink_in_sync_0(tile_3_auto_intsink_in_sync_0_to_tile_clock),
  ...
  ResetCatchAndSync_d3 ddr_reset_ResetCatchAndSync_d3 ( 
    .clock(ddr_clock),
    .reset(ddr_reset|ddr_sft_rst),
    .io_sync_reset(ddr_async_rst)
  );
  ...
  //   if(!debug_mode_sel_latch) begin
  //     reset_vector_msb_32[31:0] <= 32'h1_0000;
  //   end
  //   else if(!debug_mode_config_sync) begin
  //     reset_vector_msb_32[31:0] <= 32'h8000_0000;
  //   end
  //   else begin
  //     reset_vector_msb_32[31:0] <= 32'h5000_0000;
  //   end
  // end

  assign reset_vector_msb_32[31:0] = debug_mode_sel_latch ? reset_vector_msb_32_lsys_o : 32'h1_0000;
  ...
  D2D_SUB d2d_sub (
    ...
    .reset_vector_msb_32(reset_vector_msb_32_lsys_o),
...
`ifndef USE_PCIE_CONTROLLER_SLAVE
  ...
  assign asource_1_auto_out_a_mem_0_opcode = 0; 
  assign asource_1_auto_out_a_mem_0_param = 0; 
  assign asource_1_auto_out_a_mem_0_size = 0; 
  assign asource_1_auto_out_a_mem_0_source = 0; 
  assign asource_1_auto_out_a_mem_0_address = 0; 
  assign asource_1_auto_out_a_mem_0_mask = 0; 
  assign asource_1_auto_out_a_mem_0_data = 0; 
  assign asource_1_auto_out_a_mem_0_corrupt = 1'b0; 
  assign asource_1_auto_out_a_mem_1_opcode = 0; 
  assign asource_1_auto_out_a_mem_1_param = 0; 
  assign asource_1_auto_out_a_mem_1_size = 0; 
  assign asource_1_auto_out_a_mem_1_source = 0; 
  assign asource_1_auto_out_a_mem_1_address = 0; 
  assign asource_1_auto_out_a_mem_1_mask = 0; 
  assign asource_1_auto_out_a_mem_1_data = 0; 
  assign asource_1_auto_out_a_mem_1_corrupt = 1'b0; 
  assign asource_1_auto_out_a_mem_2_opcode = 0; 
  assign asource_1_auto_out_a_mem_2_param = 0; 
  assign asource_1_auto_out_a_mem_2_size = 0; 
  assign asource_1_auto_out_a_mem_2_source = 0; 
  assign asource_1_auto_out_a_mem_2_address = 0; 
  assign asource_1_auto_out_a_mem_2_mask = 0; 
  assign asource_1_auto_out_a_mem_2_data = 0; 
  assign asource_1_auto_out_a_mem_2_corrupt = 1'b0; 
  assign asource_1_auto_out_a_mem_3_opcode = 0; 
  assign asource_1_auto_out_a_mem_3_param = 0; 
  assign asource_1_auto_out_a_mem_3_size = 0; 
  assign asource_1_auto_out_a_mem_3_source = 0; 
  assign asource_1_auto_out_a_mem_3_address = 0; 
  assign asource_1_auto_out_a_mem_3_mask = 0; 
  assign asource_1_auto_out_a_mem_3_data = 0; 
  assign asource_1_auto_out_a_mem_3_corrupt = 1'b0; 
  assign asource_1_auto_out_a_mem_4_opcode = 0; 
  assign asource_1_auto_out_a_mem_4_param = 0; 
  assign asource_1_auto_out_a_mem_4_size = 0; 
  assign asource_1_auto_out_a_mem_4_source = 0; 
  assign asource_1_auto_out_a_mem_4_address = 0; 
  assign asource_1_auto_out_a_mem_4_mask = 0; 
  assign asource_1_auto_out_a_mem_4_data = 0; 
  assign asource_1_auto_out_a_mem_4_corrupt = 1'b0; 
  assign asource_1_auto_out_a_mem_5_opcode = 0; 
  assign asource_1_auto_out_a_mem_5_param = 0; 
  assign asource_1_auto_out_a_mem_5_size = 0; 
  assign asource_1_auto_out_a_mem_5_source = 0; 
  assign asource_1_auto_out_a_mem_5_address = 0; 
  assign asource_1_auto_out_a_mem_5_mask = 0; 
  assign asource_1_auto_out_a_mem_5_data = 0; 
  assign asource_1_auto_out_a_mem_5_corrupt = 1'b0; 
  assign asource_1_auto_out_a_mem_6_opcode = 0; 
  assign asource_1_auto_out_a_mem_6_param = 0; 
  assign asource_1_auto_out_a_mem_6_size = 0; 
  assign asource_1_auto_out_a_mem_6_source = 0; 
  assign asource_1_auto_out_a_mem_6_address = 0; 
  assign asource_1_auto_out_a_mem_6_mask = 0; 
  assign asource_1_auto_out_a_mem_6_data = 0; 
  assign asource_1_auto_out_a_mem_6_corrupt = 1'b0; 
  assign asource_1_auto_out_a_mem_7_opcode = 0; 
  assign asource_1_auto_out_a_mem_7_param = 0; 
  assign asource_1_auto_out_a_mem_7_size = 0; 
  assign asource_1_auto_out_a_mem_7_source = 0; 
  assign asource_1_auto_out_a_mem_7_address = 0; 
  assign asource_1_auto_out_a_mem_7_mask = 0; 
  assign asource_1_auto_out_a_mem_7_data = 0; 
  assign asource_1_auto_out_a_mem_7_corrupt = 1'b0; 
  assign asource_1_auto_out_a_ridx = 0; 
  assign asource_1_auto_out_a_widx = 0; 
  assign asource_1_auto_out_a_safe_ridx_valid = 1'b0; 
  assign asource_1_auto_out_a_safe_widx_valid = 1'b0; 
  assign asource_1_auto_out_a_safe_source_reset_n = 1'b0; 
  assign asource_1_auto_out_a_safe_sink_reset_n = 1'b0; 
  assign asource_1_auto_out_d_mem_0_opcode = 0; 
  assign asource_1_auto_out_d_mem_0_param = 0; 
  assign asource_1_auto_out_d_mem_0_size = 0; 
  assign asource_1_auto_out_d_mem_0_source = 0; 
  assign asource_1_auto_out_d_mem_0_sink = 1'b0; 
  assign asource_1_auto_out_d_mem_0_denied = 1'b0; 
  assign asource_1_auto_out_d_mem_0_data = 0; 
  assign asource_1_auto_out_d_mem_0_corrupt = 1'b0; 
  assign asource_1_auto_out_d_mem_1_opcode = 0; 
  assign asource_1_auto_out_d_mem_1_param = 0; 
  assign asource_1_auto_out_d_mem_1_size = 0; 
  assign asource_1_auto_out_d_mem_1_source = 0; 
  assign asource_1_auto_out_d_mem_1_sink = 1'b0; 
  assign asource_1_auto_out_d_mem_1_denied = 1'b0; 
  assign asource_1_auto_out_d_mem_1_data = 0; 
  assign asource_1_auto_out_d_mem_1_corrupt = 1'b0; 
  assign asource_1_auto_out_d_mem_2_opcode = 0; 
  assign asource_1_auto_out_d_mem_2_param = 0; 
  assign asource_1_auto_out_d_mem_2_size = 0; 
  assign asource_1_auto_out_d_mem_2_source = 0; 
  assign asource_1_auto_out_d_mem_2_sink = 1'b0; 
  assign asource_1_auto_out_d_mem_2_denied = 1'b0; 
  assign asource_1_auto_out_d_mem_2_data = 0; 
  assign asource_1_auto_out_d_mem_2_corrupt = 1'b0; 
  assign asource_1_auto_out_d_mem_3_opcode = 0; 
  assign asource_1_auto_out_d_mem_3_param = 0; 
  assign asource_1_auto_out_d_mem_3_size = 0; 
  assign asource_1_auto_out_d_mem_3_source = 0; 
  assign asource_1_auto_out_d_mem_3_sink = 1'b0; 
  assign asource_1_auto_out_d_mem_3_denied = 1'b0; 
  assign asource_1_auto_out_d_mem_3_data = 0; 
  assign asource_1_auto_out_d_mem_3_corrupt = 1'b0; 
  assign asource_1_auto_out_d_mem_4_opcode = 0; 
  assign asource_1_auto_out_d_mem_4_param = 0; 
  assign asource_1_auto_out_d_mem_4_size = 0; 
  assign asource_1_auto_out_d_mem_4_source = 0; 
  assign asource_1_auto_out_d_mem_4_sink = 1'b0; 
  assign asource_1_auto_out_d_mem_4_denied = 1'b0; 
  assign asource_1_auto_out_d_mem_4_data = 0; 
  assign asource_1_auto_out_d_mem_4_corrupt = 1'b0; 
  assign asource_1_auto_out_d_mem_5_opcode = 0; 
  assign asource_1_auto_out_d_mem_5_param = 0; 
  assign asource_1_auto_out_d_mem_5_size = 0; 
  assign asource_1_auto_out_d_mem_5_source = 0; 
  assign asource_1_auto_out_d_mem_5_sink = 1'b0; 
  assign asource_1_auto_out_d_mem_5_denied = 1'b0; 
  assign asource_1_auto_out_d_mem_5_data = 0; 
  assign asource_1_auto_out_d_mem_5_corrupt = 1'b0; 
  assign asource_1_auto_out_d_mem_6_opcode = 0; 
  assign asource_1_auto_out_d_mem_6_param = 0; 
  assign asource_1_auto_out_d_mem_6_size = 0; 
  assign asource_1_auto_out_d_mem_6_source = 0; 
  assign asource_1_auto_out_d_mem_6_sink = 1'b0; 
  assign asource_1_auto_out_d_mem_6_denied = 1'b0; 
  assign asource_1_auto_out_d_mem_6_data = 0; 
  assign asource_1_auto_out_d_mem_6_corrupt = 1'b0; 
  assign asource_1_auto_out_d_mem_7_opcode = 0; 
  assign asource_1_auto_out_d_mem_7_param = 0; 
  assign asource_1_auto_out_d_mem_7_size = 0; 
  assign asource_1_auto_out_d_mem_7_source = 0; 
  assign asource_1_auto_out_d_mem_7_sink = 1'b0; 
  assign asource_1_auto_out_d_mem_7_denied = 1'b0; 
  assign asource_1_auto_out_d_mem_7_data = 0; 
  assign asource_1_auto_out_d_mem_7_corrupt = 1'b0; 
  assign asource_1_auto_out_d_ridx = 0; 
  assign asource_1_auto_out_d_safe_ridx_valid = 1'b0; 
  assign asource_1_auto_out_d_safe_sink_reset_n = 1'b0; 
  
  assign asource_1_auto_out_d_widx = 1'b0; 
  assign asource_1_auto_out_d_safe_widx_valid = 1'b0; 
  assign asource_1_auto_out_d_safe_source_reset_n = 1'b0; 
`else
...
`endif
  ...
  assign auto_io_out_1_port_axi_aclk_out = clock;   // pcie_io_port_axi_aclk_out use main clock
  ...
  assign intsource_clock = tile_clock;
  assign intsource_reset = all_tile_async_rst; 
  assign intsource_auto_in_0 = clint_auto_int_out_0_0; 
  assign intsource_auto_in_1 = clint_auto_int_out_0_1; 
  assign intsource_1_clock = tile_clock; 
  assign intsource_1_reset = all_tile_async_rst; 
  assign intsource_1_auto_in_0 = plic_auto_int_out_0_0; 
  assign intsource_2_clock = tile_clock; 
  assign intsource_2_reset = all_tile_async_rst; 
  ...
  assign intsource_3_clock = tile_1_clock; 
  assign intsource_3_reset = all_tile_async_rst; 
  assign intsource_3_auto_in_0 = clint_auto_int_out_1_0; 
  assign intsource_3_auto_in_1 = clint_auto_int_out_1_1; 
  assign intsource_4_clock = tile_1_clock; 
  assign intsource_4_reset = all_tile_async_rst; 
  assign intsource_4_auto_in_0 = plic_auto_int_out_2_0; 
  assign intsource_5_clock = tile_1_clock; 
  assign intsource_5_reset = all_tile_async_rst; 
  ...
  assign intsource_6_clock = tile_2_clock; 
  assign intsource_6_reset = all_tile_async_rst; 
  assign intsource_6_auto_in_0 = clint_auto_int_out_2_0; 
  assign intsource_6_auto_in_1 = clint_auto_int_out_2_1; 
  assign intsource_7_clock = tile_2_clock; 
  assign intsource_7_reset = all_tile_async_rst; 
  assign intsource_7_auto_in_0 = plic_auto_int_out_4_0; 
  assign intsource_8_clock = tile_2_clock; 
  assign intsource_8_reset = all_tile_async_rst; 
  ...
  assign intsource_9_clock = tile_3_clock; 
  assign intsource_9_reset = all_tile_async_rst; 
  assign intsource_9_auto_in_0 = clint_auto_int_out_3_0; 
  assign intsource_9_auto_in_1 = clint_auto_int_out_3_1; 
  assign intsource_10_clock = tile_3_clock; 
  assign intsource_10_reset = all_tile_async_rst; 
  assign intsource_10_auto_in_0 = plic_auto_int_out_6_0; 
  assign intsource_11_clock = tile_3_clock; 
  assign intsource_11_reset = all_tile_async_rst; 
