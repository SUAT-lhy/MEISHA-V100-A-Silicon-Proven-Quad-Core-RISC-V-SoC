...
TLBuffer_h_param #(
    ...
    .clock(buffer_clock),
    .reset(buffer_reset),
    .auto_in_a_ready(buffer_auto_in_0_a_ready),
    .auto_in_a_valid(buffer_auto_in_0_a_valid),
    .auto_in_a_bits_opcode(buffer_auto_in_0_a_bits_opcode),
    .auto_in_a_bits_param(buffer_auto_in_0_a_bits_param),
    .auto_in_a_bits_size(buffer_auto_in_0_a_bits_size),
    .auto_in_a_bits_source(buffer_auto_in_0_a_bits_source),
    .auto_in_a_bits_address(buffer_auto_in_0_a_bits_address),
    .auto_in_a_bits_mask(buffer_auto_in_0_a_bits_mask),
    .auto_in_a_bits_data(buffer_auto_in_0_a_bits_data),
    .auto_in_a_bits_corrupt(buffer_auto_in_0_a_bits_corrupt),
    .auto_in_d_ready(buffer_auto_in_0_d_ready),
    .auto_in_d_valid(buffer_auto_in_0_d_valid),
    .auto_in_d_bits_opcode(buffer_auto_in_0_d_bits_opcode),
    .auto_in_d_bits_param(buffer_auto_in_0_d_bits_param),
    .auto_in_d_bits_size(buffer_auto_in_0_d_bits_size),
    .auto_in_d_bits_source(buffer_auto_in_0_d_bits_source),
    .auto_in_d_bits_sink(buffer_auto_in_0_d_bits_sink),
    .auto_in_d_bits_denied(buffer_auto_in_0_d_bits_denied),
    .auto_in_d_bits_data(buffer_auto_in_0_d_bits_data),
    .auto_in_d_bits_corrupt(buffer_auto_in_0_d_bits_corrupt),
    .auto_out_a_ready(buffer_auto_out_0_a_ready),
    .auto_out_a_valid(buffer_auto_out_0_a_valid),
    .auto_out_a_bits_opcode(buffer_auto_out_0_a_bits_opcode),
    .auto_out_a_bits_param(buffer_auto_out_0_a_bits_param),
    .auto_out_a_bits_size(buffer_auto_out_0_a_bits_size),
    .auto_out_a_bits_source(buffer_auto_out_0_a_bits_source),
    .auto_out_a_bits_address(buffer_auto_out_0_a_bits_address),
    .auto_out_a_bits_mask(buffer_auto_out_0_a_bits_mask),
    .auto_out_a_bits_data(buffer_auto_out_0_a_bits_data),
    .auto_out_a_bits_corrupt(buffer_auto_out_0_a_bits_corrupt),
    .auto_out_d_ready(buffer_auto_out_0_d_ready),
    .auto_out_d_valid(buffer_auto_out_0_d_valid),
    .auto_out_d_bits_opcode(buffer_auto_out_0_d_bits_opcode),
    .auto_out_d_bits_param(buffer_auto_out_0_d_bits_param),
    .auto_out_d_bits_size(buffer_auto_out_0_d_bits_size),
    .auto_out_d_bits_source(buffer_auto_out_0_d_bits_source),
    .auto_out_d_bits_sink(buffer_auto_out_0_d_bits_sink),
    .auto_out_d_bits_denied(buffer_auto_out_0_d_bits_denied),
    .auto_out_d_bits_data(buffer_auto_out_0_d_bits_data),
    .auto_out_d_bits_corrupt(buffer_auto_out_0_d_bits_corrupt)
  );
...
TLBuffer_h_param #(
    ...
    .clock(buffer_clock),
    .reset(buffer_reset),
    .auto_in_a_ready(buffer_auto_in_1_a_ready),
    .auto_in_a_valid(buffer_auto_in_1_a_valid),
    .auto_in_a_bits_opcode(buffer_auto_in_1_a_bits_opcode),
    .auto_in_a_bits_param(buffer_auto_in_1_a_bits_param),
    .auto_in_a_bits_size(buffer_auto_in_1_a_bits_size),
    .auto_in_a_bits_source(buffer_auto_in_1_a_bits_source),
    .auto_in_a_bits_address(buffer_auto_in_1_a_bits_address),
    .auto_in_a_bits_mask(buffer_auto_in_1_a_bits_mask),
    .auto_in_a_bits_data(buffer_auto_in_1_a_bits_data),
    .auto_in_a_bits_corrupt(buffer_auto_in_1_a_bits_corrupt),
    .auto_in_d_ready(buffer_auto_in_1_d_ready),
    .auto_in_d_valid(buffer_auto_in_1_d_valid),
    .auto_in_d_bits_opcode(buffer_auto_in_1_d_bits_opcode),
    .auto_in_d_bits_param(buffer_auto_in_1_d_bits_param),
    .auto_in_d_bits_size(buffer_auto_in_1_d_bits_size),
    .auto_in_d_bits_source(buffer_auto_in_1_d_bits_source),
    .auto_in_d_bits_sink(buffer_auto_in_1_d_bits_sink),
    .auto_in_d_bits_denied(buffer_auto_in_1_d_bits_denied),
    .auto_in_d_bits_data(buffer_auto_in_1_d_bits_data),
    .auto_in_d_bits_corrupt(buffer_auto_in_1_d_bits_corrupt),
    .auto_out_a_ready(buffer_auto_out_1_a_ready),
    .auto_out_a_valid(buffer_auto_out_1_a_valid),
    .auto_out_a_bits_opcode(buffer_auto_out_1_a_bits_opcode),
    .auto_out_a_bits_param(buffer_auto_out_1_a_bits_param),
    .auto_out_a_bits_size(buffer_auto_out_1_a_bits_size),
    .auto_out_a_bits_source(buffer_auto_out_1_a_bits_source),
    .auto_out_a_bits_address(buffer_auto_out_1_a_bits_address),
    .auto_out_a_bits_mask(buffer_auto_out_1_a_bits_mask),
    .auto_out_a_bits_data(buffer_auto_out_1_a_bits_data),
    .auto_out_a_bits_corrupt(buffer_auto_out_1_a_bits_corrupt),
    .auto_out_d_ready(buffer_auto_out_1_d_ready),
    .auto_out_d_valid(buffer_auto_out_1_d_valid),
    .auto_out_d_bits_opcode(buffer_auto_out_1_d_bits_opcode),
    .auto_out_d_bits_param(buffer_auto_out_1_d_bits_param),
    .auto_out_d_bits_size(buffer_auto_out_1_d_bits_size),
    .auto_out_d_bits_source(buffer_auto_out_1_d_bits_source),
    .auto_out_d_bits_sink(buffer_auto_out_1_d_bits_sink),
    .auto_out_d_bits_denied(buffer_auto_out_1_d_bits_denied),
    .auto_out_d_bits_data(buffer_auto_out_1_d_bits_data),
    .auto_out_d_bits_corrupt(buffer_auto_out_1_d_bits_corrupt)
  );
