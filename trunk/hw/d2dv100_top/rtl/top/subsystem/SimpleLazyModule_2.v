module SimpleLazyModule_2( 
  ...
  wire [1-1:0]  buffer_auto_in_d_bits_sink; 
  wire        buffer_auto_in_d_bits_denied;
  wire        buffer_auto_in_d_bits_corrupt;

  wire [1:0]  buffer_auto_out_d_bits_param;
  wire [1-1:0]  buffer_auto_out_d_bits_sink; 
  wire        buffer_auto_out_d_bits_denied;
  wire        buffer_auto_out_d_bits_corrupt;


  assign buffer_auto_out_d_bits_param = 2'b0;
  assign buffer_auto_out_d_bits_sink = 1'b0; 
  assign buffer_auto_out_d_bits_denied = 1'b0;
  assign buffer_auto_out_d_bits_corrupt = 2'b0;
