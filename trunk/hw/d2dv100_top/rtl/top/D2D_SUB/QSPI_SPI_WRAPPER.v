...
#(
    ...
    parameter SPI_MASTER_AXI4_USER_WIDTH    = 1,
...
`endif
    ...
    wire                            s_axi_buf_out_awvalid;
    wire        [SPI_MASTER_AXI4_ID_WIDTH-1:0] s_axi_buf_out_awid;
    wire                      [7:0] s_axi_buf_out_awlen;
    wire   [SPI_MASTER_AXI4_ADDRESS_WIDTH-1:0] s_axi_buf_out_awaddr;
    wire      [SPI_MASTER_AXI4_USER_WIDTH-1:0] s_axi_buf_out_awuser;
    wire                           s_axi_buf_out_awready;

    wire                            s_axi_buf_out_wvalid;
    wire     [SPI_MASTER_AXI4_WDATA_WIDTH-1:0] s_axi_buf_out_wdata;
    wire   [SPI_MASTER_AXI4_WDATA_WIDTH/8-1:0] s_axi_buf_out_wstrb;
    wire                            s_axi_buf_out_wlast;
    wire      [SPI_MASTER_AXI4_USER_WIDTH-1:0] s_axi_buf_out_wuser;
    wire                           s_axi_buf_out_wready;

    wire                           s_axi_buf_out_bvalid;
    wire       [SPI_MASTER_AXI4_ID_WIDTH-1:0] s_axi_buf_out_bid;
    wire                     [1:0] s_axi_buf_out_bresp;
    wire     [SPI_MASTER_AXI4_USER_WIDTH-1:0] s_axi_buf_out_buser;
    wire                            s_axi_buf_out_bready;

    wire                            s_axi_buf_out_arvalid;
    wire        [SPI_MASTER_AXI4_ID_WIDTH-1:0] s_axi_buf_out_arid;
    wire                      [7:0] s_axi_buf_out_arlen;
    wire   [SPI_MASTER_AXI4_ADDRESS_WIDTH-1:0] s_axi_buf_out_araddr;
    wire      [SPI_MASTER_AXI4_USER_WIDTH-1:0] s_axi_buf_out_aruser;
    wire                           s_axi_buf_out_arready;

    wire                           s_axi_buf_out_rvalid;
    wire       [SPI_MASTER_AXI4_ID_WIDTH-1:0] s_axi_buf_out_rid;
    wire    [SPI_MASTER_AXI4_RDATA_WIDTH-1:0] s_axi_buf_out_rdata;
    wire                     [1:0] s_axi_buf_out_rresp;
    wire                           s_axi_buf_out_rlast;
    wire     [SPI_MASTER_AXI4_USER_WIDTH-1:0] s_axi_buf_out_ruser;
    wire                            s_axi_buf_out_rready;

    wire      [1:0]         s_axi_buf_out_awburst_unused;
    wire      [1:0]         s_axi_buf_out_arburst_unused;
    wire      [2:0]         s_axi_buf_out_awsize_unused;
    wire      [2:0]         s_axi_buf_out_arsize_unused;

  AXI4Buffer_Param #(
    .ADDR_WIDTH(SPI_MASTER_AXI4_ADDRESS_WIDTH),
    .DATA_WIDTH(SPI_MASTER_AXI4_RDATA_WIDTH),
    .ID_WIDTH(SPI_MASTER_AXI4_ID_WIDTH) 
  ) u_axi_spi_master_buf ( 
    .clock(axi_aclk),
    .reset(~axi_master_aresetn),
    .auto_in_awready(s_axi_awready),
    .auto_in_awvalid(s_axi_awvalid),
    .auto_in_awid({s_axi_awid}),
    .auto_in_awaddr(s_axi_awaddr),
    .auto_in_awlen(s_axi_awlen),
    .auto_in_awsize(3'b10),
    .auto_in_awburst(2'b01),
    .auto_in_wready(s_axi_wready),
    .auto_in_wvalid(s_axi_wvalid),
    .auto_in_wdata(s_axi_wdata),
    .auto_in_wstrb(s_axi_wstrb),
    .auto_in_wlast(s_axi_wlast),
    .auto_in_bready(s_axi_bready),
    .auto_in_bvalid(s_axi_bvalid),
    .auto_in_bid({s_axi_bid}),
    .auto_in_bresp(s_axi_bresp),
    .auto_in_arready(s_axi_arready),
    .auto_in_arvalid(s_axi_arvalid),
    .auto_in_arid({s_axi_arid}),
    .auto_in_araddr(s_axi_araddr),
    .auto_in_arlen(s_axi_arlen),
    .auto_in_arsize(3'b10),
    .auto_in_arburst(2'b01),
    .auto_in_rready(s_axi_rready),
    .auto_in_rvalid(s_axi_rvalid),
    .auto_in_rid({s_axi_rid}),
    .auto_in_rdata(s_axi_rdata),
    .auto_in_rresp(s_axi_rresp),
    .auto_in_rlast(s_axi_rlast),
    .auto_out_awready(s_axi_buf_out_awready),
    .auto_out_awvalid(s_axi_buf_out_awvalid),
    .auto_out_awid({s_axi_buf_out_awid}),
    .auto_out_awaddr(s_axi_buf_out_awaddr),
    .auto_out_awlen(s_axi_buf_out_awlen),
    .auto_out_awsize(s_axi_buf_out_awsize_unused),
    .auto_out_awburst(s_axi_buf_out_awburst_unused),
    .auto_out_wready(s_axi_buf_out_wready),
    .auto_out_wvalid(s_axi_buf_out_wvalid),
    .auto_out_wdata(s_axi_buf_out_wdata),
    .auto_out_wstrb(s_axi_buf_out_wstrb),
    .auto_out_wlast(s_axi_buf_out_wlast),
    .auto_out_bready(s_axi_buf_out_bready),
    .auto_out_bvalid(s_axi_buf_out_bvalid),
    .auto_out_bid({s_axi_buf_out_bid}),
    .auto_out_bresp(s_axi_buf_out_bresp),
    .auto_out_arready(s_axi_buf_out_arready),
    .auto_out_arvalid(s_axi_buf_out_arvalid),
    .auto_out_arid({s_axi_buf_out_arid}),
    .auto_out_araddr(s_axi_buf_out_araddr),
    .auto_out_arlen(s_axi_buf_out_arlen),
    .auto_out_arsize(s_axi_buf_out_arsize_unused),
    .auto_out_arburst(s_axi_buf_out_arburst_unused),
    .auto_out_rready(s_axi_buf_out_rready),
    .auto_out_rvalid(s_axi_buf_out_rvalid),
    .auto_out_rid({s_axi_buf_out_rid}),
    .auto_out_rdata(s_axi_buf_out_rdata),
    .auto_out_rresp(s_axi_buf_out_rresp),
    .auto_out_rlast(s_axi_buf_out_rlast)
  );

  assign s_axi_buf_out_wuser = 1'b0;
  assign s_axi_buf_out_awuser = 1'b0;
  assign s_axi_buf_out_aruser = 1'b0;
...
axi_spi_master #(
  ...
  `ifndef USE_PCIE_CONTROLLER_SLAVE
    ...
    .s_axi_awvalid(s_axi_buf_out_awvalid),
    .s_axi_awid(s_axi_buf_out_awid),
    .s_axi_awlen(s_axi_buf_out_awlen),
    .s_axi_awaddr(s_axi_buf_out_awaddr),
    .s_axi_awuser(s_axi_buf_out_awuser),
    .s_axi_awready(s_axi_buf_out_awready),

    .s_axi_wvalid(s_axi_buf_out_wvalid),
    .s_axi_wdata(s_axi_buf_out_wdata),
    .s_axi_wstrb(s_axi_buf_out_wstrb),
    .s_axi_wlast(s_axi_buf_out_wlast),
    .s_axi_wuser(s_axi_buf_out_wuser),
    .s_axi_wready(s_axi_buf_out_wready),

    .s_axi_bvalid(s_axi_buf_out_bvalid),
    .s_axi_bid(s_axi_buf_out_bid),
    .s_axi_bresp(s_axi_buf_out_bresp),
    .s_axi_buser(s_axi_buf_out_buser),
    .s_axi_bready(s_axi_buf_out_bready),

    .s_axi_arvalid(s_axi_buf_out_arvalid),
    .s_axi_arid(s_axi_buf_out_arid),
    .s_axi_arlen(s_axi_buf_out_arlen),
    .s_axi_araddr(s_axi_buf_out_araddr),
    .s_axi_aruser(s_axi_buf_out_aruser),
    .s_axi_arready(s_axi_buf_out_arready),

    .s_axi_rvalid(s_axi_buf_out_rvalid),
    .s_axi_rid(s_axi_buf_out_rid),
    .s_axi_rdata(s_axi_buf_out_rdata),
    .s_axi_rresp(s_axi_buf_out_rresp),
    .s_axi_rlast(s_axi_buf_out_rlast),
    .s_axi_ruser(s_axi_buf_out_ruser),
    .s_axi_rready(s_axi_buf_out_rready)
