module D2D_SUB( 
  ...
  output wire mig_input_takeover_en,
   ...
   output  [  31:0] sdram_start_delay
  ,output  [  31:0] sdram_refresh_cycles
  ,output  [  31:0] sdram_trcd_cycles
  ,output  [  31:0] sdram_trp_cycles
  ,output  [  31:0] sdram_trfc_cycles,

  output wire [15:0] tl_master_xing_in_d_bits_resp_control,
  input wire debug_mode_config_sync,
  ...
  output        io_port_mmcm_lock 
    ...
    localparam master_bus_indexer_AXI4_ID_WIDTH      = 10;

  wire        io_port_axi_aclk_out;
  wire  spi_1_sft_rst;
  wire  spi_slave_sft_rst;
  wire  soc_iram_sft_rst;
  wire  soc_lsys_sft_rst;
  wire  nvdla_core_sft_rst;
  wire  [15:0] nvdla_other_cfg;
  wire  nvdla_csb_sft_rst;
  wire  dla_intr;
  ...
  wire [7:0] qspi_master_out_r_id;
  wire [63:0] qspi_master_out_r_data; 
  wire [1:0] qspi_master_out_r_resp; 
  wire  qspi_master_out_r_last; 

  wire  nvdla_master_out_aw_ready; 
  wire  nvdla_master_out_aw_valid; 
  wire [31:0] nvdla_master_out_aw_addr; 
  wire [3:0] nvdla_master_out_aw_len; 
  wire [2:0] nvdla_master_out_aw_size; 
  wire [1:0] nvdla_master_out_aw_burst;
  wire [7:0] nvdla_master_out_aw_id; 

  wire [2:0] nvdla_master_out_aw_prot;
  wire [3:0] nvdla_master_out_aw_region;
  wire [3:0] nvdla_master_out_aw_cache;
  wire [3:0] nvdla_master_out_aw_qos;

  wire [2:0] nvdla_master_out_ar_prot;
  wire [3:0] nvdla_master_out_ar_region;
  wire [3:0] nvdla_master_out_ar_cache;
  wire [3:0] nvdla_master_out_ar_qos;
  wire [7:0] nvdla_master_out_ar_id;

  wire  nvdla_master_out_w_ready; 
  wire  nvdla_master_out_w_valid; 
  wire [63:0] nvdla_master_out_w_data; 
  wire [7:0] nvdla_master_out_w_strb; 
  wire  nvdla_master_out_w_last; 
  wire  nvdla_master_out_b_ready; 
  wire  nvdla_master_out_b_valid; 
  wire [1:0] nvdla_master_out_b_resp; 
  wire [7:0] nvdla_master_out_b_id;
  wire  nvdla_master_out_ar_ready; 
  wire  nvdla_master_out_ar_valid; 
  wire [31:0] nvdla_master_out_ar_addr; 
  wire [3:0] nvdla_master_out_ar_len; 
  wire [2:0] nvdla_master_out_ar_size; 
  wire [1:0] nvdla_master_out_ar_burst; 
  wire  nvdla_master_out_r_ready; 
  wire  nvdla_master_out_r_valid; 
  wire [7:0] nvdla_master_out_r_id;
  wire [63:0] nvdla_master_out_r_data; 
  wire [1:0] nvdla_master_out_r_resp; 
  wire  nvdla_master_out_r_last; 


  assign nvdla_master_out_aw_burst = 3'b001;
  assign nvdla_master_out_aw_size = 3'b011;
  assign nvdla_master_out_aw_prot = 3'b0;
  assign nvdla_master_out_aw_region = 4'b0;
  assign nvdla_master_out_aw_cache = 4'b0;
  assign nvdla_master_out_aw_qos = 4'h0;

  assign nvdla_master_out_ar_burst = 3'b001;
  assign nvdla_master_out_ar_size = 3'b011;
  assign nvdla_master_out_ar_prot = 3'b0;
  assign nvdla_master_out_ar_region = 4'b0;
  assign nvdla_master_out_ar_cache = 4'b0;
  assign nvdla_master_out_ar_qos = 4'h0;
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4yank_2_auto_in_aw_bits_echo_extra_id; 
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4yank_2_auto_in_b_bits_echo_extra_id;
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4yank_2_auto_in_ar_bits_echo_extra_id;
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4yank_2_auto_in_r_bits_echo_extra_id;
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4frag_auto_out_awecho_extra_id; 
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4frag_auto_out_becho_extra_id;
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4frag_auto_out_arecho_extra_id; 
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4frag_auto_out_recho_extra_id; 
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4frag_axi4yank_master_bus_awecho_extra_id; 
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4frag_axi4yank_master_bus_becho_extra_id;
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4frag_axi4yank_master_bus_arecho_extra_id; 
  ...
  wire [master_bus_indexer_AXI4_ID_WIDTH-2:0] axi4frag_axi4yank_master_bus_recho_extra_id; 
  ...
  wire  ibufds_gte2_O; 
   ...
   // wire logic   [SPI_MASTER_AXI4_USER_WIDTH-1:0] spi_master_s_axi_ruser;
    ...
    localparam NVDLA_SLAVE_AXI4_ADDRESS_WIDTH = 28;
    localparam NVDLA_SLAVE_AXI4_RDATA_WIDTH   = 64;
    localparam NVDLA_SLAVE_AXI4_WDATA_WIDTH   = 64;
    localparam NVDLA_SLAVE_AXI4_USER_WIDTH    = 1;
    localparam NVDLA_SLAVE_AXI4_ID_WIDTH      = 5;
    localparam NVDLA_SLAVE_BUFFER_DEPTH       = 8;

    wire  logic                          nvdla_slave_s_axi_awvalid;
    wire  logic      [NVDLA_SLAVE_AXI4_ID_WIDTH-1:0] nvdla_slave_s_axi_awid;
    wire  logic                    [7:0] nvdla_slave_s_axi_awlen;
    wire  logic                    [1:0] nvdla_slave_s_axi_awburst;
    wire  logic                    [2:0] nvdla_slave_s_axi_awsize;
    wire  logic                          nvdla_slave_s_axi_awlock;
    wire  logic [NVDLA_SLAVE_AXI4_ADDRESS_WIDTH-1:0] nvdla_slave_s_axi_awaddr;
    //wire  logic    [NVDLA_SLAVE_AXI4_USER_WIDTH-1:0] nvdla_slave_s_axi_awuser;
    wire logic                          nvdla_slave_s_axi_awready;

    wire  logic                          nvdla_slave_s_axi_wvalid;
    wire  logic   [NVDLA_SLAVE_AXI4_WDATA_WIDTH-1:0] nvdla_slave_s_axi_wdata;
    wire  logic [NVDLA_SLAVE_AXI4_WDATA_WIDTH/8-1:0] nvdla_slave_s_axi_wstrb;
    wire  logic                          nvdla_slave_s_axi_wlast;
    //wire  logic    [NVDLA_SLAVE_AXI4_USER_WIDTH-1:0] nvdla_slave_s_axi_wuser;
    wire logic                          nvdla_slave_s_axi_wready;

    wire logic                          nvdla_slave_s_axi_bvalid;
    wire logic      [NVDLA_SLAVE_AXI4_ID_WIDTH-1:0] nvdla_slave_s_axi_bid;
    wire logic                    [1:0] nvdla_slave_s_axi_bresp;
    //wire logic    [NVDLA_SLAVE_AXI4_USER_WIDTH-1:0] nvdla_slave_s_axi_buser;
    wire  logic                          nvdla_slave_s_axi_bready;

    wire  logic                          nvdla_slave_s_axi_arvalid;
    wire  logic      [NVDLA_SLAVE_AXI4_ID_WIDTH-1:0] nvdla_slave_s_axi_arid;
    wire  logic                    [7:0] nvdla_slave_s_axi_arlen;
    wire  logic                    [1:0] nvdla_slave_s_axi_arburst;
    wire  logic                    [2:0] nvdla_slave_s_axi_arsize;
    wire  logic                          nvdla_slave_s_axi_arlock;
    wire  logic [NVDLA_SLAVE_AXI4_ADDRESS_WIDTH-1:0] nvdla_slave_s_axi_araddr;
    //wire  logic    [NVDLA_SLAVE_AXI4_USER_WIDTH-1:0] nvdla_slave_s_axi_aruser;
    wire logic                          nvdla_slave_s_axi_arready;

    wire logic                          nvdla_slave_s_axi_rvalid;
    wire logic   [NVDLA_SLAVE_AXI4_ID_WIDTH-1:0] nvdla_slave_s_axi_rid;
    wire logic   [NVDLA_SLAVE_AXI4_RDATA_WIDTH-1:0] nvdla_slave_s_axi_rdata;
    wire logic                    [1:0] nvdla_slave_s_axi_rresp;
    wire logic                          nvdla_slave_s_axi_rlast;
   // wire logic   [NVDLA_SLAVE_AXI4_USER_WIDTH-1:0] nvdla_slave_s_axi_ruser;
    wire  logic                          nvdla_slave_s_axi_rready;
  ...
  //--------------------------------------------------------------
    ...
    assign axi_to_pcie_x1_io_port_axi_aclk_out = main_clock; 
    assign axi_to_pcie_x1_io_port_axi_aresetn = ~main_reset; 
    ...
    assign ddr_master_0_araddr_override = chiplink_master_addr_msb_16[15] ? {chiplink_master_addr_msb_16[3:0]} : ddr_master_0_araddr[31:28];
    ...
    wire [31:0] nvdla_slave_s_paddr;
    wire        nvdla_slave_s_penable;
    wire        nvdla_slave_s_pwrite;
    wire [31:0] nvdla_slave_s_pwdata;
    wire [3:0]  nvdla_slave_s_pstrb;
    wire [3:0]  nvdla_slave_s_pprot;
    wire [31:0] nvdla_slave_s0_prdata;
    wire        nvdla_slave_s0_psel;
    wire        nvdla_slave_s0_pready;
    wire        nvdla_slave_s0_pslverr;
    
    wire [31:0] nvdla_slave_s1_prdata;
    wire        nvdla_slave_s1_psel;
    wire        nvdla_slave_s1_pready;
    wire        nvdla_slave_s1_pslverr;
    
    wire [31:0] nvdla_slave_s2_prdata;
    wire        nvdla_slave_s2_psel;
    wire        nvdla_slave_s2_pready;
    wire        nvdla_slave_s2_pslverr;
    
    
    assign nvdla_slave_s0_pslverr = 1'b0;
    assign nvdla_slave_s1_pslverr = 1'b0;
    assign nvdla_slave_s1_prdata = 32'b0;
    assign nvdla_slave_s1_pready = 1'b1;
    
    assign nvdla_slave_s2_pslverr = 1'b0;
    assign nvdla_slave_s2_prdata = 32'b0;
    assign nvdla_slave_s2_pready = 1'b1;


  wire  nvdla_core_async_rst;
  ResetCatchAndSync_d3 nvdla_core_reset_ResetCatchAndSync_d3 ( 
    .clock(tile_clock),
    .reset(tile_reset|nvdla_core_sft_rst),
    .io_sync_reset(nvdla_core_async_rst)
  );

  wire  nvdla_csb_async_rst;
  ResetCatchAndSync_d3 nvdla_csb_reset_ResetCatchAndSync_d3 ( 
    .clock(main_clock),
    .reset(main_reset|nvdla_csb_sft_rst),
    .io_sync_reset(nvdla_csb_async_rst)
  );


  wire  nvdla_master_out_x2x_aw_ready; 
  wire  nvdla_master_out_x2x_aw_valid; 
  wire [31:0] nvdla_master_out_x2x_aw_addr; 
  wire [3:0] nvdla_master_out_x2x_aw_len; 
  wire [2:0] nvdla_master_out_x2x_aw_size; 
  wire [1:0] nvdla_master_out_x2x_aw_burst;
  wire [7:0] nvdla_master_out_x2x_aw_id; 

  wire [2:0] nvdla_master_out_x2x_aw_prot;
  wire [3:0] nvdla_master_out_x2x_aw_region;
  wire [3:0] nvdla_master_out_x2x_aw_cache;
  wire [3:0] nvdla_master_out_x2x_aw_qos;

  wire [2:0] nvdla_master_out_x2x_ar_prot;
  wire [3:0] nvdla_master_out_x2x_ar_region;
  wire [3:0] nvdla_master_out_x2x_ar_cache;
  wire [3:0] nvdla_master_out_x2x_ar_qos;
  wire [7:0] nvdla_master_out_x2x_ar_id;

  wire  nvdla_master_out_x2x_w_ready; 
  wire  nvdla_master_out_x2x_w_valid; 
  wire [63:0] nvdla_master_out_x2x_w_data; 
  wire [7:0] nvdla_master_out_x2x_w_strb; 
  wire  nvdla_master_out_x2x_w_last; 
  wire  nvdla_master_out_x2x_b_ready; 
  wire  nvdla_master_out_x2x_b_valid; 
  wire [1:0] nvdla_master_out_x2x_b_resp; 
  wire [7:0] nvdla_master_out_x2x_b_id;
  wire  nvdla_master_out_x2x_ar_ready; 
  wire  nvdla_master_out_x2x_ar_valid; 
  wire [31:0] nvdla_master_out_x2x_ar_addr;
  wire [3:0] nvdla_master_out_x2x_ar_len; 
  wire [2:0] nvdla_master_out_x2x_ar_size; 
  wire [1:0] nvdla_master_out_x2x_ar_burst; 
  wire  nvdla_master_out_x2x_r_ready; 
  wire  nvdla_master_out_x2x_r_valid; 
  wire [7:0] nvdla_master_out_x2x_r_id;
  wire [63:0] nvdla_master_out_x2x_r_data; 
  wire [1:0] nvdla_master_out_x2x_r_resp; 
  wire  nvdla_master_out_x2x_r_last; 


  // assign nvdla_master_out_x2x_aw_burst = 3'b001;
  // assign nvdla_master_out_x2x_aw_size = 3'b011;
  // assign nvdla_master_out_x2x_aw_prot = 3'b0;
  // assign nvdla_master_out_x2x_aw_region = 4'b0;
  // assign nvdla_master_out_x2x_aw_cache = 4'b0;
  // assign nvdla_master_out_x2x_aw_qos = 4'h0;

  // assign nvdla_master_out_x2x_ar_burst = 3'b001;
  // assign nvdla_master_out_x2x_ar_size = 3'b011;
  // assign nvdla_master_out_x2x_ar_prot = 3'b0;
  // assign nvdla_master_out_x2x_ar_region = 4'b0;
  // assign nvdla_master_out_x2x_ar_cache = 4'b0;
  // assign nvdla_master_out_x2x_ar_qos = 4'h0;
  ...
  axi4_async_bridge #(
		...
		,.WIDTH_ADDRESS(32)
		,.WIDTH_DATA(64)
  ) u_nvdla_master_axi4_async_bridge (

		.s_clk(tile_clock),
    .s_reset_n(~tile_reset),
		.m_clk(main_clock),
    .m_reset_n(~main_reset),
		//
		.s_awready(nvdla_master_out_aw_ready),
		.s_awvalid(nvdla_master_out_aw_valid),
		`ifdef AXI_HAVE_USER
		.s_awuser(nvdla_master_out_aw_user),
    `endif
		.s_awsize(nvdla_master_out_aw_size),
		.s_awlen(nvdla_master_out_aw_len),
		.s_awburst(nvdla_master_out_aw_burst),
		.s_awaddr(nvdla_master_out_aw_addr),
		.s_awid(nvdla_master_out_aw_id),

		.s_wdata(nvdla_master_out_w_data),
		.s_wstrb(nvdla_master_out_w_strb),
		.s_wlast(nvdla_master_out_w_last),
		.s_wready(nvdla_master_out_w_ready),
		.s_wvalid(nvdla_master_out_w_valid),
		`ifdef AXI_HAVE_USER
		.s_wuser(nvdla_master_out_w_user),
    `endif

		.s_arready(nvdla_master_out_ar_ready),
		.s_arvalid(nvdla_master_out_ar_valid),
		`ifdef AXI_HAVE_USER
		.s_aruser(nvdla_master_out_ar_user),
    `endif
		.s_arsize(nvdla_master_out_ar_size),
		.s_arlen(nvdla_master_out_ar_len),
		.s_arburst(nvdla_master_out_ar_burst),
		.s_araddr(nvdla_master_out_ar_addr),
		.s_arid(nvdla_master_out_ar_id),

		.s_rdata(nvdla_master_out_r_data),
		.s_rresp(nvdla_master_out_r_resp),
		.s_rid(nvdla_master_out_r_id),
		.s_rlast(nvdla_master_out_r_last),
		.s_rready(nvdla_master_out_r_ready),
		.s_rvalid(nvdla_master_out_r_valid),

		.s_bid(nvdla_master_out_b_id),
		.s_bresp(nvdla_master_out_b_resp),
		.s_bready(nvdla_master_out_b_ready),
		.s_bvalid(nvdla_master_out_b_valid),
		
		// MASTER 
		.m_awready(nvdla_master_out_x2x_aw_ready),
		.m_awvalid(nvdla_master_out_x2x_aw_valid),
		`ifdef AXI_HAVE_USER
		.m_awuser(nvdla_master_out_x2x_aw_user),
    `endif
		.m_awsize(nvdla_master_out_x2x_aw_size),
		.m_awlen(nvdla_master_out_x2x_aw_len),
		.m_awburst(nvdla_master_out_x2x_aw_burst),
		.m_awaddr(nvdla_master_out_x2x_aw_addr),
		.m_awid(nvdla_master_out_x2x_aw_id),

		.m_wdata(nvdla_master_out_x2x_w_data),
		.m_wstrb(nvdla_master_out_x2x_w_strb),
		.m_wlast(nvdla_master_out_x2x_w_last),
		.m_wready(nvdla_master_out_x2x_w_ready),
		.m_wvalid(nvdla_master_out_x2x_w_valid),
		`ifdef AXI_HAVE_USER
		.m_wuser(nvdla_master_out_x2x_w_user),
    `endif

		.m_arready(nvdla_master_out_x2x_ar_ready),
		.m_arvalid(nvdla_master_out_x2x_ar_valid),
		`ifdef AXI_HAVE_USER
		.m_aruser(nvdla_master_out_x2x_ar_user),
    `endif
		.m_arsize(nvdla_master_out_x2x_ar_size),
		.m_arlen(nvdla_master_out_x2x_ar_len),
		.m_arburst(nvdla_master_out_x2x_ar_burst),
		.m_araddr(nvdla_master_out_x2x_ar_addr),
		.m_arid(nvdla_master_out_x2x_ar_id),

		.m_rdata(nvdla_master_out_x2x_r_data),
		.m_rresp(nvdla_master_out_x2x_r_resp),
		.m_rid(nvdla_master_out_x2x_r_id),
		.m_rlast(nvdla_master_out_x2x_r_last),
		.m_rready(nvdla_master_out_x2x_r_ready),
		.m_rvalid(nvdla_master_out_x2x_r_valid),

		.m_bid(nvdla_master_out_x2x_b_id),
		.m_bresp(nvdla_master_out_x2x_b_resp),
		.m_bready(nvdla_master_out_x2x_b_ready),
		.m_bvalid(nvdla_master_out_x2x_b_valid)
	);



  wire  nvdla_core_clk_en;
  AsyncResetReg#(.RESET_VALUE(0)) nvdla_core_clk_en_async ( 
    .rst(tile_reset),
    .clk(tile_clock),
    .en(1'b1),
    .d(nvdla_other_cfg[0]),
  ...
  dont_touch_tc_clk_gating #(
      .IS_FUNCTIONAL(1'b1)
    ) nvdla_csb_clk_gate (
      .clk_i     ( main_clock        ),
      .en_i      ( nvdla_other_cfg[1] ),
      .test_en_i ( 1'b0             ),
      .clk_o     ( nvdla_csb_clk )
    );
  ...
  dont_touch_tc_clk_gating #(
      ...
      .clk_i     ( tile_clock        ),
      .en_i      ( nvdla_core_clk_en ),
      .test_en_i ( 1'b0             ),
      .clk_o     ( nvdla_core_clk )
    );


nvdla_small U_nvdla_small(
  // .core_clk(1'b0) //|< i
  //,.csb_clk(1'b0) //|< i cfg clk
   .core_clk(nvdla_core_clk) //|< i
  ,.csb_clk(nvdla_csb_clk) //|< i cfg clk
  ,.global_clk_ovr_on(nvdla_other_cfg[15]) //|< i
  ,.tmc2slcg_disable_clock_gating(nvdla_other_cfg[14]) //|< i
  ,.rstn(~nvdla_core_async_rst) //|< i
  ,.csb_rstn(~nvdla_csb_async_rst) //|< i  preset
  // cfg APB
  ,.psel(nvdla_slave_s0_psel)
  ,.penable(nvdla_slave_s_penable)
  ,.pwrite(nvdla_slave_s_pwrite)
  ,.paddr({nvdla_slave_s_paddr})
  ,.pwdata(nvdla_slave_s_pwdata)
  ,.prdata(nvdla_slave_s0_prdata)
  ,.pready(nvdla_slave_s0_pready)
  ...
  ,.nvdla_core2dbb_aw_awvalid(nvdla_master_out_aw_valid) //|> o
  ,.nvdla_core2dbb_aw_awready(nvdla_master_out_aw_ready) //|< i
  ,.nvdla_core2dbb_aw_awid(nvdla_master_out_aw_id) //|> o
  ,.nvdla_core2dbb_aw_awlen(nvdla_master_out_aw_len) //|> o
  //,.nvdla_core2dbb_aw_awsize(nvdla_master_out_aw_size) //|> o
  ,.nvdla_core2dbb_aw_awaddr(nvdla_master_out_aw_addr) //|> o
  ,.nvdla_core2dbb_w_wvalid(nvdla_master_out_w_valid) //|> o
  ,.nvdla_core2dbb_w_wready(nvdla_master_out_w_ready) //|< i
  ,.nvdla_core2dbb_w_wdata(nvdla_master_out_w_data) //|> o
  ,.nvdla_core2dbb_w_wstrb(nvdla_master_out_w_strb) //|> o
  ,.nvdla_core2dbb_w_wlast(nvdla_master_out_w_last) //|> o
  ,.nvdla_core2dbb_b_bvalid(nvdla_master_out_b_valid) //|< i
  ,.nvdla_core2dbb_b_bready(nvdla_master_out_b_ready) //|> o
  ,.nvdla_core2dbb_b_bid(nvdla_master_out_b_id) //|< i
  ,.nvdla_core2dbb_ar_arvalid(nvdla_master_out_ar_valid) //|> o
  ,.nvdla_core2dbb_ar_arready(nvdla_master_out_ar_ready) //|< i
  ,.nvdla_core2dbb_ar_arid(nvdla_master_out_ar_id) //|> o
  ,.nvdla_core2dbb_ar_arlen(nvdla_master_out_ar_len) //|> o
  //,.nvdla_core2dbb_ar_arsize(nvdla_master_out_ar_size) //|> o
  ,.nvdla_core2dbb_ar_araddr(nvdla_master_out_ar_addr) //|> o
  ,.nvdla_core2dbb_r_rvalid(nvdla_master_out_r_valid) //|< i
  ,.nvdla_core2dbb_r_rready(nvdla_master_out_r_ready) //|> o
  ,.nvdla_core2dbb_r_rid(nvdla_master_out_r_id) //|< i
  ,.nvdla_core2dbb_r_rlast(nvdla_master_out_r_last) //|< i
  ,.nvdla_core2dbb_r_rdata(nvdla_master_out_r_data) //|< i
  ,.dla_intr(dla_intr) //|> o
...
////////////////////////////////////////////////////////////////////////////////
  wire [3:0] ddr_master_0_rid_unused;
  wire [3:0] ddr_master_0_bid_unused;

  amba_axi_m3s2
        #(.NUM_MASTER(3)  // should not be changed
    ...
    U_D2D_MASTER_BUS(
      ...
      ,.ACLK(main_clock)
      //--------------------------------------------------------------
      ,.M0_AWID({4'b0, ddr_master_0_awid})
      ...
      ,.M0_WUSER(1'b0)
        `endif
      ,.M0_BID({ddr_master_0_bid_unused, ddr_master_0_bid})
      ...
      ,.M0_BUSER(1'b0)
        `endif
      ,.M0_ARID({4'b0, ddr_master_0_arid})
      ...
      ,.M0_ARUSER(1'b0)
        `endif
      ,.M0_RID({ddr_master_0_rid_unused, ddr_master_0_rid})
      ...
      ,.M0_RUSER()
        `endif
        //--------------------------------------------------------------
      ,.M1_AWID({4'b0, qspi_master_out_aw_id})
      ...
      ,.M1_AWBURST(qspi_master_out_aw_burst)
        `ifdef  AMBA_AXI_CACHE
      ,.M1_AWCACHE(qspi_master_out_aw_cache)
        `endif
        `ifdef AMBA_AXI_PROT
      ,.M1_AWPROT(qspi_master_out_aw_prot)
        `endif
      ,.M1_AWVALID(qspi_master_out_aw_valid)
      ,.M1_AWREADY(qspi_master_out_aw_ready)
        `ifdef AMBA_QOS
      ,.M1_AWQOS(qspi_master_out_aw_qos)
      ,.M1_AWREGION(qspi_master_out_aw_region)
        `endif
        `ifdef AMBA_AXI_AWUSER
      ,.M1_AWUSER(1'b0)
        `endif
      ...
      ,.M1_BUSER()
        `endif
      ,.M1_ARID({4'b0, qspi_master_out_ar_id})
      ...
      ,.M1_ARBURST(qspi_master_out_ar_burst)
        `ifdef  AMBA_AXI_CACHE
      ,.M1_ARCACHE(qspi_master_out_ar_cache)
        `endif
        `ifdef AMBA_AXI_PROT
      ,.M1_ARPROT(qspi_master_out_ar_prot)
        `endif
      ,.M1_ARVALID(qspi_master_out_ar_valid)
      ,.M1_ARREADY(qspi_master_out_ar_ready)
        `ifdef AMBA_QOS
      ,.M1_ARQOS(qspi_master_out_ar_qos)
      ,.M1_ARREGION(qspi_master_out_ar_region)
        `endif
        `ifdef AMBA_AXI_ARUSER
      ,.M1_ARUSER(1'b0)
        `endif
      ...
      ,.M1_RUSER()
        `endif
        //--------------------------------------------------------------
        // for nvdla ip master port
      ,.M2_AWID(nvdla_master_out_x2x_aw_id)
      ,.M2_AWADDR({1'b0, nvdla_master_out_x2x_aw_addr[31:0]})
      ,.M2_AWLEN({4'h0, nvdla_master_out_x2x_aw_len})
      ,.M2_AWLOCK(1'b0)
      ,.M2_AWSIZE(nvdla_master_out_x2x_aw_size)
      ,.M2_AWBURST(nvdla_master_out_x2x_aw_burst)
        `ifdef  AMBA_AXI_CACHE
      ,.M2_AWCACHE(nvdla_master_out_x2x_aw_cache)
        `endif
        `ifdef AMBA_AXI_PROT
      ,.M2_AWPROT(nvdla_master_out_x2x_aw_prot)
        `endif
      ,.M2_AWVALID(nvdla_master_out_x2x_aw_valid)
      ,.M2_AWREADY(nvdla_master_out_x2x_aw_ready)
        `ifdef AMBA_QOS
      ,.M2_AWQOS(nvdla_master_out_x2x_aw_qos)
      ,.M2_AWREGION(nvdla_master_out_x2x_aw_region)
        `endif
        `ifdef AMBA_AXI_AWUSER
      ,.M2_AWUSER(1'b0)
        `endif
      ,.M2_WDATA(nvdla_master_out_x2x_w_data)
      ,.M2_WSTRB(nvdla_master_out_x2x_w_strb)
      ,.M2_WLAST(nvdla_master_out_x2x_w_last)
      ,.M2_WVALID(nvdla_master_out_x2x_w_valid)
      ,.M2_WREADY(nvdla_master_out_x2x_w_ready)
        `ifdef AMBA_AXI_WUSER
      ,.M2_WUSER(1'b0)
        `endif
      ,.M2_BID(nvdla_master_out_x2x_b_id)
      ,.M2_BRESP(nvdla_master_out_x2x_b_resp)
      ,.M2_BVALID(nvdla_master_out_x2x_b_valid)
      ,.M2_BREADY(nvdla_master_out_x2x_b_ready)
        `ifdef AMBA_AXI_BUSER
      ,.M2_BUSER()
        `endif
      ,.M2_ARID(nvdla_master_out_x2x_ar_id)
      ,.M2_ARADDR({1'b0, nvdla_master_out_x2x_ar_addr[31:0]})
      ,.M2_ARLEN({4'h0, nvdla_master_out_x2x_ar_len})
      ,.M2_ARLOCK(1'b0)
      ,.M2_ARSIZE(nvdla_master_out_x2x_ar_size)
      ,.M2_ARBURST(nvdla_master_out_x2x_ar_burst)
        `ifdef  AMBA_AXI_CACHE
      ,.M2_ARCACHE(nvdla_master_out_x2x_ar_cache)
        `endif
        `ifdef AMBA_AXI_PROT
      ,.M2_ARPROT(nvdla_master_out_x2x_ar_prot)
        `endif
      ,.M2_ARVALID(nvdla_master_out_x2x_ar_valid)
      ,.M2_ARREADY(nvdla_master_out_x2x_ar_ready)
        `ifdef AMBA_QOS
      ,.M2_ARQOS(nvdla_master_out_x2x_ar_qos)
      ,.M2_ARREGION(nvdla_master_out_x2x_ar_region)
        `endif
        `ifdef AMBA_AXI_ARUSER
      ,.M2_ARUSER(1'b0)
        `endif
      ,.M2_RID(nvdla_master_out_x2x_r_id)
      ,.M2_RDATA(nvdla_master_out_x2x_r_data)
      ,.M2_RRESP(nvdla_master_out_x2x_r_resp)
      ,.M2_RLAST(nvdla_master_out_x2x_r_last)
      ,.M2_RVALID(nvdla_master_out_x2x_r_valid)
      ,.M2_RREADY(nvdla_master_out_x2x_r_ready)
        `ifdef AMBA_AXI_RUSER
      ,.M2_RUSER()
        `endif
        //--------------------------------------------------------------
...
//--------------------------------------------------------------
  ...
  amba_axi_m2s4
        #(.NUM_MASTER(2)  // should not be changed
          ...
          ,.SLAVE_EN3(1) 
          ,.ADDR_LENGTH3(24) // effective address bits-widgh
          ,.ADDR_BASE0(32'h000_0000)
          ,.ADDR_BASE1(32'h100_0000)
          ,.ADDR_BASE2(32'h200_0000)
          ,.ADDR_BASE3(32'h300_0000)
        )
    U_D2D_SLAVE_PERI_BUS(
      ...
      ,.S2_RUSER()
        `endif
        //--------------------------------------------------------------  NVDLA
      ,.S3_AWID(nvdla_slave_s_axi_awid)
      ,.S3_AWADDR(nvdla_slave_s_axi_awaddr)
      ,.S3_AWLEN(nvdla_slave_s_axi_awlen)
      ,.S3_AWLOCK(nvdla_slave_s_axi_awlock)
      ,.S3_AWSIZE(nvdla_slave_s_axi_awsize)
      ,.S3_AWBURST(nvdla_slave_s_axi_awburst)
        `ifdef  AMBA_AXI_CACHE
      ,.S3_AWCACHE()
        `endif
        `ifdef AMBA_AXI_PROT
      ,.S3_AWPROT()
        `endif
      ,.S3_AWVALID(nvdla_slave_s_axi_awvalid)
      ,.S3_AWREADY(nvdla_slave_s_axi_awready)
        `ifdef AMBA_QOS
      ,.S3_AWQOS()
      ,.S3_AWREGION()
        `endif
      ...
      ,.S3_AWUSER()
        `endif
      ,.S3_WDATA(nvdla_slave_s_axi_wdata)
      ,.S3_WSTRB(nvdla_slave_s_axi_wstrb)
      ,.S3_WLAST(nvdla_slave_s_axi_wlast)
      ,.S3_WVALID(nvdla_slave_s_axi_wvalid)
      ,.S3_WREADY(nvdla_slave_s_axi_wready)
        `ifdef AMBA_AXI_WUSER
      ,.S3_WUSER()
        `endif
      ,.S3_BID(nvdla_slave_s_axi_bid)
      ,.S3_BRESP(nvdla_slave_s_axi_bresp)
      ,.S3_BVALID(nvdla_slave_s_axi_bvalid)
      ,.S3_BREADY(nvdla_slave_s_axi_bready)
        `ifdef AMBA_AXI_BUSER
      ,.S3_BUSER()
        `endif
      ,.S3_ARID(nvdla_slave_s_axi_arid)
      ,.S3_ARADDR(nvdla_slave_s_axi_araddr)
      ,.S3_ARLEN(nvdla_slave_s_axi_arlen)
      ,.S3_ARLOCK(nvdla_slave_s_axi_arlock)
      ,.S3_ARSIZE(nvdla_slave_s_axi_arsize)
      ,.S3_ARBURST(nvdla_slave_s_axi_arburst)
        `ifdef  AMBA_AXI_CACHE
      ,.S3_ARCACHE()
        `endif
        `ifdef AMBA_AXI_PROT
      ,.S3_ARPROT()
        `endif
      ,.S3_ARVALID(nvdla_slave_s_axi_arvalid)
      ,.S3_ARREADY(nvdla_slave_s_axi_arready)
        `ifdef AMBA_QOS
      ,.S3_ARQOS()
      ,.S3_ARREGION()
        `endif
      ...
      ,.S3_ARUSER()
        `endif
      ,.S3_RID(nvdla_slave_s_axi_rid)
      ,.S3_RDATA(nvdla_slave_s_axi_rdata)
      ,.S3_RRESP(nvdla_slave_s_axi_rresp)
      ,.S3_RLAST(nvdla_slave_s_axi_rlast)
      ,.S3_RVALID(nvdla_slave_s_axi_rvalid)
      ,.S3_RREADY(nvdla_slave_s_axi_rready)
        `ifdef AMBA_AXI_RUSER
      ,.S3_RUSER()
        `endif
        //--------------------------------------------------------------
...
axi_to_apb_s3
     #(.AXI_WIDTH_SID(NVDLA_SLAVE_AXI4_ID_WIDTH) // ID width in bits
     , .AXI_WIDTH_AD(32) // address width
     , .AXI_WIDTH_DA(NVDLA_SLAVE_AXI4_WDATA_WIDTH) // data width
     , .AXI_WIDTH_DS(NVDLA_SLAVE_AXI4_WDATA_WIDTH/8) // data strobe width
     , .NUM_PSLAVE(3)
     , .WIDTH_PAD(32) // address width
     , .WIDTH_PDA(32) // data width
     , .WIDTH_PDS(32/8) // data strobe width
     , .ADDR_PBASE0(32'h3000000)
     , .ADDR_PLENGTH0(24)
     , .ADDR_PBASE1(32'h4000000)
     , .ADDR_PLENGTH1(24)
     , .ADDR_PBASE2(32'h5000000)
     , .ADDR_PLENGTH2(24)
     , .CLOCK_RATIO(2'b00)// 0=1:1, 3=async
     ) u_nvdla_slave_x2b_s3 (
      .ARESETn(~main_reset)
     ,.ACLK(main_clock)
     ,.AWID(nvdla_slave_s_axi_awid)
     ,.AWADDR({4'h0, nvdla_slave_s_axi_awaddr})
     ,.AWLEN(nvdla_slave_s_axi_awlen)
     ,.AWLOCK(nvdla_slave_s_axi_awlock)
     ,.AWSIZE(nvdla_slave_s_axi_awsize)
     ,.AWBURST(nvdla_slave_s_axi_awburst)
     `ifdef AMBA_AXI_CACHE
     ,.AWCACHE(nvdla_slave_s_axi_awcache)
     `endif
     `ifdef AMBA_AXI_PROT
     ,.AWPROT(nvdla_slave_s_axi_awprot)
     `endif
     ,.AWVALID(nvdla_slave_s_axi_awvalid)
     ,.AWREADY(nvdla_slave_s_axi_awready)
     `ifdef AMBA_QOS
     ,.AWQOS(nvdla_slave_s_axi_awqos)
     ,.AWREGION(nvdla_slave_s_axi_awregion)
     `endif
     ,.WDATA(nvdla_slave_s_axi_wdata)
     ,.WSTRB(nvdla_slave_s_axi_wstrb)
     ,.WLAST(nvdla_slave_s_axi_wlast)
     ,.WVALID(nvdla_slave_s_axi_wvalid)
     ,.WREADY(nvdla_slave_s_axi_wready)
     ,.BID(nvdla_slave_s_axi_bid)
     ,.BRESP(nvdla_slave_s_axi_bresp)
     ,.BVALID(nvdla_slave_s_axi_bvalid)
     ,.BREADY(nvdla_slave_s_axi_bready)
     ,.ARID(nvdla_slave_s_axi_arid)
     ,.ARADDR({4'h0, nvdla_slave_s_axi_araddr})
     ,.ARLEN(nvdla_slave_s_axi_arlen)
     ,.ARLOCK(1'b0)
     ,.ARSIZE(nvdla_slave_s_axi_arsize)
     ,.ARBURST(nvdla_slave_s_axi_arburst)
     `ifdef AMBA_AXI_CACHE
     ,.ARCACHE(nvdla_slave_s_axi_arcache)
     `endif
     `ifdef AMBA_AXI_PROT
     ,.ARPROT(nvdla_slave_s_axi_arprot)
     `endif
     ,.ARVALID(nvdla_slave_s_axi_arvalid)
     ,.ARREADY(nvdla_slave_s_axi_arready)
     `ifdef AMBA_QOS
     ,.ARQOS(nvdla_slave_s_axi_arqos)
     ,.ARREGION(nvdla_slave_s_axi_arregion)
     `endif
     ,.RID(nvdla_slave_s_axi_rid)
     ,.RDATA(nvdla_slave_s_axi_rdata)
     ,.RRESP(nvdla_slave_s_axi_rresp)
     ,.RLAST(nvdla_slave_s_axi_rlast)
     ,.RVALID(nvdla_slave_s_axi_rvalid)
     ,.RREADY(nvdla_slave_s_axi_rready)
     //-----------------------------------------------------------
     ,.PRESETn(~main_reset)
     ,.PCLK(main_clock)
     ,.S_PADDR(nvdla_slave_s_paddr)
     ,.S_PENABLE(nvdla_slave_s_penable)
     ,.S_PWRITE(nvdla_slave_s_pwrite)
     ,.S_PWDATA(nvdla_slave_s_pwdata)
     ,.S0_PSEL(nvdla_slave_s0_psel)
     ,.S0_PRDATA(nvdla_slave_s0_prdata)
     `ifdef AMBA_APB3
     ,.S0_PREADY(nvdla_slave_s0_pready)
     ,.S0_PSLVERR(nvdla_slave_s0_pslverr)
     `endif
     ,.S1_PSEL(nvdla_slave_s1_psel)
     ,.S1_PRDATA(nvdla_slave_s1_prdata)
     `ifdef AMBA_APB3
     ,.S1_PREADY(nvdla_slave_s1_pready)
     ,.S1_PSLVERR(nvdla_slave_s1_pslverr)
     `endif
     ,.S2_PSEL(nvdla_slave_s2_psel)
     ,.S2_PRDATA(nvdla_slave_s2_prdata)
     `ifdef AMBA_APB3
     ,.S2_PREADY(nvdla_slave_s2_pready)
     ,.S2_PSLVERR(nvdla_slave_s2_pslverr)
     `endif
     `ifdef AMBA_APB4
     ,.S_PSTRB(nvdla_slave_s_pstrb)
     ,.S_PPROT(nvdla_slave_s_pprot)
     `endif
     //-----------------------------------------------------------
);
  ...
  ResetCatchAndSync_d3 spi_1_reset_ResetCatchAndSync_d3 ( 
    .clock(main_clock),
    .reset(main_reset|spi_1_sft_rst),
  ...
  ResetCatchAndSync_d3 spi_slave_reset_ResetCatchAndSync_d3 ( 
    .clock(main_clock),
    .reset(main_reset|spi_slave_sft_rst),
...
`endif
    ...
    .auto_master_out_b_id(qspi_master_out_b_id[3:0]),
    ...
    .auto_master_out_r_id(qspi_master_out_r_id[3:0])
  ...
  ResetCatchAndSync_d3 soc_iram_reset_ResetCatchAndSync_d3 ( 
    .clock(main_clock),
    .reset(main_reset|soc_iram_sft_rst),
  ...
  //SOC_IRAM U_SOC_IRAM ( // used for dc harden
    .clk(main_clock),
  ...
  SOC_LSYS # (
    ...
    .debug_mode_config_sync(debug_mode_config_sync),
    ...
    .nvdla_core_sft_rst(nvdla_core_sft_rst),
    .nvdla_csb_sft_rst(nvdla_csb_sft_rst),
    .nvdla_other_cfg(nvdla_other_cfg),
  ...
  AXI4Fragmenter_Param #(
    ...
    .auto_in_aw_bits_echo_extra_id({indexer_auto_out_aw_bits_echo_extra_id[master_bus_indexer_AXI4_ID_WIDTH-2:0]}),
    ...
    .auto_in_b_bits_echo_extra_id({indexer_auto_out_b_bits_echo_extra_id[master_bus_indexer_AXI4_ID_WIDTH-2:0]}),
    ...
    .auto_in_ar_bits_echo_extra_id({indexer_auto_out_ar_bits_echo_extra_id[master_bus_indexer_AXI4_ID_WIDTH-2:0]}),
    ...
    .auto_in_r_bits_echo_extra_id({indexer_auto_out_r_bits_echo_extra_id[master_bus_indexer_AXI4_ID_WIDTH-2:0]}),
  ...
  AXI4Buffer_Param #(
    .ADDR_WIDTH(32),
    .DATA_WIDTH(64),
    .ID_WIDTH(1+master_bus_indexer_AXI4_ID_WIDTH-1+1)  // id + extra_id + real_last
  ...
  AXI4IdIndexer_Param #(
    ...
    .auto_in_awready(indexer_auto_in_aw_ready),
    .auto_in_awvalid(indexer_auto_in_aw_valid),
    .auto_in_awid(indexer_auto_in_aw_bits_id),
    .auto_in_awaddr(indexer_auto_in_aw_bits_addr[31:0]),
    .auto_in_awlen(indexer_auto_in_aw_bits_len),
    .auto_in_awsize(indexer_auto_in_aw_bits_size),
    .auto_in_awburst(indexer_auto_in_aw_bits_burst),
    //.auto_in_awlock(indexer_auto_in_aw_bits_lock),
    .auto_in_awcache(4'b0),
    .auto_in_awprot(3'b0),
    //.auto_in_awqos(indexer_auto_in_aw_bits_qos),
    .auto_in_wready(indexer_auto_in_w_ready),
    .auto_in_wvalid(indexer_auto_in_w_valid),
    .auto_in_wdata(indexer_auto_in_w_bits_data),
    .auto_in_wstrb(indexer_auto_in_w_bits_strb),
    .auto_in_wlast(indexer_auto_in_w_bits_last),
    .auto_in_bready(indexer_auto_in_b_ready),
    .auto_in_bvalid(indexer_auto_in_b_valid),
    .auto_in_bid(indexer_auto_in_b_bits_id),
    .auto_in_bresp(indexer_auto_in_b_bits_resp),
    .auto_in_arready(indexer_auto_in_ar_ready),
    .auto_in_arvalid(indexer_auto_in_ar_valid),
    .auto_in_arid(indexer_auto_in_ar_bits_id),
    .auto_in_araddr(indexer_auto_in_ar_bits_addr[31:0]),
    .auto_in_arlen(indexer_auto_in_ar_bits_len),
    .auto_in_arsize(indexer_auto_in_ar_bits_size),
    .auto_in_arburst(indexer_auto_in_ar_bits_burst),
    //.auto_in_arlock(indexer_auto_in_ar_bits_lock),
    .auto_in_arcache(4'b0),
    .auto_in_arprot(3'b0),
    //.auto_in_arqos(indexer_auto_in_ar_bits_qos),
    .auto_in_rready(indexer_auto_in_r_ready),
    .auto_in_rvalid(indexer_auto_in_r_valid),
    .auto_in_rid(indexer_auto_in_r_bits_id),
    .auto_in_rdata(indexer_auto_in_r_bits_data),
    .auto_in_rresp(indexer_auto_in_r_bits_resp),
    .auto_in_rlast(indexer_auto_in_r_bits_last),
    //.auto_in_ruser(indexer_auto_in_r_bits_user),
    .auto_out_awready(indexer_auto_out_aw_ready),
    .auto_out_awvalid(indexer_auto_out_aw_valid),
    .auto_out_awid(indexer_auto_out_aw_bits_id),
    .auto_out_awaddr(indexer_auto_out_aw_bits_addr),
    .auto_out_awlen(indexer_auto_out_aw_bits_len),
    .auto_out_awsize(indexer_auto_out_aw_bits_size),
    .auto_out_awburst(indexer_auto_out_aw_bits_burst),
    //.auto_out_awlock(indexer_auto_out_aw_bits_lock),
    .auto_out_awcache(indexer_auto_out_aw_bits_cache),
    .auto_out_awprot(indexer_auto_out_aw_bits_prot),
    //.auto_out_awqos(indexer_auto_out_aw_bits_qos),
    .auto_out_awecho_extra_id(indexer_auto_out_aw_bits_echo_extra_id),
    .auto_out_wready(indexer_auto_out_w_ready),
    .auto_out_wvalid(indexer_auto_out_w_valid),
    .auto_out_wdata(indexer_auto_out_w_bits_data),
    .auto_out_wstrb(indexer_auto_out_w_bits_strb),
    .auto_out_wlast(indexer_auto_out_w_bits_last),
    .auto_out_bready(indexer_auto_out_b_ready),
    .auto_out_bvalid(indexer_auto_out_b_valid),
    .auto_out_bid(indexer_auto_out_b_bits_id),
    .auto_out_bresp(indexer_auto_out_b_bits_resp),
    .auto_out_becho_extra_id(indexer_auto_out_b_bits_echo_extra_id),
    .auto_out_arready(indexer_auto_out_ar_ready),
    .auto_out_arvalid(indexer_auto_out_ar_valid),
    .auto_out_arid(indexer_auto_out_ar_bits_id),
    .auto_out_araddr(indexer_auto_out_ar_bits_addr),
    .auto_out_arlen(indexer_auto_out_ar_bits_len),
    .auto_out_arsize(indexer_auto_out_ar_bits_size),
    .auto_out_arburst(indexer_auto_out_ar_bits_burst),
    //.auto_out_arlock(indexer_auto_out_ar_bits_lock),
    .auto_out_arcache(indexer_auto_out_ar_bits_cache),
    .auto_out_arprot(indexer_auto_out_ar_bits_prot),
    //.auto_out_arqos(indexer_auto_out_ar_bits_qos),
    .auto_out_arecho_extra_id(indexer_auto_out_ar_bits_echo_extra_id),
    .auto_out_rready(indexer_auto_out_r_ready),
    .auto_out_rvalid(indexer_auto_out_r_valid),
    .auto_out_rid(indexer_auto_out_r_bits_id),
    .auto_out_rdata(indexer_auto_out_r_bits_data),
    .auto_out_rresp(indexer_auto_out_r_bits_resp),
    .auto_out_recho_extra_id(indexer_auto_out_r_bits_echo_extra_id),
    .auto_out_rlast(indexer_auto_out_r_bits_last)
  );
...
`ifndef USE_PCIE_CONTROLLER_SLAVE
  assign axi_to_pcie_x1_auto_control_in_aw_ready = 1'b0;
  assign axi_to_pcie_x1_auto_control_in_w_ready = 1'b0;
  assign axi_to_pcie_x1_auto_control_in_b_valid = 1'b0;
  assign axi_to_pcie_x1_auto_control_in_b_bits_resp = 2'b0;

  assign axi_to_pcie_x1_auto_control_in_ar_ready = 1'b0;
  assign axi_to_pcie_x1_auto_control_in_r_valid = 1'b0;
  assign axi_to_pcie_x1_auto_control_in_r_bits_data = 32'b0;
  assign axi_to_pcie_x1_auto_control_in_r_bits_resp = 2'b0;
...
`endif
  ...
  assign intsource_auto_in_0 = spi_master_events_o[0]|dla_intr; 
