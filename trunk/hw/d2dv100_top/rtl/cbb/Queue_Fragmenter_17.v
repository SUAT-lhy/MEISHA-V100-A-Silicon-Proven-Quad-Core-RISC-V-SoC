module Queue_Fragmenter_17 #(
  ...
  input  [AXI4_ID_WIDTH-2:0]  io_enq_bits_echo_extra_id,
  input         io_deq_ready,
  output        io_deq_valid,
  ...
  output [AXI4_ID_WIDTH-2:0]  io_deq_bits_echo_extra_id
);
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [AXI4_ID_WIDTH-2:0] ram_echo_extra_id [0:0]; // @[Decoupled.scala 259:95]
  ...
  wire [AXI4_ID_WIDTH-2:0] ram_echo_extra_id_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire [AXI4_ID_WIDTH-2:0] ram_echo_extra_id_MPORT_data; // @[Decoupled.scala 259:95]
...
`ifdef RANDOMIZE_MEM_INIT
  ...
  _RAND_7 = {1{`RANDOM}};
  for (initvar = 0; initvar < 1; initvar = initvar+1)
    ram_echo_extra_id[initvar] = _RAND_7[AXI4_ID_WIDTH-2:0];
`endif // RANDOMIZE_MEM_INIT
`ifdef RANDOMIZE_REG_INIT
  _RAND_8 = {1{`RANDOM}};
