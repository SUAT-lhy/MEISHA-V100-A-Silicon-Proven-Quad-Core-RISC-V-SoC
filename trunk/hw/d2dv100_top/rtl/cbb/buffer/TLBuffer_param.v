module TLBuffer_param #(
		// {{{
		parameter	B_CHANNEL_ENABLE = 0,
  ...
  input  [ADDR_WIDTH-1:0] auto_in_a_bits_address, 
  input  [DATA_WIDTH/8-1:0]  auto_in_a_bits_mask, 
  ...
  output [SOURCE_WIDTH-1:0]  auto_in_b_bits_source, 
  output [ADDR_WIDTH-1:0] auto_in_b_bits_address, 
  output [DATA_WIDTH/8-1:0]  auto_in_b_bits_mask, 
  ...
  input  [SOURCE_WIDTH-1:0]  auto_in_c_bits_source, 
  input  [ADDR_WIDTH-1:0] auto_in_c_bits_address, 
  input  [DATA_WIDTH-1:0] auto_in_c_bits_data, 
  ...
  output [SINK_WIDTH-1:0]  auto_in_d_bits_sink, 
  output        auto_in_d_bits_denied, 
  output [DATA_WIDTH-1:0] auto_in_d_bits_data, 
  output        auto_in_d_bits_corrupt, 
  output        auto_in_e_ready, 
  input         auto_in_e_valid, 
  input  [SINK_WIDTH-1:0]  auto_in_e_bits_sink, 
  input         auto_out_a_ready, 
  output        auto_out_a_valid, 
  output [2:0]  auto_out_a_bits_opcode, 
  output [2:0]  auto_out_a_bits_param, 
  output [2:0]  auto_out_a_bits_size, 
  output [SOURCE_WIDTH-1:0]  auto_out_a_bits_source, 
  output [ADDR_WIDTH-1:0] auto_out_a_bits_address, 
  output [DATA_WIDTH/8-1:0]  auto_out_a_bits_mask, 
  ...
  input  [SOURCE_WIDTH-1:0]  auto_out_b_bits_source, 
  input  [ADDR_WIDTH-1:0] auto_out_b_bits_address, 
  input  [DATA_WIDTH/8-1:0]  auto_out_b_bits_mask, 
  ...
  output [SOURCE_WIDTH-1:0]  auto_out_c_bits_source, 
  output [ADDR_WIDTH-1:0] auto_out_c_bits_address, 
  output [DATA_WIDTH-1:0] auto_out_c_bits_data, 
  ...
  input  [SOURCE_WIDTH-1:0]  auto_out_d_bits_source, 
  input  [SINK_WIDTH-1:0]  auto_out_d_bits_sink, 
  input         auto_out_d_bits_denied, 
  input  [DATA_WIDTH-1:0] auto_out_d_bits_data, 
  input         auto_out_d_bits_corrupt, 
  input         auto_out_e_ready, 
  output        auto_out_e_valid, 
  output [SINK_WIDTH-1:0]  auto_out_e_bits_sink 
);
  ...
  wire [SOURCE_WIDTH-1:0] TLMonitor_io_in_a_bits_source; 
  wire [ADDR_WIDTH-1:0] TLMonitor_io_in_a_bits_address; 
  wire [DATA_WIDTH/8-1:0] TLMonitor_io_in_a_bits_mask; 
  ...
  wire [SOURCE_WIDTH-1:0] TLMonitor_io_in_b_bits_source; 
  wire [ADDR_WIDTH-1:0] TLMonitor_io_in_b_bits_address; 
  wire [DATA_WIDTH/8-1:0] TLMonitor_io_in_b_bits_mask; 
  ...
  wire [SOURCE_WIDTH-1:0] TLMonitor_io_in_c_bits_source; 
  wire [ADDR_WIDTH-1:0] TLMonitor_io_in_c_bits_address; 
  ...
  wire [SOURCE_WIDTH-1:0] TLMonitor_io_in_d_bits_source; 
  wire [SINK_WIDTH-1:0] TLMonitor_io_in_d_bits_sink; 
  ...
  wire [SINK_WIDTH-1:0] TLMonitor_io_in_e_bits_sink; 
  wire  Queue_clock; 
  wire  Queue_reset; 
  ...
  wire [SOURCE_WIDTH-1:0] Queue_io_enq_bits_source; 
  wire [ADDR_WIDTH-1:0] Queue_io_enq_bits_address; 
  wire [DATA_WIDTH/8-1:0] Queue_io_enq_bits_mask; 
  wire [DATA_WIDTH-1:0] Queue_io_enq_bits_data; 
  ...
  wire [SOURCE_WIDTH-1:0] Queue_io_deq_bits_source; 
  wire [ADDR_WIDTH-1:0] Queue_io_deq_bits_address; 
  wire [DATA_WIDTH/8-1:0] Queue_io_deq_bits_mask; 
  wire [DATA_WIDTH-1:0] Queue_io_deq_bits_data; 
  ...
  wire [SOURCE_WIDTH-1:0] Queue_1_io_enq_bits_source; 
  wire [SINK_WIDTH-1:0] Queue_1_io_enq_bits_sink; 
  ...
  wire [SOURCE_WIDTH-1:0] Queue_1_io_deq_bits_source; 
  wire [SINK_WIDTH-1:0] Queue_1_io_deq_bits_sink; 
  ...
  wire [SOURCE_WIDTH-1:0] Queue_2_io_enq_bits_source; 
  wire [ADDR_WIDTH-1:0] Queue_2_io_enq_bits_address; 
  wire [DATA_WIDTH/8-1:0] Queue_2_io_enq_bits_mask; 
  ...
  wire [SOURCE_WIDTH-1:0] Queue_2_io_deq_bits_source; 
  wire [ADDR_WIDTH-1:0] Queue_2_io_deq_bits_address; 
  wire [DATA_WIDTH/8-1:0] Queue_2_io_deq_bits_mask; 
  ...
  wire [SOURCE_WIDTH-1:0] Queue_3_io_enq_bits_source; 
  wire [ADDR_WIDTH-1:0] Queue_3_io_enq_bits_address; 
  wire [DATA_WIDTH-1:0] Queue_3_io_enq_bits_data; 
  ...
  wire [SOURCE_WIDTH-1:0] Queue_3_io_deq_bits_source; 
  wire [ADDR_WIDTH-1:0] Queue_3_io_deq_bits_address; 
  wire [DATA_WIDTH-1:0] Queue_3_io_deq_bits_data; 
  wire  Queue_3_io_deq_bits_corrupt; 
  wire  Queue_4_clock; 
  wire  Queue_4_reset; 
  wire  Queue_4_io_enq_ready; 
  wire  Queue_4_io_enq_valid; 
  wire [SINK_WIDTH-1:0] Queue_4_io_enq_bits_sink; 
  wire  Queue_4_io_deq_ready; 
  wire  Queue_4_io_deq_valid; 
  wire [SINK_WIDTH-1:0] Queue_4_io_deq_bits_sink; 
  TLQueue_a_param #(
