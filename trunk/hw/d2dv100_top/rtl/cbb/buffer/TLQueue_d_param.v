module TLQueue_d_param #(
  ...
  input  [SINK_WIDTH-1:0]  io_enq_bits_sink, 
  ...
  output [SINK_WIDTH-1:0]  io_deq_bits_sink, 
  ...
  reg [SINK_WIDTH-1:0] _T_35_sink [0:1]; 
  reg [31:0] _RAND_4;
  wire [SINK_WIDTH-1:0] _T_35_sink__T_58_data; 
  wire  _T_35_sink__T_58_addr; 
  wire [SINK_WIDTH-1:0] _T_35_sink__T_50_data; 
...
`ifdef RANDOMIZE
  ...
  `ifdef RANDOMIZE_MEM_INIT
  for (initvar = 0; initvar < 2; initvar = initvar+1)
    _T_35_sink[initvar] = _RAND_4[SINK_WIDTH-1:0];
  `endif // RANDOMIZE_MEM_INIT
  _RAND_5 = {1{`RANDOM}};
  `ifdef RANDOMIZE_MEM_INIT
  for (initvar = 0; initvar < 2; initvar = initvar+1)
