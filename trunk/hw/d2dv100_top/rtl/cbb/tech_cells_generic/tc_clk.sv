...
module dont_touch_tc_clk_buffer (
  input  logic clk_i,
  output logic clk_o
);
...
module dont_touch_tc_clk_gating #(
...
module dont_touch_tc_clk_inverter (
  input  logic clk_i,
  output logic clk_o
);
