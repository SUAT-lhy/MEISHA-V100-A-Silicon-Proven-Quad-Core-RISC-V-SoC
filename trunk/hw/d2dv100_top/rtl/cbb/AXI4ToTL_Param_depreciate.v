...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [13:0] _GEN_37 = {{11'd0}, auto_in_ar_bits_addr[2:0]}; // @[ToTL.scala 99:59]
  wire [13:0] _r_addr_T_1 = 14'h3000 | _GEN_37; // @[ToTL.scala 99:59]
  ...
  reg [2:0] r_count_2; // @[ToTL.scala 100:28]
  reg [2:0] r_count_3; // @[ToTL.scala 100:28]
  reg [2:0] r_count_4; // @[ToTL.scala 100:28]
  wire [2:0] _GEN_1 = auto_in_ar_bits_id ? r_count_1 : r_count_0; // @[ToTL.scala 104:{50,50}]
  wire [1:0] _GEN_38 = {{1'd0}, auto_in_ar_bits_id}; // @[ToTL.scala 104:{50,50}]
  wire [2:0] _GEN_2 = 2'h2 == _GEN_38 ? r_count_2 : _GEN_1; // @[ToTL.scala 104:{50,50}]
  wire [2:0] _GEN_3 = 2'h3 == _GEN_38 ? r_count_3 : _GEN_2; // @[ToTL.scala 104:{50,50}]
  wire [2:0] _GEN_40 = {{2'd0}, auto_in_ar_bits_id}; // @[ToTL.scala 104:{50,50}]
  wire [2:0] _GEN_4 = 3'h4 == _GEN_40 ? r_count_4 : _GEN_3; // @[ToTL.scala 104:{50,50}]
  wire [4:0] r_id = {auto_in_ar_bits_id,_GEN_4,1'h0}; // @[Cat.scala 31:58]
  ...
  wire [7:0] _r_sel_T = 8'h1 << _GEN_40; // @[OneHot.scala 64:12]
  wire [4:0] r_sel = _r_sel_T[4:0]; // @[OneHot.scala 64:27]
  ...
  wire [3:0] _GEN_41 = {{1'd0}, readys_filter[3:1]}; // @[package.scala 253:43]
  wire [3:0] _readys_unready_T_1 = readys_filter | _GEN_41; // @[package.scala 253:43]
  wire [3:0] _readys_unready_T_4 = {readys_mask, 2'h0}; // @[Arbiter.scala 25:66]
  wire [3:0] _GEN_42 = {{1'd0}, _readys_unready_T_1[3:1]}; // @[Arbiter.scala 25:58]
  wire [3:0] readys_unready = _GEN_42 | _readys_unready_T_4; // @[Arbiter.scala 25:58]
  ...
  wire  _T_15 = out_ready & auto_in_ar_valid; // @[Decoupled.scala 50:35]
  wire [2:0] _r_count_0_T_1 = r_count_0 + 3'h1; // @[ToTL.scala 125:43]
  wire [2:0] _r_count_1_T_1 = r_count_1 + 3'h1; // @[ToTL.scala 125:43]
  wire [2:0] _r_count_2_T_1 = r_count_2 + 3'h1; // @[ToTL.scala 125:43]
  wire [2:0] _r_count_3_T_1 = r_count_3 + 3'h1; // @[ToTL.scala 125:43]
  wire [2:0] _r_count_4_T_1 = r_count_4 + 3'h1; // @[ToTL.scala 125:43]
  wire [15:0] _w_size1_T = {auto_in_aw_bits_len,8'hff}; // @[Cat.scala 31:58]
  wire [22:0] _GEN_10 = {{7'd0}, _w_size1_T}; // @[Bundles.scala 34:21]
  wire [22:0] _w_size1_T_1 = _GEN_10 << auto_in_aw_bits_size; // @[Bundles.scala 34:21]
  ...
  wire [13:0] _GEN_43 = {{11'd0}, auto_in_aw_bits_addr[2:0]}; // @[ToTL.scala 132:59]
  wire [13:0] _w_addr_T_1 = 14'h3000 | _GEN_43; // @[ToTL.scala 132:59]
  ...
  reg [2:0] w_count_2; // @[ToTL.scala 133:28]
  reg [2:0] w_count_3; // @[ToTL.scala 133:28]
  reg [2:0] w_count_4; // @[ToTL.scala 133:28]
  wire [2:0] _GEN_11 = auto_in_aw_bits_id ? w_count_1 : w_count_0; // @[ToTL.scala 137:{50,50}]
  wire [1:0] _GEN_44 = {{1'd0}, auto_in_aw_bits_id}; // @[ToTL.scala 137:{50,50}]
  wire [2:0] _GEN_12 = 2'h2 == _GEN_44 ? w_count_2 : _GEN_11; // @[ToTL.scala 137:{50,50}]
  wire [2:0] _GEN_13 = 2'h3 == _GEN_44 ? w_count_3 : _GEN_12; // @[ToTL.scala 137:{50,50}]
  wire [2:0] _GEN_46 = {{2'd0}, auto_in_aw_bits_id}; // @[ToTL.scala 137:{50,50}]
  wire [2:0] _GEN_14 = 3'h4 == _GEN_46 ? w_count_4 : _GEN_13; // @[ToTL.scala 137:{50,50}]
  wire [4:0] w_id = {auto_in_aw_bits_id,_GEN_14,1'h1}; // @[Cat.scala 31:58]
  wire  _T_25 = ~auto_in_aw_valid; // @[ToTL.scala 140:15]
  wire [29:0] _T_27 = 30'h7fff << w_size; // @[package.scala 234:77]
  wire [14:0] _T_29 = ~_T_27[14:0]; // @[package.scala 234:46]
  ...
  wire [7:0] _w_sel_T = 8'h1 << _GEN_46; // @[OneHot.scala 64:12]
  wire [4:0] w_sel = _w_sel_T[4:0]; // @[OneHot.scala 64:27]
  wire  _T_48 = bundleIn_0_aw_ready & auto_in_aw_valid; // @[Decoupled.scala 50:35]
  wire [2:0] _w_count_0_T_1 = w_count_0 + 3'h1; // @[ToTL.scala 161:43]
  wire [2:0] _w_count_1_T_1 = w_count_1 + 3'h1; // @[ToTL.scala 161:43]
  wire [2:0] _w_count_2_T_1 = w_count_2 + 3'h1; // @[ToTL.scala 161:43]
  wire [2:0] _w_count_3_T_1 = w_count_3 + 3'h1; // @[ToTL.scala 161:43]
  wire [2:0] _w_count_4_T_1 = w_count_4 + 3'h1; // @[ToTL.scala 161:43]
  ...
  wire  _T_68 = auto_in_ar_valid | w_out_valid; // @[Arbiter.scala 107:36]
  wire  _T_69 = ~(auto_in_ar_valid | w_out_valid); // @[Arbiter.scala 107:15]
  wire  muxStateEarly_0 = idle ? earlyWinner_0 : state_0; // @[Arbiter.scala 117:30]
  wire  muxStateEarly_1 = idle ? earlyWinner_1 : state_1; // @[Arbiter.scala 117:30]
  wire  _sink_ACancel_earlyValid_T_3 = state_0 & auto_in_ar_valid | state_1 & w_out_valid; // @[Mux.scala 27:73]
  wire  sink_ACancel_earlyValid = idle ? _T_68 : _sink_ACancel_earlyValid_T_3; // @[Arbiter.scala 125:29]
  wire  _beatsLeft_T_2 = auto_out_a_ready & sink_ACancel_earlyValid; // @[ReadyValidCancel.scala 49:33]
  wire [7:0] _GEN_47 = {{7'd0}, _beatsLeft_T_2}; // @[Arbiter.scala 113:52]
  wire [7:0] _beatsLeft_T_4 = beatsLeft - _GEN_47; // @[Arbiter.scala 113:52]
  wire [7:0] _T_88 = muxStateEarly_0 ? a_mask : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _T_89 = muxStateEarly_1 ? auto_in_w_bits_strb : 8'h0; // @[Mux.scala 27:73]
  wire [31:0] _T_112 = muxStateEarly_0 ? r_addr : 32'h0; // @[Mux.scala 27:73]
  wire [31:0] _T_113 = muxStateEarly_1 ? w_addr : 32'h0; // @[Mux.scala 27:73]
  wire [4:0] _T_115 = muxStateEarly_0 ? r_id : 5'h0; // @[Mux.scala 27:73]
  wire [4:0] _T_116 = muxStateEarly_1 ? w_id : 5'h0; // @[Mux.scala 27:73]
  wire [3:0] _T_118 = muxStateEarly_0 ? r_size : 4'h0; // @[Mux.scala 27:73]
  wire [3:0] _T_119 = muxStateEarly_1 ? w_size : 4'h0; // @[Mux.scala 27:73]
  wire [2:0] _T_124 = muxStateEarly_0 ? 3'h4 : 3'h0; // @[Mux.scala 27:73]
  wire [2:0] _T_125 = muxStateEarly_1 ? 3'h1 : 3'h0; // @[Mux.scala 27:73]
  ...
  reg [2:0] b_count_2; // @[ToTL.scala 195:28]
  reg [2:0] b_count_3; // @[ToTL.scala 195:28]
  reg [2:0] b_count_4; // @[ToTL.scala 195:28]
  wire  q_b_bits_id = q_b_deq_io_deq_bits_id; // @[Decoupled.scala 401:19 402:14]
  wire [2:0] _GEN_23 = q_b_bits_id ? b_count_1 : b_count_0; // @[ToTL.scala 196:{43,43}]
  wire [1:0] _GEN_48 = {{1'd0}, q_b_bits_id}; // @[ToTL.scala 196:{43,43}]
  wire [2:0] _GEN_24 = 2'h2 == _GEN_48 ? b_count_2 : _GEN_23; // @[ToTL.scala 196:{43,43}]
  wire [2:0] _GEN_25 = 2'h3 == _GEN_48 ? b_count_3 : _GEN_24; // @[ToTL.scala 196:{43,43}]
  wire [2:0] _GEN_50 = {{2'd0}, q_b_bits_id}; // @[ToTL.scala 196:{43,43}]
  wire [2:0] _GEN_26 = 3'h4 == _GEN_50 ? b_count_4 : _GEN_25; // @[ToTL.scala 196:{43,43}]
  wire [2:0] _GEN_28 = q_b_bits_id ? w_count_1 : w_count_0; // @[ToTL.scala 196:{43,43}]
  wire [2:0] _GEN_29 = 2'h2 == _GEN_48 ? w_count_2 : _GEN_28; // @[ToTL.scala 196:{43,43}]
  wire [2:0] _GEN_30 = 2'h3 == _GEN_48 ? w_count_3 : _GEN_29; // @[ToTL.scala 196:{43,43}]
  wire [2:0] _GEN_31 = 3'h4 == _GEN_50 ? w_count_4 : _GEN_30; // @[ToTL.scala 196:{43,43}]
  wire  b_allow = _GEN_26 != _GEN_31; // @[ToTL.scala 196:43]
  wire [7:0] _b_sel_T = 8'h1 << _GEN_50; // @[OneHot.scala 64:12]
  wire [4:0] b_sel = _b_sel_T[4:0]; // @[OneHot.scala 64:27]
  ...
  wire  _T_132 = auto_in_b_ready & bundleIn_0_b_valid; // @[Decoupled.scala 50:35]
  wire [2:0] _b_count_0_T_1 = b_count_0 + 3'h1; // @[ToTL.scala 200:42]
  wire [2:0] _b_count_1_T_1 = b_count_1 + 3'h1; // @[ToTL.scala 200:42]
  wire [2:0] _b_count_2_T_1 = b_count_2 + 3'h1; // @[ToTL.scala 200:42]
  wire [2:0] _b_count_3_T_1 = b_count_3 + 3'h1; // @[ToTL.scala 200:42]
  wire [2:0] _b_count_4_T_1 = b_count_4 + 3'h1; // @[ToTL.scala 200:42]
  Queue_15 deq ( // @[Decoupled.scala 361:21]
    .clock(deq_clock),
    .reset(deq_reset),
  ...
  Queue_16 q_b_deq ( // @[Decoupled.scala 361:21]
    .clock(q_b_deq_clock),
    .reset(q_b_deq_reset),
  ...
  assign auto_out_a_valid = idle ? _T_68 : _sink_ACancel_earlyValid_T_3; // @[Arbiter.scala 125:29]
  assign auto_out_a_bits_opcode = _T_124 | _T_125; // @[Mux.scala 27:73]
  assign auto_out_a_bits_size = _T_118 | _T_119; // @[Mux.scala 27:73]
  assign auto_out_a_bits_source = _T_115 | _T_116; // @[Mux.scala 27:73]
  assign auto_out_a_bits_address = _T_112 | _T_113; // @[Mux.scala 27:73]
  ...
  assign auto_out_a_bits_mask = _T_88 | _T_89; // @[Mux.scala 27:73]
  ...
  assign deq_io_enq_bits_id = auto_out_d_bits_source[4]; // @[ToTL.scala 177:43]
  ...
  assign q_b_deq_io_enq_bits_id = auto_out_d_bits_source[4]; // @[ToTL.scala 186:43]
  ...
  always @(posedge clock) begin
    ...
    end else if (_T_15 & r_sel[0]) begin // @[ToTL.scala 125:34]
      r_count_0 <= _r_count_0_T_1; // @[ToTL.scala 125:38]
    end
    if (reset) begin // @[ToTL.scala 100:28]
      r_count_1 <= 3'h0; // @[ToTL.scala 100:28]
    end else if (_T_15 & r_sel[1]) begin // @[ToTL.scala 125:34]
      r_count_1 <= _r_count_1_T_1; // @[ToTL.scala 125:38]
    end
    if (reset) begin // @[ToTL.scala 100:28]
      r_count_2 <= 3'h0; // @[ToTL.scala 100:28]
    end else if (_T_15 & r_sel[2]) begin // @[ToTL.scala 125:34]
      r_count_2 <= _r_count_2_T_1; // @[ToTL.scala 125:38]
    end
    if (reset) begin // @[ToTL.scala 100:28]
      r_count_3 <= 3'h0; // @[ToTL.scala 100:28]
    end else if (_T_15 & r_sel[3]) begin // @[ToTL.scala 125:34]
      r_count_3 <= _r_count_3_T_1; // @[ToTL.scala 125:38]
    end
    if (reset) begin // @[ToTL.scala 100:28]
      r_count_4 <= 3'h0; // @[ToTL.scala 100:28]
    end else if (_T_15 & r_sel[4]) begin // @[ToTL.scala 125:34]
      r_count_4 <= _r_count_4_T_1; // @[ToTL.scala 125:38]
    end
    ...
    end else if (_T_48 & w_sel[0]) begin // @[ToTL.scala 161:34]
      w_count_0 <= _w_count_0_T_1; // @[ToTL.scala 161:38]
    end
    if (reset) begin // @[ToTL.scala 133:28]
      w_count_1 <= 3'h0; // @[ToTL.scala 133:28]
    end else if (_T_48 & w_sel[1]) begin // @[ToTL.scala 161:34]
      w_count_1 <= _w_count_1_T_1; // @[ToTL.scala 161:38]
    end
    if (reset) begin // @[ToTL.scala 133:28]
      w_count_2 <= 3'h0; // @[ToTL.scala 133:28]
    end else if (_T_48 & w_sel[2]) begin // @[ToTL.scala 161:34]
      w_count_2 <= _w_count_2_T_1; // @[ToTL.scala 161:38]
    end
    if (reset) begin // @[ToTL.scala 133:28]
      w_count_3 <= 3'h0; // @[ToTL.scala 133:28]
    end else if (_T_48 & w_sel[3]) begin // @[ToTL.scala 161:34]
      w_count_3 <= _w_count_3_T_1; // @[ToTL.scala 161:38]
    end
    if (reset) begin // @[ToTL.scala 133:28]
      w_count_4 <= 3'h0; // @[ToTL.scala 133:28]
    end else if (_T_48 & w_sel[4]) begin // @[ToTL.scala 161:34]
      w_count_4 <= _w_count_4_T_1; // @[ToTL.scala 161:38]
    end
    if (reset) begin // @[Arbiter.scala 116:26]
    ...
    end else if (_T_132 & b_sel[0]) begin // @[ToTL.scala 200:33]
      b_count_0 <= _b_count_0_T_1; // @[ToTL.scala 200:37]
    end
    if (reset) begin // @[ToTL.scala 195:28]
      b_count_1 <= 3'h0; // @[ToTL.scala 195:28]
    end else if (_T_132 & b_sel[1]) begin // @[ToTL.scala 200:33]
      b_count_1 <= _b_count_1_T_1; // @[ToTL.scala 200:37]
    end
    if (reset) begin // @[ToTL.scala 195:28]
      b_count_2 <= 3'h0; // @[ToTL.scala 195:28]
    end else if (_T_132 & b_sel[2]) begin // @[ToTL.scala 200:33]
      b_count_2 <= _b_count_2_T_1; // @[ToTL.scala 200:37]
    end
    if (reset) begin // @[ToTL.scala 195:28]
      b_count_3 <= 3'h0; // @[ToTL.scala 195:28]
    end else if (_T_132 & b_sel[3]) begin // @[ToTL.scala 200:33]
      b_count_3 <= _b_count_3_T_1; // @[ToTL.scala 200:37]
    end
    if (reset) begin // @[ToTL.scala 195:28]
      b_count_4 <= 3'h0; // @[ToTL.scala 195:28]
    end else if (_T_132 & b_sel[4]) begin // @[ToTL.scala 200:33]
      b_count_4 <= _b_count_4_T_1; // @[ToTL.scala 200:37]
    end
    `ifndef SYNTHESIS
    `ifdef STOP_COND
      if (`STOP_COND) begin
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~(~auto_in_aw_valid | w_size1 == _T_29) & _T_8) begin
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_8 & ~(~auto_in_aw_valid | w_size1 == _T_29)) begin
          $fwrite(32'h80000002,
    ...
    `ifdef STOP_COND
      if (`STOP_COND) begin
    `endif
        if (~(_T_25 | auto_in_aw_bits_len == 8'h0 | auto_in_aw_bits_size == 3'h3) & _T_8) begin
    ...
    `ifdef PRINTF_COND
      if (`PRINTF_COND) begin
    `endif
        if (_T_8 & ~(_T_25 | auto_in_aw_bits_len == 8'h0 | auto_in_aw_bits_size == 3'h3)) begin
          $fwrite(32'h80000002,
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_4 = {1{`RANDOM}};
  r_count_4 = _RAND_4[2:0];
  _RAND_5 = {1{`RANDOM}};
  beatsLeft = _RAND_5[7:0];
  _RAND_6 = {1{`RANDOM}};
  readys_mask = _RAND_6[1:0];
  _RAND_7 = {1{`RANDOM}};
  state_0 = _RAND_7[0:0];
  _RAND_8 = {1{`RANDOM}};
  w_count_0 = _RAND_8[2:0];
  _RAND_9 = {1{`RANDOM}};
  w_count_1 = _RAND_9[2:0];
  _RAND_10 = {1{`RANDOM}};
  w_count_2 = _RAND_10[2:0];
  _RAND_11 = {1{`RANDOM}};
  w_count_3 = _RAND_11[2:0];
  _RAND_12 = {1{`RANDOM}};
  w_count_4 = _RAND_12[2:0];
  _RAND_13 = {1{`RANDOM}};
  state_1 = _RAND_13[0:0];
  _RAND_14 = {1{`RANDOM}};
  d_last_counter = _RAND_14[8:0];
  _RAND_15 = {1{`RANDOM}};
  b_count_0 = _RAND_15[2:0];
  _RAND_16 = {1{`RANDOM}};
  b_count_1 = _RAND_16[2:0];
  _RAND_17 = {1{`RANDOM}};
  b_count_2 = _RAND_17[2:0];
  _RAND_18 = {1{`RANDOM}};
  b_count_3 = _RAND_18[2:0];
  _RAND_19 = {1{`RANDOM}};
  b_count_4 = _RAND_19[2:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
