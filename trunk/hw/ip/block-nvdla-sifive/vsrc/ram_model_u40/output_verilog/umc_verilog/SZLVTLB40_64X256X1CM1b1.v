...
module SZLVTLB40_64X256X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (56.1:83.2:156.6);
  parameter  Tw2r                 = (65.0:98.6:195.2);
  parameter  TOH                  = (47.3:72.0:125.4);
  parameter  TOH_2                = (48.9:74.7:131.2);
  parameter  TOH_3                = (47.3:72.0:125.4);
  parameter  TOH_4                = (45.5:68.9:119.0);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (65.0:98.6:179.3);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (66.8:101.1:171.6);
      specparam TAA_2  = (68.4:103.7:177.4);
      specparam TAA_3  = (66.8:101.1:171.6);
      specparam TAA_4  = (65.0:98.0:165.3);
      specparam TRC  = (65.0:98.6:179.3);
      specparam TRC_2    = (65.0:98.6:179.3);
      specparam TRC_3    = (65.0:98.6:179.3);
      specparam TRC_4    = (65.0:98.6:179.3);
      ...
      specparam TNAP_CSH  = (28.0:37.0:53.7);
      specparam TDVSES  = (13.1:15.1:22.5);
      specparam TDVSEH  = (51.3:79.2:133.6);
      specparam TDVSS   = (13.1:15.1:22.5);
      specparam TDVSH   = (51.3:79.2:133.6);
