...
module SZLVTLB40_16X66X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (44.5:63.9:124.6);
  parameter  Tw2r                 = (52.3:77.9:163.7);
  parameter  TOH                  = (34.5:52.6:91.6); 
  parameter  TOH_2                = (35.4:54.2:94.9); 
  parameter  TOH_3                = (34.5:52.6:91.6); 
  parameter  TOH_4                = (33.5:50.9:87.9); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (52.3:77.9:144.6);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.8:80.2:136.0);
      specparam TAA_2  = (53.6:81.8:139.4);
      specparam TAA_3  = (52.8:80.2:136.0);
      specparam TAA_4  = (51.8:78.5:132.4);
      specparam TRC  = (52.3:77.9:144.6);
      specparam TRC_2    = (52.3:77.9:144.6);
      specparam TRC_3    = (52.3:77.9:144.6);
      specparam TRC_4    = (52.3:77.9:144.6);
      specparam THPW = (8.9:14.6:24.2);
