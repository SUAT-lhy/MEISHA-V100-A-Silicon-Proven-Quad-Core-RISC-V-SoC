...
module SZLVTLB40_4X128X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (45.6:65.2:119.3);
  parameter  Tw2r                 = (54.0:79.8:164.6);
  parameter  TOH                  = (36.1:54.5:93.0); 
  parameter  TOH_2                = (37.7:57.3:97.6); 
  parameter  TOH_3                = (36.1:54.5:93.0); 
  parameter  TOH_4                = (35.2:53.1:90.3); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (54.0:79.8:148.8);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (54.6:82.4:138.0);
      specparam TAA_2  = (56.2:85.2:143.4);
      specparam TAA_3  = (54.6:82.4:138.0);
      specparam TAA_4  = (53.7:81.0:135.1);
      specparam TRC  = (54.0:79.8:148.8);
      specparam TRC_2    = (54.0:79.8:148.8);
      specparam TRC_3    = (54.0:79.8:148.8);
      specparam TRC_4    = (54.0:79.8:148.8);
      ...
      specparam TNAP_CSH  = (19.1:25.1:38.3);
      specparam TDVSES  = (12.1:13.3:21.1);
      specparam TDVSEH  = (31.0:50.2:85.7);
      specparam TDVSS   = (12.1:13.3:21.1);
      specparam TDVSH   = (31.0:50.2:85.7);
