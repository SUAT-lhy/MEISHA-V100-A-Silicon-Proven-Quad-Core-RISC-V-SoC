...
module SZLVTLB40_64X116X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (51.2:74.6:147.5);
  parameter  Tw2r                 = (58.9:88.1:183.1);
  parameter  TOH                  = (41.6:64.0:113.1);
  parameter  TOH_2                = (43.1:66.7:119.0);
  parameter  TOH_3                = (41.6:64.0:113.1);
  parameter  TOH_4                = (39.9:61.0:106.8);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (58.9:88.1:163.4);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (60.1:91.9:157.9);
      specparam TAA_2  = (61.6:94.5:163.7);
      specparam TAA_3  = (60.1:91.9:157.9);
      specparam TAA_4  = (58.3:88.9:151.6);
      specparam TRC  = (58.9:88.1:163.4);
      specparam TRC_2    = (58.9:88.1:163.4);
      specparam TRC_3    = (58.9:88.1:163.4);
      specparam TRC_4    = (58.9:88.1:163.4);
      ...
      specparam TWH  = (9.5:12.7:19.7);
      specparam TDS  = (15.4:19.4:34.3);
      specparam TDH  = (7.3:6.4:6.7);
      specparam TCSS = (20.0:24.1:39.5);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.8);
      specparam TNAP_CSH  = (23.6:31.9:51.0);
      specparam TDVSES  = (13.1:15.1:22.5);
      specparam TDVSEH  = (36.6:60.1:106.7);
      specparam TDVSS   = (13.1:15.1:22.5);
      specparam TDVSH   = (36.6:60.1:106.7);
