...
module SZLVTLL40_256X64X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (55.5:85.3:148.4);
  parameter  Tw2r                 = (61.5:94.5:183.5);
  parameter  TOH                  = (43.4:65.4:111.6);
  parameter  TOH_12               = (43.4:65.4:111.6);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (61.5:94.5:167.7);
`else
`endif
  parameter  TSLP_Q               = (98.4:142.1:233.9);
  parameter  TRET_Q               = (93.6:136.0:223.5);
  parameter  TSLP_Wakeup          = 732.0;            
  parameter  TRET_Wakeup          = 669.6;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (63.5:94.4:155.7);
      specparam TDEFAULT    = (63.5:94.4:155.7);
      specparam TAA_12  = (63.5:94.4:155.7);
      specparam TRC  = (61.5:94.5:167.7);
      specparam TRC_12    = (61.5:94.5:167.7);
      specparam THPW = (9.0:14.7:23.6);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (13.2:18.2:30.5);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (14.9:19.1:33.1);
      specparam TWH  = (4.1:6.6:12.3);
      specparam TDS  = (16.0:19.9:34.7);
      specparam TDH  = (7.8:7.4:8.9);
      specparam TCSS = (17.4:26.2:46.3);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (349.6:482.9:732.0);
      specparam TRET_CSH  = (320.2:432.8:669.6);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.5:103.6:146.5);
      specparam TDVSES  = (17.4:26.2:46.3);
      specparam TDVSEH  = (65.5:102.1:176.4);
      specparam TDVSS   = (17.4:26.2:46.3);
      specparam TDVSH   = (65.5:102.1:176.4);
