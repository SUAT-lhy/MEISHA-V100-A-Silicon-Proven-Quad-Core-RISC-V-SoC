...
module SZLVTLB40_16X256X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (50.6:74.0:136.5);
  parameter  Tw2r                 = (60.0:90.6:179.1);
  parameter  TOH                  = (41.7:62.8:107.4);
  parameter  TOH_2                = (42.7:64.4:110.8);
  parameter  TOH_3                = (41.7:62.8:107.4);
  parameter  TOH_4                = (40.6:61.0:103.7);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (60.0:90.6:164.8);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (61.2:91.9:153.7);
      specparam TAA_2  = (62.2:93.4:157.0);
      specparam TAA_3  = (61.2:91.9:153.7);
      specparam TAA_4  = (60.1:90.1:150.0);
      specparam TRC  = (60.0:90.6:164.8);
      specparam TRC_2    = (60.0:90.6:164.8);
      specparam TRC_3    = (60.0:90.6:164.8);
      specparam TRC_4    = (60.0:90.6:164.8);
      ...
      specparam TNAP_CSH  = (22.8:29.7:42.6);
      specparam TDVSES  = (12.1:13.3:21.1);
      specparam TDVSEH  = (45.1:69.2:114.6);
      specparam TDVSS   = (12.1:13.3:21.1);
      specparam TDVSH   = (45.1:69.2:114.6);
