...
module SZLVTLB40_8X66X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (44.1:63.1:116.3);
  parameter  Tw2r                 = (51.8:77.0:160.5);
  parameter  TOH                  = (34.0:51.7:88.8); 
  parameter  TOH_2                = (35.6:54.4:93.3); 
  parameter  TOH_3                = (34.0:51.7:88.8); 
  parameter  TOH_4                = (33.2:50.3:86.1); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (51.8:77.0:142.8);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.3:79.3:133.3);
      specparam TAA_2  = (53.9:82.1:138.7);
      specparam TAA_3  = (52.3:79.3:133.3);
      specparam TAA_4  = (51.5:77.9:130.6);
      specparam TRC  = (51.8:77.0:142.8);
      specparam TRC_2    = (51.8:77.0:142.8);
      specparam TRC_3    = (51.8:77.0:142.8);
      specparam TRC_4    = (51.8:77.0:142.8);
      ...
      specparam TDVSEH  = (25.7:43.4:76.0);
      specparam TDVSS   = (12.1:13.3:21.1);
      specparam TDVSH   = (25.7:43.4:76.0);
