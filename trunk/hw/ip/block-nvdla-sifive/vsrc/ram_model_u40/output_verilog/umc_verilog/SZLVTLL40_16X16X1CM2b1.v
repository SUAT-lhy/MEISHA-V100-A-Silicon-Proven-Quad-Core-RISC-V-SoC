...
module SZLVTLL40_16X16X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (44.0:67.6:129.7);
  parameter  Tw2r                 = (50.9:75.2:153.8);
  parameter  TOH                  = (30.0:45.5:77.2); 
  parameter  TOH_12               = (30.0:45.5:77.2); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (50.9:75.2:133.9);
`else
`endif
  parameter  TSLP_Q               = (58.6:86.7:144.5);
  parameter  TRET_Q               = (53.8:80.6:134.1);
  parameter  TSLP_Wakeup          = 469.4;            
  parameter  TRET_Wakeup          = 452.3;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (50.0:74.4:121.3);
      specparam TDEFAULT    = (50.0:74.4:121.3);
      specparam TAA_12  = (50.0:74.4:121.3);
      specparam TRC  = (50.9:75.2:133.9);
      specparam TRC_12    = (50.9:75.2:133.9);
      ...
      specparam TWH  = (2.5:4.4:8.9);
      specparam TDS  = (17.4:22.0:38.2);
      specparam TDH  = (5.5:4.0:3.7);
      specparam TCSS = (17.2:23.3:41.8);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.8:33.2);
      specparam TRETH  = (7.6:16.8:33.2);
      specparam TSLP_CSH  = (220.5:303.9:469.4);
      specparam TRET_CSH  = (216.5:294.3:452.3);
      specparam TNAPH  = (7.6:16.8:33.2);
      specparam TNAP_CSH  = (84.3:102.1:139.5);
      specparam TDVSES  = (17.2:23.3:41.8);
      specparam TDVSEH  = (41.4:66.6:114.4);
      specparam TDVSS   = (17.2:23.3:41.8);
      specparam TDVSH   = (41.4:66.6:114.4);
