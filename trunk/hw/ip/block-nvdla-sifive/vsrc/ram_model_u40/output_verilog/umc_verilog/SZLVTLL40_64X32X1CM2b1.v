...
module SZLVTLL40_64X32X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (49.0:74.0:138.8);
  parameter  Tw2r                 = (53.5:79.3:160.8);
  parameter  TOH                  = (35.4:53.2:90.4); 
  parameter  TOH_12               = (35.4:53.2:90.4); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.5:79.3:140.5);
`else
`endif
  parameter  TSLP_Q               = (72.2:105.8:175.5);
  parameter  TRET_Q               = (67.5:99.7:165.1);
  parameter  TSLP_Wakeup          = 544.0;            
  parameter  TRET_Wakeup          = 514.0;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (55.3:82.0:134.5);
      specparam TDEFAULT    = (55.3:82.0:134.5);
      specparam TAA_12  = (55.3:82.0:134.5);
      specparam TRC  = (53.5:79.3:140.5);
      specparam TRC_12    = (53.5:79.3:140.5);
      ...
      specparam TCSS = (16.9:23.9:42.5);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (254.1:356.8:544.0);
      specparam TRET_CSH  = (246.2:334.1:514.0);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.4:102.3:140.6);
      specparam TDVSES  = (16.9:23.9:42.5);
      specparam TDVSEH  = (51.4:80.7:139.3);
      specparam TDVSS   = (16.9:23.9:42.5);
      specparam TDVSH   = (51.4:80.7:139.3);
