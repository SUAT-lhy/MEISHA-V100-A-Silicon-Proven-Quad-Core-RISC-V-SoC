...
module SZLVTLB40_16X64X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (44.4:63.8:124.5);
  parameter  Tw2r                 = (52.3:77.8:163.6);
  parameter  TOH                  = (34.4:52.5:91.4); 
  parameter  TOH_2                = (35.3:54.1:94.8); 
  parameter  TOH_3                = (34.4:52.5:91.4); 
  parameter  TOH_4                = (33.4:50.8:87.8); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (52.3:77.8:144.4);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.7:80.1:135.9);
      specparam TAA_2  = (53.6:81.7:139.3);
      specparam TAA_3  = (52.7:80.1:135.9);
      specparam TAA_4  = (51.7:78.4:132.3);
      specparam TRC  = (52.3:77.8:144.4);
      specparam TRC_2    = (52.3:77.8:144.4);
      specparam TRC_3    = (52.3:77.8:144.4);
      specparam TRC_4    = (52.3:77.8:144.4);
      ...
      specparam TDVSEH  = (26.2:44.5:79.4);
      specparam TDVSS   = (12.1:13.3:21.1);
      specparam TDVSH   = (26.2:44.5:79.4);
