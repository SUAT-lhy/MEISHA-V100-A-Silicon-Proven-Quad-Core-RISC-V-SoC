...
module SZLVTLB40_160X258X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (65.8:99.6:192.6);
  parameter  Tw2r                 = (73.4:112.9:224.4);
  parameter  TOH                  = (56.9:88.1:157.4);
  parameter  TOH_2                = (59.9:93.1:168.3);
  parameter  TOH_3                = (56.9:88.1:157.4);
  parameter  TOH_4                = (53.8:82.6:146.0);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (73.4:112.9:206.2);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (76.4:117.2:203.6);
      specparam TAA_2  = (79.3:122.1:214.4);
      specparam TAA_3  = (76.4:117.2:203.6);
      specparam TAA_4  = (73.3:111.7:192.2);
      specparam TRC  = (73.4:112.9:206.2);
      specparam TRC_2    = (73.4:112.9:206.2);
      specparam TRC_3    = (73.4:112.9:206.2);
      specparam TRC_4    = (73.4:112.9:206.2);
      specparam THPW = (9.3:15.1:24.9);
      specparam TLPW = (19.7:22.5:35.8);
      specparam TAS  = (13.6:15.8:23.5);
      specparam TAH  = (13.1:16.5:23.0);
      specparam TWS  = (11.3:14.8:26.5);
      specparam TWH  = (10.2:13.7:21.1);
      specparam TDS  = (14.9:18.6:32.7);
      specparam TDH  = (9.6:9.5:11.1);
      specparam TCSS = (20.5:24.8:40.5);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.9);
      specparam TNAP_CSH  = (35.6:47.9:70.9);
      specparam TDVSES  = (13.6:15.8:23.5);
      specparam TDVSEH  = (61.7:96.4:167.4);
      specparam TDVSS   = (13.6:15.8:23.5);
      specparam TDVSH   = (61.7:96.4:167.4);
