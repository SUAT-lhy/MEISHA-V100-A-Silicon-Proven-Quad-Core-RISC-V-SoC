...
module SZLVTLL40_256X16X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (50.7:77.2:137.8);
  parameter  Tw2r                 = (56.0:82.9:165.2);
  parameter  TOH                  = (36.8:55.5:95.1); 
  parameter  TOH_12               = (36.8:55.5:95.1); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (56.0:82.9:147.8);
`else
`endif
  parameter  TSLP_Q               = (61.9:91.7:150.4);
  parameter  TRET_Q               = (57.1:85.1:140.1);
  parameter  TSLP_Wakeup          = 546.5;            
  parameter  TRET_Wakeup          = 510.5;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (56.9:84.7:139.8);
      specparam TDEFAULT    = (56.9:84.7:139.8);
      specparam TAA_12  = (56.9:84.7:139.8);
      specparam TRC  = (56.0:82.9:147.8);
      specparam TRC_12    = (56.0:82.9:147.8);
      specparam THPW = (9.4:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.8:26.5);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (15.8:19.2:32.2);
      specparam TWH  = (5.2:6.5:11.2);
      specparam TDS  = (16.5:20.6:36.0);
      specparam TDH  = (5.6:4.4:4.8);
      specparam TCSS = (16.2:24.0:42.6);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (253.9:359.1:546.5);
      specparam TRET_CSH  = (241.4:329.6:510.5);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.9:101.9:141.4);
      specparam TDVSES  = (16.2:24.0:42.6);
      specparam TDVSEH  = (54.8:86.2:149.3);
      specparam TDVSS   = (16.2:24.0:42.6);
      specparam TDVSH   = (54.8:86.2:149.3);
