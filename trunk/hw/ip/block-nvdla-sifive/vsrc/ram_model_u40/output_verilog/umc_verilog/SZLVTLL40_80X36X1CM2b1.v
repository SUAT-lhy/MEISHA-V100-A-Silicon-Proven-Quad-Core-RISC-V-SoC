...
module SZLVTLL40_80X36X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (49.7:75.1:137.1);
  parameter  Tw2r                 = (54.2:80.4:162.7);
  parameter  TOH                  = (36.2:54.4:92.5); 
  parameter  TOH_12               = (36.2:54.4:92.5); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (54.2:80.4:142.4);
`else
`endif
  parameter  TSLP_Q               = (75.7:110.6:183.3);
  parameter  TRET_Q               = (70.9:104.5:172.9);
  parameter  TSLP_Wakeup          = 564.3;            
  parameter  TRET_Wakeup          = 530.7;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (56.1:83.2:136.5);
      specparam TDEFAULT    = (56.1:83.2:136.5);
      specparam TAA_12  = (56.1:83.2:136.5);
      specparam TRC  = (54.2:80.4:142.4);
      specparam TRC_12    = (54.2:80.4:142.4);
      specparam THPW = (8.7:14.3:23.2);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (11.7:15.9:26.8);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (15.2:19.5:33.8);
      specparam TWH  = (3.2:5.4:10.4);
      specparam TDS  = (16.8:21.0:36.5);
      specparam TDH  = (6.5:5.5:5.9);
      specparam TCSS = (16.9:23.9:42.6);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (263.9:371.0:564.3);
      specparam TRET_CSH  = (254.4:344.9:530.7);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.4:102.3:141.0);
      specparam TDVSES  = (16.9:23.9:42.6);
      specparam TDVSEH  = (52.7:82.7:142.7);
      specparam TDVSS   = (16.9:23.9:42.6);
      specparam TDVSH   = (52.7:82.7:142.7);
