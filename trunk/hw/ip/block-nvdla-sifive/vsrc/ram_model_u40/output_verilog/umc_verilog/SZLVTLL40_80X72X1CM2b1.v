...
module SZLVTLL40_80X72X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (52.0:79.2:137.0);
  parameter  Tw2r                 = (56.5:83.3:167.0);
  parameter  TOH                  = (39.7:59.5:100.6);
  parameter  TOH_12               = (39.7:59.5:100.6);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (56.5:83.3:151.3);
`else
`endif
  parameter  TSLP_Q               = (104.6:150.8:248.0);
  parameter  TRET_Q               = (99.9:144.7:237.6);
  parameter  TSLP_Wakeup          = 665.9;            
  parameter  TRET_Wakeup          = 619.3;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (59.8:88.6:144.8);
      specparam TDEFAULT    = (59.8:88.6:144.8);
      specparam TAA_12  = (59.8:88.6:144.8);
      specparam TRC  = (56.5:83.3:151.3);
      specparam TRC_12    = (56.5:83.3:151.3);
      specparam THPW = (8.7:14.3:23.2);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (11.7:15.9:26.8);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (14.9:19.0:32.9);
      specparam TWH  = (4.3:6.9:12.7);
      specparam TDS  = (15.8:19.6:34.1);
      specparam TDH  = (8.2:7.9:9.7);
      specparam TCSS = (16.4:23.9:42.6);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (311.0:441.7:665.9);
      specparam TRET_CSH  = (299.8:404.5:619.3);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.4:102.3:141.0);
      specparam TDVSES  = (16.4:23.9:42.6);
      specparam TDVSEH  = (58.2:90.8:155.3);
      specparam TDVSS   = (16.4:23.9:42.6);
      specparam TDVSH   = (58.2:90.8:155.3);
