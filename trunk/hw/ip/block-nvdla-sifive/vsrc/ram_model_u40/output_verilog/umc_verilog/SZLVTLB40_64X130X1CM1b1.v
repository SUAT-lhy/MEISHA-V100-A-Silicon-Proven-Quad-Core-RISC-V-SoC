...
module SZLVTLB40_64X130X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (51.6:75.2:148.3);
  parameter  Tw2r                 = (59.4:88.8:184.0);
  parameter  TOH                  = (42.1:64.8:114.2);
  parameter  TOH_2                = (43.7:67.4:120.1);
  parameter  TOH_3                = (42.1:64.8:114.2);
  parameter  TOH_4                = (40.4:61.7:107.9);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (59.4:88.8:164.8);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (60.6:92.7:159.1);
      specparam TAA_2  = (62.2:95.3:164.9);
      specparam TAA_3  = (60.6:92.7:159.1);
      specparam TAA_4  = (58.9:89.6:152.8);
      specparam TRC  = (59.4:88.8:164.8);
      specparam TRC_2    = (59.4:88.8:164.8);
      specparam TRC_3    = (59.4:88.8:164.8);
      specparam TRC_4    = (59.4:88.8:164.8);
