...
module SZLVTLL40_80X15X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (46.1:70.7:136.7);
  parameter  Tw2r                 = (53.4:78.5:156.9);
  parameter  TOH                  = (31.9:48.6:82.7); 
  parameter  TOH_12               = (31.9:48.6:82.7); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.4:78.5:139.8);
`else
`endif
  parameter  TSLP_Q               = (60.7:90.0:147.7);
  parameter  TRET_Q               = (55.9:83.5:137.6);
  parameter  TSLP_Wakeup          = 498.6;            
  parameter  TRET_Wakeup          = 472.9;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.4:78.2:128.1);
      specparam TDEFAULT    = (52.4:78.2:128.1);
      specparam TAA_12  = (52.4:78.2:128.1);
      specparam TRC  = (53.4:78.5:139.8);
      specparam TRC_12    = (53.4:78.5:139.8);
      specparam THPW = (9.4:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.8:26.4);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (15.8:19.2:32.3);
      specparam TWH  = (5.1:6.4:11.0);
      specparam TDS  = (16.5:20.7:36.1);
      specparam TDH  = (5.5:4.3:4.6);
      specparam TCSS = (16.2:23.9:42.5);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (231.4:325.4:498.6);
      specparam TRET_CSH  = (225.6:307.4:472.9);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.4:138.8);
      specparam TDVSES  = (16.2:23.9:42.5);
      specparam TDVSEH  = (45.5:73.1:125.5);
      specparam TDVSS   = (16.2:23.9:42.5);
      specparam TDVSH   = (45.5:73.1:125.5);
