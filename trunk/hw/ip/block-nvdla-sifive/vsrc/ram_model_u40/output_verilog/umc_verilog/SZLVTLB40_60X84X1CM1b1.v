...
module SZLVTLB40_60X84X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (49.9:72.7:144.1);
  parameter  Tw2r                 = (57.3:86.0:179.8);
  parameter  TOH                  = (40.0:61.7:109.2);
  parameter  TOH_2                = (41.5:64.3:114.9);
  parameter  TOH_3                = (40.0:61.7:109.2);
  parameter  TOH_4                = (38.4:58.8:103.1);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (57.3:86.0:159.3);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (58.4:89.4:153.8);
      specparam TAA_2  = (59.8:92.0:159.5);
      specparam TAA_3  = (58.4:89.4:153.8);
      specparam TAA_4  = (56.7:86.5:147.7);
      specparam TRC  = (57.3:86.0:159.3);
      specparam TRC_2    = (57.3:86.0:159.3);
      specparam TRC_3    = (57.3:86.0:159.3);
      specparam TRC_4    = (57.3:86.0:159.3);
      ...
      specparam TWH  = (9.3:12.5:19.4);
      specparam TDS  = (15.7:19.8:34.8);
      specparam TDH  = (6.9:5.8:5.8);
      specparam TCSS = (20.0:24.1:39.5);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.8);
      specparam TNAP_CSH  = (22.4:30.9:49.4);
      specparam TDVSES  = (13.1:15.1:22.5);
      specparam TDVSEH  = (33.3:55.7:100.0);
      specparam TDVSS   = (13.1:15.1:22.5);
      specparam TDVSH   = (33.3:55.7:100.0);
