...
module SZLVTLB40_8X130X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (45.7:65.2:119.4);
  parameter  Tw2r                 = (54.1:79.9:164.7);
  parameter  TOH                  = (36.1:54.6:93.2); 
  parameter  TOH_2                = (37.8:57.4:97.8); 
  parameter  TOH_3                = (36.1:54.6:93.2); 
  parameter  TOH_4                = (35.3:53.1:90.4); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (54.1:79.9:149.0);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (54.7:82.5:138.1);
      specparam TAA_2  = (56.3:85.3:143.5);
      specparam TAA_3  = (54.7:82.5:138.1);
      specparam TAA_4  = (53.8:81.1:135.2);
      specparam TRC  = (54.1:79.9:149.0);
      specparam TRC_2    = (54.1:79.9:149.0);
      specparam TRC_3    = (54.1:79.9:149.0);
      specparam TRC_4    = (54.1:79.9:149.0);
      specparam THPW = (8.8:14.5:24.1);
      specparam TLPW = (19.7:22.5:35.7);
      specparam TAS  = (12.1:13.3:21.1);
      specparam TAH  = (13.1:16.5:23.0);
      specparam TWS  = (10.9:14.2:25.5);
      specparam TWH  = (9.6:12.9:19.9);
      specparam TDS  = (15.3:19.3:34.0);
      specparam TDH  = (7.5:6.6:7.0);
      specparam TCSS = (19.0:22.3:38.1);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.8);
      specparam TNAP_CSH  = (19.1:25.2:38.3);
      specparam TDVSES  = (12.1:13.3:21.1);
      specparam TDVSEH  = (31.1:50.4:86.0);
      specparam TDVSS   = (12.1:13.3:21.1);
      specparam TDVSH   = (31.1:50.4:86.0);
