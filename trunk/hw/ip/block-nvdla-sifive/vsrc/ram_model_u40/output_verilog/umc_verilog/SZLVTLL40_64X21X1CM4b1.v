...
module SZLVTLL40_64X21X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (46.4:71.0:134.2);
  parameter  Tw2r                 = (53.4:78.4:156.6);
  parameter  TOH                  = (32.3:49.2:83.3); 
  parameter  TOH_12               = (32.3:49.2:83.3); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.4:78.4:139.3);
`else
`endif
  parameter  TSLP_Q               = (67.5:99.6:163.1);
  parameter  TRET_Q               = (62.7:93.0:153.0);
  parameter  TSLP_Wakeup          = 520.0;            
  parameter  TRET_Wakeup          = 491.9;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.9:78.8:128.7);
      specparam TDEFAULT    = (52.9:78.8:128.7);
      specparam TAA_12  = (52.9:78.8:128.7);
      specparam TRC  = (53.4:78.4:139.3);
      specparam TRC_12    = (53.4:78.4:139.3);
      specparam THPW = (9.0:14.7:23.9);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.3:15.2:25.5);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (15.6:18.9:31.9);
      specparam TWH  = (5.4:6.8:11.7);
      specparam TDS  = (16.2:20.3:35.5);
      specparam TDH  = (5.9:4.9:5.5);
      specparam TCSS = (15.8:23.3:41.6);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (240.7:339.2:520.0);
      specparam TRET_CSH  = (235.2:319.9:491.9);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.4:138.7);
      specparam TDVSES  = (15.8:23.3:41.6);
      specparam TDVSEH  = (45.7:73.3:125.4);
      specparam TDVSS   = (15.8:23.3:41.6);
      specparam TDVSH   = (45.7:73.3:125.4);
