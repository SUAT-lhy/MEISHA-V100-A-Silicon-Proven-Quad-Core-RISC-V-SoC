...
module SZLVTLB40_64X66X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (49.7:72.6:144.6);
  parameter  Tw2r                 = (57.0:85.8:179.8);
  parameter  TOH                  = (39.8:61.5:109.2);
  parameter  TOH_2                = (41.3:64.2:115.0);
  parameter  TOH_3                = (39.8:61.5:109.2);
  parameter  TOH_4                = (38.0:58.5:102.8);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (57.0:85.8:158.6);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (58.0:89.1:153.6);
      specparam TAA_2  = (59.6:91.8:159.5);
      specparam TAA_3  = (58.0:89.1:153.6);
      specparam TAA_4  = (56.3:86.1:147.3);
      specparam TRC  = (57.0:85.8:158.6);
      specparam TRC_2    = (57.0:85.8:158.6);
      specparam TRC_3    = (57.0:85.8:158.6);
      specparam TRC_4    = (57.0:85.8:158.6);
      ...
      specparam TNAP_CSH  = (22.5:31.1:49.6);
      specparam TDVSES  = (13.1:15.1:22.5);
      specparam TDVSEH  = (32.1:54.3:98.4);
      specparam TDVSS   = (13.1:15.1:22.5);
      specparam TDVSH   = (32.1:54.3:98.4);
