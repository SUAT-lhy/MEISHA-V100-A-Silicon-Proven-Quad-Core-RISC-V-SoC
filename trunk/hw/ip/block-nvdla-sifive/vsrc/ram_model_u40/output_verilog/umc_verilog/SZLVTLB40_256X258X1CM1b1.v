...
module SZLVTLB40_256X258X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (76.3:115.5:227.3);
  parameter  Tw2r                 = (83.5:129.0:253.3);
  parameter  TOH                  = (66.1:103.5:188.2);
  parameter  TOH_2                = (70.4:110.8:204.1);
  parameter  TOH_3                = (66.1:103.5:188.2);
  parameter  TOH_4                = (61.6:95.7:171.7);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (83.5:129.0:232.2);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (85.6:132.6:234.4);
      specparam TAA_2  = (89.9:139.8:250.3);
      specparam TAA_3  = (85.6:132.6:234.4);
      specparam TAA_4  = (81.1:124.7:217.9);
      specparam TRC  = (83.5:129.0:232.2);
      specparam TRC_2    = (83.5:129.0:232.2);
      specparam TRC_3    = (83.5:129.0:232.2);
      specparam TRC_4    = (83.5:129.0:232.2);
      ...
      specparam TNAP_CSH  = (42.6:57.8:87.0);
      specparam TDVSES  = (14.0:16.4:24.4);
      specparam TDVSEH  = (71.6:112.7:199.8);
      specparam TDVSS   = (14.0:16.4:24.4);
      specparam TDVSH   = (71.6:112.7:199.8);
