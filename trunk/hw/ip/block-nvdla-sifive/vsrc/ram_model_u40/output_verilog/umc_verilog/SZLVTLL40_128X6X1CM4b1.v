...
module SZLVTLL40_128X6X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (47.6:72.8:137.4);
  parameter  Tw2r                 = (53.0:78.3:157.0);
  parameter  TOH                  = (33.4:50.4:86.3); 
  parameter  TOH_12               = (33.4:50.4:86.3); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.0:78.3:139.9);
`else
`endif
  parameter  TSLP_Q               = (50.1:75.1:123.3);
  parameter  TRET_Q               = (45.3:68.6:113.2);
  parameter  TSLP_Wakeup          = 465.7;            
  parameter  TRET_Wakeup          = 444.3;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (53.4:79.5:131.1);
      specparam TDEFAULT    = (53.4:79.5:131.1);
      specparam TAA_12  = (53.4:79.5:131.1);
      specparam TRC  = (53.0:78.3:139.9);
      specparam TRC_12    = (53.0:78.3:139.9);
      specparam THPW = (9.3:15.0:24.0);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.7:26.4);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (16.2:19.7:33.2);
      specparam TWH  = (4.5:5.6:9.8);
      specparam TDS  = (16.9:21.4:37.2);
      specparam TDH  = (4.9:3.4:3.2);
      specparam TCSS = (16.2:23.9:42.4);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (216.8:303.7:465.7);
      specparam TRET_CSH  = (210.6:287.9:444.3);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.5:139.4);
      specparam TDVSES  = (16.2:23.9:42.4);
      specparam TDVSEH  = (49.0:77.5:134.3);
      specparam TDVSS   = (16.2:23.9:42.4);
      specparam TDVSH   = (49.0:77.5:134.3);
