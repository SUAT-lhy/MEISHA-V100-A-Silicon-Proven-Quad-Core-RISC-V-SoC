...
module SZLVTLL40_128X11X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (48.5:73.8:138.5);
  parameter  Tw2r                 = (53.6:79.0:158.1);
  parameter  TOH                  = (34.3:51.7:88.4); 
  parameter  TOH_12               = (34.3:51.7:88.4); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.6:79.0:141.0);
`else
`endif
  parameter  TSLP_Q               = (56.1:83.5:137.0);
  parameter  TRET_Q               = (51.3:77.0:126.9);
  parameter  TSLP_Wakeup          = 490.8;            
  parameter  TRET_Wakeup          = 465.5;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (54.4:80.9:133.2);
      specparam TDEFAULT    = (54.4:80.9:133.2);
      specparam TAA_12  = (54.4:80.9:133.2);
      specparam TRC  = (53.6:79.0:141.0);
      specparam TRC_12    = (53.6:79.0:141.0);
      ...
      specparam TSLP_CSH  = (228.2:321.1:490.8);
      specparam TRET_CSH  = (221.1:301.9:465.5);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.5:139.4);
      specparam TDVSES  = (16.2:23.9:42.5);
      specparam TDVSEH  = (50.5:79.6:137.6);
      specparam TDVSS   = (16.2:23.9:42.5);
      specparam TDVSH   = (50.5:79.6:137.6);
