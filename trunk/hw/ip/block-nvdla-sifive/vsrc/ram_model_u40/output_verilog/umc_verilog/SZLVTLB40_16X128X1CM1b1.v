...
module SZLVTLB40_16X128X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (46.3:66.4:128.2);
  parameter  Tw2r                 = (54.6:80.8:167.8);
  parameter  TOH                  = (36.7:55.8:96.5); 
  parameter  TOH_2                = (37.6:57.3:99.8); 
  parameter  TOH_3                = (36.7:55.8:96.5); 
  parameter  TOH_4                = (35.7:54.0:92.9); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (54.6:80.8:150.5);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (55.3:83.7:141.3);
      specparam TAA_2  = (56.1:85.2:144.6);
      specparam TAA_3  = (55.3:83.7:141.3);
      specparam TAA_4  = (54.2:81.9:137.7);
      specparam TRC  = (54.6:80.8:150.5);
      specparam TRC_2    = (54.6:80.8:150.5);
      specparam TRC_3    = (54.6:80.8:150.5);
      specparam TRC_4    = (54.6:80.8:150.5);
      ...
      specparam TNAP_CSH  = (20.0:26.2:40.2);
      specparam TDVSES  = (12.1:13.3:21.1);
      specparam TDVSEH  = (31.8:51.9:90.0);
      specparam TDVSS   = (12.1:13.3:21.1);
      specparam TDVSH   = (31.8:51.9:90.0);
