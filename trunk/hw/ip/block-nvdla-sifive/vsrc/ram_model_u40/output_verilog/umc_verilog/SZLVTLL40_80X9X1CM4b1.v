...
module SZLVTLL40_80X9X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (45.1:69.2:133.7);
  parameter  Tw2r                 = (52.7:77.6:155.5);
  parameter  TOH                  = (31.0:47.3:80.5); 
  parameter  TOH_12               = (31.0:47.3:80.5); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (52.7:77.6:138.4);
`else
`endif
  parameter  TSLP_Q               = (53.8:80.2:131.8);
  parameter  TRET_Q               = (49.0:73.7:121.6);
  parameter  TSLP_Wakeup          = 470.3;            
  parameter  TRET_Wakeup          = 449.1;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (51.4:76.8:125.8);
      specparam TDEFAULT    = (51.4:76.8:125.8);
      specparam TAA_12  = (51.4:76.8:125.8);
      specparam TRC  = (52.7:77.6:138.4);
      specparam TRC_12    = (52.7:77.6:138.4);
      specparam THPW = (9.3:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.8:26.4);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (16.0:19.5:32.8);
      specparam TWH  = (4.7:5.9:10.2);
      specparam TDS  = (16.8:21.1:36.9);
      specparam TDH  = (5.1:3.7:3.7);
      specparam TCSS = (16.2:23.9:42.5);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (219.1:306.3:470.3);
      specparam TRET_CSH  = (213.8:291.7:449.1);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.4:138.8);
      specparam TDVSES  = (16.2:23.9:42.5);
      specparam TDVSEH  = (44.1:71.0:122.1);
      specparam TDVSS   = (16.2:23.9:42.5);
      specparam TDVSH   = (44.1:71.0:122.1);
