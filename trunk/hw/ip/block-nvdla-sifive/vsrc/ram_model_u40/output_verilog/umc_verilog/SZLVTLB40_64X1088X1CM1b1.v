module SZLVTLB40_64X1088X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
    ...
    SZLVTLB40_64X272X1CM1b1 ram_high2 (
        .A(A),
        .B(B),
        .DO(DO[1087:816]),
        .DI(DI[1087:816]),
    ...
    SZLVTLB40_64X272X1CM1b1 ram_high (
        .A(A),
        .B(B),
        .DO(DO[815:544]),
        .DI(DI[815:544]),
    ...
    SZLVTLB40_64X272X1CM1b1 ram_low2 (
        .A(A),
        .B(B),
        .DO(DO[543:272]),
        .DI(DI[543:272]),
    ...
    SZLVTLB40_64X272X1CM1b1 ram_low  (
        .A(A),
        .B(B),
        .DO(DO[271:0]),
        .DI(DI[271:0]),
