...
module SZLVTLL40_64X18X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (46.0:70.6:136.8);
  parameter  Tw2r                 = (53.0:77.9:155.9);
  parameter  TOH                  = (31.9:48.5:82.3); 
  parameter  TOH_12               = (31.9:48.5:82.3); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.0:77.9:138.6);
`else
`endif
  parameter  TSLP_Q               = (64.2:94.9:155.6);
  parameter  TRET_Q               = (59.4:88.4:145.5);
  parameter  TSLP_Wakeup          = 506.7;            
  parameter  TRET_Wakeup          = 480.6;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.4:78.1:127.6);
      specparam TDEFAULT    = (52.4:78.1:127.6);
      specparam TAA_12  = (52.4:78.1:127.6);
      specparam TRC  = (53.0:77.9:138.6);
      specparam TRC_12    = (53.0:77.9:138.6);
      specparam THPW = (9.0:14.7:23.9);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.3:15.2:25.5);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (15.7:19.0:32.1);
      specparam TWH  = (5.3:6.6:11.4);
      specparam TDS  = (16.4:20.5:35.8);
      ...
      specparam TSLP_CSH  = (235.1:330.3:506.7);
      specparam TRET_CSH  = (229.6:312.4:480.6);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.4:138.7);
      specparam TDVSES  = (15.8:23.3:41.6);
      specparam TDVSEH  = (45.0:72.3:123.7);
      specparam TDVSS   = (15.8:23.3:41.6);
      specparam TDVSH   = (45.0:72.3:123.7);
