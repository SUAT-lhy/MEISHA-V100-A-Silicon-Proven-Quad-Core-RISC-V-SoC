...
module SZLVTLL40_512X64X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (60.6:93.4:165.3);
  parameter  Tw2r                 = (72.4:113.2:216.4);
  parameter  TOH                  = (48.8:73.9:127.5);
  parameter  TOH_12               = (48.8:73.9:127.5);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (72.4:113.2:200.9);
`else
`endif
  parameter  TSLP_Q               = (98.4:142.1:234.0);
  parameter  TRET_Q               = (93.6:136.0:223.5);
  parameter  TSLP_Wakeup          = 844.0;            
  parameter  TRET_Wakeup          = 760.7;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (69.0:102.9:171.5);
      specparam TDEFAULT    = (69.0:102.9:171.5);
      specparam TAA_12  = (69.0:102.9:171.5);
      specparam TRC  = (72.4:113.2:200.9);
      specparam TRC_12    = (72.4:113.2:200.9);
      specparam THPW = (9.0:14.7:23.6);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (13.6:18.9:31.5);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (14.9:19.1:33.1);
      specparam TWH  = (4.1:6.6:12.2);
      specparam TDS  = (16.0:19.9:34.7);
      specparam TDH  = (7.8:7.4:8.9);
      specparam TCSS = (17.8:26.8:47.3);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (406.8:554.3:844.0);
      specparam TRET_CSH  = (362.6:490.1:760.7);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.9:106.3:153.8);
      specparam TDVSES  = (17.8:26.8:47.3);
      specparam TDVSEH  = (75.8:118.2:206.5);
      specparam TDVSS   = (17.8:26.8:47.3);
      specparam TDVSH   = (75.8:118.2:206.5);
