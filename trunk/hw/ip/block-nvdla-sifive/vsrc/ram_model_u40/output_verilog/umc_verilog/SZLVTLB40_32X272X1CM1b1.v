...
module SZLVTLB40_32X272X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (54.2:78.6:145.0);
  parameter  Tw2r                 = (62.7:95.0:186.9);
  parameter  TOH                  = (44.5:67.1:115.4);
  parameter  TOH_2                = (45.6:69.0:119.5);
  parameter  TOH_3                = (44.5:67.1:115.4);
  parameter  TOH_4                = (43.1:64.9:110.8);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (62.7:95.0:171.9);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (64.1:96.4:161.8);
      specparam TAA_2  = (65.2:98.2:165.9);
      specparam TAA_3  = (64.1:96.4:161.8);
      specparam TAA_4  = (62.7:94.1:157.2);
      specparam TRC  = (62.7:95.0:171.9);
      specparam TRC_2    = (62.7:95.0:171.9);
      specparam TRC_3    = (62.7:95.0:171.9);
      specparam TRC_4    = (62.7:95.0:171.9);
      ...
      specparam TNAP_CSH  = (25.2:32.9:47.2);
      specparam TDVSES  = (13.1:15.1:22.4);
      specparam TDVSEH  = (49.3:75.3:124.9);
      specparam TDVSS   = (13.1:15.1:22.4);
      specparam TDVSH   = (49.3:75.3:124.9);
