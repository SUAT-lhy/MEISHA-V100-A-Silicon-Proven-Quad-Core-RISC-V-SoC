...
module SZLVTLL40_80X16X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (46.3:70.9:137.2);
  parameter  Tw2r                 = (53.5:78.7:157.2);
  parameter  TOH                  = (32.1:48.8:83.0); 
  parameter  TOH_12               = (32.1:48.8:83.0); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.5:78.7:140.0);
`else
`endif
  parameter  TSLP_Q               = (61.9:91.7:150.4);
  parameter  TRET_Q               = (57.1:85.1:140.2);
  parameter  TSLP_Wakeup          = 503.3;            
  parameter  TRET_Wakeup          = 476.8;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.6:78.4:128.4);
      specparam TDEFAULT    = (52.6:78.4:128.4);
      specparam TAA_12  = (52.6:78.4:128.4);
      specparam TRC  = (53.5:78.7:140.0);
      specparam TRC_12    = (53.5:78.7:140.0);
      specparam THPW = (9.4:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.8:26.4);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (15.8:19.1:32.2);
      specparam TWH  = (5.2:6.4:11.1);
      ...
      specparam TSLP_CSH  = (233.5:328.5:503.3);
      specparam TRET_CSH  = (227.6:310.0:476.8);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.4:138.8);
      specparam TDVSES  = (16.2:23.9:42.5);
      specparam TDVSEH  = (45.7:73.5:126.0);
      specparam TDVSS   = (16.2:23.9:42.5);
      specparam TDVSH   = (45.7:73.5:126.0);
