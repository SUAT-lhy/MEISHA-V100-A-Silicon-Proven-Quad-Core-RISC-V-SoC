...
module SZLVTLL40_24X32X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (45.1:69.0:134.9);
  parameter  Tw2r                 = (52.0:76.8:156.2);
  parameter  TOH                  = (31.5:47.8:80.9); 
  parameter  TOH_12               = (31.5:47.8:80.9); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (52.0:76.8:136.3);
`else
`endif
  parameter  TSLP_Q               = (72.3:105.9:175.6);
  parameter  TRET_Q               = (67.5:99.8:165.1);
  parameter  TSLP_Wakeup          = 522.0;            
  parameter  TRET_Wakeup          = 497.5;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (51.6:76.8:125.1);
      specparam TDEFAULT    = (51.6:76.8:125.1);
      specparam TAA_12  = (51.6:76.8:125.1);
      specparam TRC  = (52.0:76.8:136.3);
      specparam TRC_12    = (52.0:76.8:136.3);
      specparam THPW = (8.4:14.0:23.2);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (11.3:15.3:26.0);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (15.2:19.6:34.0);
      specparam TWH  = (3.0:5.2:10.1);
      specparam TDS  = (16.9:21.2:36.9);
      specparam TDH  = (6.3:5.2:5.5);
      specparam TCSS = (16.9:23.3:41.7);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (244.3:339.3:522.0);
      specparam TRET_CSH  = (239.4:324.3:497.5);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.3:102.1:139.7);
      specparam TDVSES  = (16.9:23.3:41.7);
      specparam TDVSEH  = (43.6:70.0:119.8);
      specparam TDVSS   = (16.9:23.3:41.7);
      specparam TDVSH   = (43.6:70.0:119.8);
