module SZLVTLB40_64X1024X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
    ...
    SZLVTLB40_64X256X1CM1b1 ram_high2 (
        .A(A),
        .B(B),
        .DO(DO[1023:768]),
        .DI(DI[1023:768]),
    ...
    SZLVTLB40_64X256X1CM1b1 ram_high (
        .A(A),
        .B(B),
        .DO(DO[767:512]),
        .DI(DI[767:512]),
    ...
    SZLVTLB40_64X256X1CM1b1 ram_low2 (
        .A(A),
        .B(B),
        .DO(DO[511:256]),
        .DI(DI[511:256]),
    ...
    SZLVTLB40_64X256X1CM1b1 ram_low  (
        .A(A),
        .B(B),
        .DO(DO[255:0]),
        .DI(DI[255:0]),
