...
module SZLVTLL40_80X18X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (46.7:71.4:138.2);
  parameter  Tw2r                 = (53.7:79.0:157.6);
  parameter  TOH                  = (32.4:49.3:83.8); 
  parameter  TOH_12               = (32.4:49.3:83.8); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.7:79.0:140.5);
`else
`endif
  parameter  TSLP_Q               = (64.2:95.0:155.7);
  parameter  TRET_Q               = (59.4:88.4:145.5);
  parameter  TSLP_Wakeup          = 512.7;            
  parameter  TRET_Wakeup          = 484.8;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.9:78.9:129.2);
      specparam TDEFAULT    = (52.9:78.9:129.2);
      specparam TAA_12  = (52.9:78.9:129.2);
      specparam TRC  = (53.7:79.0:140.5);
      specparam TRC_12    = (53.7:79.0:140.5);
      specparam THPW = (9.4:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.8:26.4);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (15.7:19.0:32.0);
      specparam TWH  = (5.3:6.6:11.4);
      specparam TDS  = (16.4:20.5:35.7);
      specparam TDH  = (5.7:4.6:5.1);
      specparam TCSS = (16.2:23.9:42.5);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (237.6:334.9:512.7);
      specparam TRET_CSH  = (231.5:315.3:484.8);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.4:138.8);
      specparam TDVSES  = (16.2:23.9:42.5);
      specparam TDVSEH  = (46.2:74.2:127.2);
      specparam TDVSS   = (16.2:23.9:42.5);
      specparam TDVSH   = (46.2:74.2:127.2);
