...
module SZLVTLL40_256X8X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (49.6:75.1:144.1);
  parameter  Tw2r                 = (55.1:81.7:163.3);
  parameter  TOH                  = (35.3:53.4:91.8); 
  parameter  TOH_12               = (35.3:53.4:91.8); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (55.1:81.7:146.0);
`else
`endif
  parameter  TSLP_Q               = (52.6:78.6:129.1);
  parameter  TRET_Q               = (47.8:72.0:118.9);
  parameter  TSLP_Wakeup          = 506.7;            
  parameter  TRET_Wakeup          = 476.9;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (55.3:82.5:136.4);
      specparam TDEFAULT    = (55.3:82.5:136.4);
      specparam TAA_12  = (55.3:82.5:136.4);
      specparam TRC  = (55.1:81.7:146.0);
      specparam TRC_12    = (55.1:81.7:146.0);
      specparam THPW = (9.3:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.8:26.5);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (16.1:19.5:32.9);
      specparam TWH  = (4.7:5.8:10.1);
      specparam TDS  = (16.8:21.2:36.9);
      specparam TDH  = (5.0:3.6:3.5);
      specparam TCSS = (16.2:24.0:42.6);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (234.4:331.0:506.7);
      specparam TRET_CSH  = (224.4:307.2:476.9);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.9:101.9:141.4);
      specparam TDVSES  = (16.2:24.0:42.6);
      specparam TDVSEH  = (52.4:82.7:143.9);
      specparam TDVSS   = (16.2:24.0:42.6);
      specparam TDVSH   = (52.4:82.7:143.9);
