...
module SZLVTLL40_128X64X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (52.7:80.4:139.3);
  parameter  Tw2r                 = (57.4:85.0:170.4);
  parameter  TOH                  = (40.1:60.3:102.3);
  parameter  TOH_12               = (40.1:60.3:102.3);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (57.4:85.0:153.6);
`else
`endif
  parameter  TSLP_Q               = (98.3:142.0:234.0);
  parameter  TRET_Q               = (93.5:135.9:223.4);
  parameter  TSLP_Wakeup          = 669.1;            
  parameter  TRET_Wakeup          = 619.5;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (60.2:89.2:146.4);
      specparam TDEFAULT    = (60.2:89.2:146.4);
      specparam TAA_12  = (60.2:89.2:146.4);
      specparam TRC  = (57.4:85.0:153.6);
      specparam TRC_12    = (57.4:85.0:153.6);
      ...
      specparam TCSS = (16.5:24.0:42.7);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (315.0:443.6:669.1);
      specparam TRET_CSH  = (298.5:402.9:619.5);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.4:102.6:142.6);
      specparam TDVSES  = (16.5:24.0:42.7);
      specparam TDVSEH  = (59.2:92.4:158.8);
      specparam TDVSS   = (16.5:24.0:42.7);
      specparam TDVSH   = (59.2:92.4:158.8);
