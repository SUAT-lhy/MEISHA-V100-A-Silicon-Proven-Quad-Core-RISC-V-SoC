...
module SZLVTLL40_80X17X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (46.5:71.2:137.7);
  parameter  Tw2r                 = (53.6:78.8:157.4);
  parameter  TOH                  = (32.2:49.1:83.4); 
  parameter  TOH_12               = (32.2:49.1:83.4); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.6:78.8:140.2);
`else
`endif
  parameter  TSLP_Q               = (63.1:93.3:153.0);
  parameter  TRET_Q               = (58.3:86.7:142.9);
  parameter  TSLP_Wakeup          = 508.0;            
  parameter  TRET_Wakeup          = 480.8;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.7:78.7:128.8);
      specparam TDEFAULT    = (52.7:78.7:128.8);
      specparam TAA_12  = (52.7:78.7:128.8);
      specparam TRC  = (53.6:78.8:140.2);
      specparam TRC_12    = (53.6:78.8:140.2);
      specparam THPW = (9.4:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.8:26.4);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (15.8:19.1:32.1);
      specparam TWH  = (5.2:6.5:11.3);
      specparam TDS  = (16.4:20.6:35.9);
      specparam TDH  = (5.7:4.5:4.9);
      specparam TCSS = (16.2:23.9:42.5);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (235.5:331.7:508.0);
      specparam TRET_CSH  = (229.5:312.7:480.8);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.4:138.8);
      specparam TDVSES  = (16.2:23.9:42.5);
      specparam TDVSEH  = (46.0:73.8:126.6);
      specparam TDVSS   = (16.2:23.9:42.5);
      specparam TDVSH   = (46.0:73.8:126.6);
