...
module SZLVTLB40_256X256X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (76.3:115.4:227.2);
  parameter  Tw2r                 = (83.4:128.8:253.2);
  parameter  TOH                  = (66.0:103.4:188.0);
  parameter  TOH_2                = (70.3:110.7:204.0);
  parameter  TOH_3                = (66.0:103.4:188.0);
  parameter  TOH_4                = (61.5:95.6:171.6);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (83.4:128.8:232.0);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (85.5:132.5:234.2);
      specparam TAA_2  = (89.8:139.7:250.1);
      specparam TAA_3  = (85.5:132.5:234.2);
      specparam TAA_4  = (81.0:124.6:217.8);
      specparam TRC  = (83.4:128.8:232.0);
      specparam TRC_2    = (83.4:128.8:232.0);
      specparam TRC_3    = (83.4:128.8:232.0);
      specparam TRC_4    = (83.4:128.8:232.0);
      specparam THPW = (9.3:15.1:24.9);
      specparam TLPW = (19.7:22.5:35.7);
      specparam TAS  = (14.0:16.4:24.4);
      specparam TAH  = (13.1:16.5:23.0);
      specparam TWS  = (11.3:14.8:26.5);
      specparam TWH  = (10.2:13.7:21.1);
      specparam TDS  = (14.9:18.6:32.7);
      specparam TDH  = (9.6:9.4:11.1);
      specparam TCSS = (20.9:25.4:41.4);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.9);
      specparam TNAP_CSH  = (42.6:57.7:86.9);
      specparam TDVSES  = (14.0:16.4:24.4);
      specparam TDVSEH  = (71.4:112.5:199.5);
      specparam TDVSS   = (14.0:16.4:24.4);
      specparam TDVSH   = (71.4:112.5:199.5);
