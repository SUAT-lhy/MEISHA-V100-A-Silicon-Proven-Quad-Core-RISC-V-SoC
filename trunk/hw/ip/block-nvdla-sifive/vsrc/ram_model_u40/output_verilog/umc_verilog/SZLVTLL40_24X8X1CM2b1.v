...
module SZLVTLL40_24X8X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (43.5:67.9:127.9);
  parameter  Tw2r                 = (50.6:75.0:153.6);
  parameter  TOH                  = (29.4:44.8:76.2); 
  parameter  TOH_12               = (29.4:44.8:76.2); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (50.6:75.0:133.7);
`else
`endif
  parameter  TSLP_Q               = (51.1:76.1:127.3);
  parameter  TRET_Q               = (46.3:70.0:116.8);
  parameter  TSLP_Wakeup          = 446.0;            
  parameter  TRET_Wakeup          = 431.0;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (49.4:73.7:120.2);
      specparam TDEFAULT    = (49.4:73.7:120.2);
      specparam TAA_12  = (49.4:73.7:120.2);
      specparam TRC  = (50.6:75.0:133.7);
      specparam TRC_12    = (50.6:75.0:133.7);
      specparam THPW = (8.4:14.0:23.2);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (11.3:15.3:26.0);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (15.7:20.3:35.1);
      specparam TWH  = (2.1:3.9:8.1);
      specparam TDS  = (17.8:22.5:39.0);
      specparam TDH  = (5.1:3.5:2.8);
      specparam TCSS = (17.4:23.3:41.7);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (209.4:289.1:446.0);
      specparam TRET_CSH  = (205.2:279.8:431.0);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.3:102.1:139.7);
      specparam TDVSES  = (17.4:23.3:41.7);
      specparam TDVSEH  = (40.8:65.8:113.4);
      specparam TDVSS   = (17.4:23.3:41.7);
      specparam TDVSH   = (40.8:65.8:113.4);
