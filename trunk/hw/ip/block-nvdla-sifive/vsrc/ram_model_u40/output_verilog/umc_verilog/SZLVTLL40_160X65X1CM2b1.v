...
module SZLVTLL40_160X65X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (53.5:81.9:142.1);
  parameter  Tw2r                 = (58.8:87.5:174.6);
  parameter  TOH                  = (41.2:62.0:105.3);
  parameter  TOH_12               = (41.2:62.0:105.3);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (58.8:87.5:157.6);
`else
`endif
  parameter  TSLP_Q               = (99.1:143.1:235.7);
  parameter  TRET_Q               = (94.4:137.1:225.2);
  parameter  TSLP_Wakeup          = 688.7;            
  parameter  TRET_Wakeup          = 635.4;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (61.4:91.1:149.6);
      specparam TDEFAULT    = (61.4:91.1:149.6);
      specparam TAA_12  = (61.4:91.1:149.6);
      specparam TRC  = (58.8:87.5:157.6);
      specparam TRC_12    = (58.8:87.5:157.6);
      specparam THPW = (9.0:14.7:23.6);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (13.1:18.1:30.3);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (14.9:19.1:33.0);
      specparam TWH  = (4.1:6.7:12.3);
      specparam TDS  = (16.0:19.8:34.6);
      specparam TDH  = (7.9:7.5:9.0);
      specparam TCSS = (17.3:26.1:46.1);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (325.4:456.4:688.7);
      specparam TRET_CSH  = (305.2:412.7:635.4);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.4:102.8:143.5);
      specparam TDVSES  = (17.3:26.1:46.1);
      specparam TDVSEH  = (61.5:95.9:164.9);
      specparam TDVSS   = (17.3:26.1:46.1);
      specparam TDVSH   = (61.5:95.9:164.9);
