...
module SZLVTLL40_32X16X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (44.4:68.4:131.3);
  parameter  Tw2r                 = (51.3:76.0:155.2);
  parameter  TOH                  = (30.4:46.2:78.5); 
  parameter  TOH_12               = (30.4:46.2:78.5); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (51.3:76.0:135.3);
`else
`endif
  parameter  TSLP_Q               = (58.6:86.7:144.5);
  parameter  TRET_Q               = (53.8:80.6:134.1);
  parameter  TSLP_Wakeup          = 478.0;            
  parameter  TRET_Wakeup          = 458.3;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (50.4:75.1:122.5);
      specparam TDEFAULT    = (50.4:75.1:122.5);
      specparam TAA_12  = (50.4:75.1:122.5);
      specparam TRC  = (51.3:76.0:135.3);
      specparam TRC_12    = (51.3:76.0:135.3);
      specparam THPW = (8.5:14.0:23.2);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (11.3:15.3:25.9);
      ...
      specparam TSLP_CSH  = (223.7:310.7:478.0);
      specparam TRET_CSH  = (218.8:297.8:458.3);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.3:102.1:139.8);
      specparam TDVSES  = (17.2:23.3:41.7);
      specparam TDVSEH  = (42.1:67.8:116.7);
      specparam TDVSS   = (17.2:23.3:41.7);
      specparam TDVSH   = (42.1:67.8:116.7);
