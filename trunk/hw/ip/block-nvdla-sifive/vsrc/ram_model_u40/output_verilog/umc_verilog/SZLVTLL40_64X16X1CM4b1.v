...
module SZLVTLL40_64X16X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (45.7:70.1:135.6);
  parameter  Tw2r                 = (52.8:77.6:155.4);
  parameter  TOH                  = (31.6:48.1:81.6); 
  parameter  TOH_12               = (31.6:48.1:81.6); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (52.8:77.6:138.2);
`else
`endif
  parameter  TSLP_Q               = (61.9:91.7:150.3);
  parameter  TRET_Q               = (57.1:85.1:140.2);
  parameter  TSLP_Wakeup          = 497.3;            
  parameter  TRET_Wakeup          = 472.5;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.1:77.6:126.9);
      specparam TDEFAULT    = (52.1:77.6:126.9);
      specparam TAA_12  = (52.1:77.6:126.9);
      specparam TRC  = (52.8:77.6:138.2);
      specparam TRC_12    = (52.8:77.6:138.2);
