...
module SZLVTLL40_24X16X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (44.0:67.8:130.3);
  parameter  Tw2r                 = (51.1:75.6:154.5);
  parameter  TOH                  = (30.2:45.8:77.8); 
  parameter  TOH_12               = (30.2:45.8:77.8); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (51.1:75.6:134.6);
`else
`endif
  parameter  TSLP_Q               = (58.6:86.7:144.5);
  parameter  TRET_Q               = (53.8:80.6:134.1);
  parameter  TSLP_Wakeup          = 473.7;            
  parameter  TRET_Wakeup          = 455.3;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (50.2:74.8:121.9);
      specparam TDEFAULT    = (50.2:74.8:121.9);
      specparam TAA_12  = (50.2:74.8:121.9);
      specparam TRC  = (51.1:75.6:134.6);
      specparam TRC_12    = (51.1:75.6:134.6);
      specparam THPW = (8.5:14.0:23.2);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (11.3:15.3:26.0);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (15.5:20.0:34.7);
      specparam TWH  = (2.4:4.4:8.9);
      specparam TDS  = (17.4:22.0:38.2);
      specparam TDH  = (5.5:4.1:3.7);
      specparam TCSS = (17.2:23.3:41.7);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.8:33.2);
      specparam TRETH  = (7.6:16.8:33.2);
      specparam TSLP_CSH  = (222.1:307.3:473.7);
      specparam TRET_CSH  = (217.7:296.1:455.3);
      specparam TNAPH  = (7.6:16.8:33.2);
      specparam TNAP_CSH  = (84.3:102.1:139.7);
      specparam TDVSES  = (17.2:23.3:41.7);
      specparam TDVSEH  = (41.8:67.2:115.5);
      specparam TDVSS   = (17.2:23.3:41.7);
      specparam TDVSH   = (41.8:67.2:115.5);
