...
module SZLVTLL40_64X42X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (49.8:75.1:137.2);
  parameter  Tw2r                 = (54.1:80.1:161.9);
  parameter  TOH                  = (36.4:54.6:92.6); 
  parameter  TOH_12               = (36.4:54.6:92.6); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (54.1:80.1:142.3);
`else
`endif
  parameter  TSLP_Q               = (80.6:117.4:194.2);
  parameter  TRET_Q               = (75.8:111.3:183.9);
  parameter  TSLP_Wakeup          = 573.5;            
  parameter  TRET_Wakeup          = 539.7;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (56.3:83.4:136.7);
      specparam TDEFAULT    = (56.3:83.4:136.7);
      specparam TAA_12  = (56.3:83.4:136.7);
      specparam TRC  = (54.1:80.1:142.3);
      specparam TRC_12    = (54.1:80.1:142.3);
      specparam THPW = (8.7:14.3:23.2);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (11.7:15.9:26.8);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (15.1:19.4:33.6);
      specparam TWH  = (3.4:5.7:10.8);
      specparam TDS  = (16.6:20.7:36.1);
      specparam TDH  = (6.8:5.9:6.6);
      specparam TCSS = (16.8:23.9:42.5);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (267.9:377.2:573.5);
      specparam TRET_CSH  = (259.5:351.3:539.7);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.4:102.3:140.6);
      specparam TDVSES  = (16.8:23.9:42.5);
      specparam TDVSEH  = (52.9:82.9:142.7);
      specparam TDVSS   = (16.8:23.9:42.5);
      specparam TDVSH   = (52.9:82.9:142.7);
