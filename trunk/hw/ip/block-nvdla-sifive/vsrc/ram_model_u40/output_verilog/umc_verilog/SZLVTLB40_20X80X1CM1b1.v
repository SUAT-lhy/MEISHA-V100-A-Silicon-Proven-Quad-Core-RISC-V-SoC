...
module SZLVTLB40_20X80X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (45.5:65.4:127.5);
  parameter  Tw2r                 = (53.4:79.5:166.5);
  parameter  TOH                  = (35.6:54.3:94.4); 
  parameter  TOH_2                = (36.5:55.9:98.0); 
  parameter  TOH_3                = (35.6:54.3:94.4); 
  parameter  TOH_4                = (34.5:52.4:90.6); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.4:79.5:147.4);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (53.9:81.9:139.0);
      specparam TAA_2  = (54.8:83.5:142.5);
      specparam TAA_3  = (53.9:81.9:139.0);
      specparam TAA_4  = (52.8:80.1:135.1);
      specparam TRC  = (53.4:79.5:147.4);
      specparam TRC_2    = (53.4:79.5:147.4);
      specparam TRC_3    = (53.4:79.5:147.4);
      specparam TRC_4    = (53.4:79.5:147.4);
      specparam THPW = (9.1:14.9:24.7);
      specparam TLPW = (19.7:22.5:35.7);
      specparam TAS  = (12.6:14.2:21.0);
      specparam TAH  = (13.1:16.5:23.0);
      specparam TWS  = (10.9:14.1:25.4);
      specparam TWH  = (9.2:12.4:19.3);
      specparam TDS  = (15.7:19.8:34.9);
      specparam TDH  = (6.8:5.7:5.7);
      specparam TCSS = (19.5:23.2:38.0);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.8);
      specparam TNAP_CSH  = (19.0:26.0:41.4);
      specparam TDVSES  = (12.6:14.2:21.0);
      specparam TDVSEH  = (28.3:47.5:84.1);
      specparam TDVSS   = (12.6:14.2:21.0);
      specparam TDVSH   = (28.3:47.5:84.1);
