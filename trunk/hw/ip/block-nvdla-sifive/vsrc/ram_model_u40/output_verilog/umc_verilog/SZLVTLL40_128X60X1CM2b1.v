...
module SZLVTLL40_128X60X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (52.5:79.8:138.8);
  parameter  Tw2r                 = (57.1:84.7:169.9);
  parameter  TOH                  = (39.7:59.7:101.4);
  parameter  TOH_12               = (39.7:59.7:101.4);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (57.1:84.7:152.5);
`else
`endif
  parameter  TSLP_Q               = (95.1:137.6:226.9);
  parameter  TRET_Q               = (90.4:131.5:216.4);
  parameter  TSLP_Wakeup          = 658.0;            
  parameter  TRET_Wakeup          = 609.9;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (59.8:88.6:145.4);
      specparam TDEFAULT    = (59.8:88.6:145.4);
      specparam TAA_12  = (59.8:88.6:145.4);
      specparam TRC  = (57.1:84.7:152.5);
      specparam TRC_12    = (57.1:84.7:152.5);
