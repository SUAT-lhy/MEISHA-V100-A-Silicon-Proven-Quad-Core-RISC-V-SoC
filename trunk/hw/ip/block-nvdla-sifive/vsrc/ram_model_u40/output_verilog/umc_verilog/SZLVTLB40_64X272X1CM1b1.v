...
module SZLVTLB40_64X272X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (57.7:84.4:157.6);
  parameter  Tw2r                 = (65.7:100.0:197.0);
  parameter  TOH                  = (47.9:72.9:126.8);
  parameter  TOH_2                = (49.5:75.6:132.6);
  parameter  TOH_3                = (47.9:72.9:126.8);
  parameter  TOH_4                = (46.1:69.8:120.4);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (65.7:100.0:181.2);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (67.6:102.1:173.2);
      specparam TAA_2  = (69.2:104.8:179.0);
      specparam TAA_3  = (67.6:102.1:173.2);
      specparam TAA_4  = (65.7:99.1:166.8);
      specparam TRC  = (65.7:100.0:181.2);
      specparam TRC_2    = (65.7:100.0:181.2);
      specparam TRC_3    = (65.7:100.0:181.2);
      specparam TRC_4    = (65.7:100.0:181.2);
      specparam THPW = (9.3:15.1:24.9);
      specparam TLPW = (19.7:22.5:35.7);
      specparam TAS  = (13.1:15.1:22.5);
      specparam TAH  = (13.1:16.5:23.0);
      specparam TWS  = (11.4:14.9:26.7);
      specparam TWH  = (10.2:13.8:21.3);
      specparam TDS  = (14.9:18.5:32.6);
      specparam TDH  = (9.9:9.8:11.6);
      specparam TCSS = (20.0:24.1:39.5);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.9);
      specparam TNAP_CSH  = (28.5:37.6:54.5);
      specparam TDVSES  = (13.1:15.1:22.5);
      specparam TDVSEH  = (53.0:81.4:136.8);
      specparam TDVSS   = (13.1:15.1:22.5);
      specparam TDVSH   = (53.0:81.4:136.8);
