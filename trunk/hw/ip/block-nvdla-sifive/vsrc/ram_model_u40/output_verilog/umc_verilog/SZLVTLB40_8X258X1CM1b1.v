...
module SZLVTLB40_8X258X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (49.6:71.9:126.5);
  parameter  Tw2r                 = (59.5:89.7:176.1);
  parameter  TOH                  = (40.7:60.9:102.6);
  parameter  TOH_2                = (42.4:63.8:107.3);
  parameter  TOH_3                = (40.7:60.9:102.6);
  parameter  TOH_4                = (39.7:59.2:99.5); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (59.5:89.7:163.1);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (60.2:89.9:148.9);
      specparam TAA_2  = (61.9:92.8:154.4);
      specparam TAA_3  = (60.2:89.9:148.9);
      specparam TAA_4  = (59.2:88.3:145.8);
      specparam TRC  = (59.5:89.7:163.1);
      specparam TRC_2    = (59.5:89.7:163.1);
      specparam TRC_3    = (59.5:89.7:163.1);
      specparam TRC_4    = (59.5:89.7:163.1);
      ...
      specparam TCSS = (19.0:22.3:38.1);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.8);
      specparam TNAP_CSH  = (21.6:28.1:41.2);
      specparam TDVSES  = (12.1:13.3:21.1);
      specparam TDVSEH  = (43.8:66.7:108.7);
      specparam TDVSS   = (12.1:13.3:21.1);
      specparam TDVSH   = (43.8:66.7:108.7);
