...
module SZLVTLL40_256X14X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (50.4:76.6:139.4);
  parameter  Tw2r                 = (55.8:82.6:164.7);
  parameter  TOH                  = (36.4:55.0:94.2); 
  parameter  TOH_12               = (36.4:55.0:94.2); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (55.8:82.6:147.4);
`else
`endif
  parameter  TSLP_Q               = (59.6:88.4:145.0);
  parameter  TRET_Q               = (54.8:81.9:134.8);
  parameter  TSLP_Wakeup          = 536.6;            
  parameter  TRET_Wakeup          = 502.1;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (56.5:84.1:139.0);
      specparam TDEFAULT    = (56.5:84.1:139.0);
      specparam TAA_12  = (56.5:84.1:139.0);
      specparam TRC  = (55.8:82.6:147.4);
      specparam TRC_12    = (55.8:82.6:147.4);
      specparam THPW = (9.4:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.8:26.5);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (15.9:19.3:32.4);
      specparam TWH  = (5.0:6.3:10.9);
      specparam TDS  = (16.6:20.8:36.3);
      specparam TDH  = (5.4:4.2:4.5);
      specparam TCSS = (16.2:24.0:42.6);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (249.0:352.0:536.6);
      specparam TRET_CSH  = (237.2:324.0:502.1);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.9:101.9:141.4);
      specparam TDVSES  = (16.2:24.0:42.6);
      specparam TDVSEH  = (54.2:85.3:147.9);
      specparam TDVSS   = (16.2:24.0:42.6);
      specparam TDVSH   = (54.2:85.3:147.9);
