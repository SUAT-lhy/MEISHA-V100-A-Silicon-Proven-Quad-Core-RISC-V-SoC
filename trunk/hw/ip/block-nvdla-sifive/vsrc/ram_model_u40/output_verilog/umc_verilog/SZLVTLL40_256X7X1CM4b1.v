...
module SZLVTLL40_256X7X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (49.4:74.8:143.7);
  parameter  Tw2r                 = (55.0:81.5:163.1);
  parameter  TOH                  = (35.1:53.1:91.4); 
  parameter  TOH_12               = (35.1:53.1:91.4); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (55.0:81.5:145.8);
`else
`endif
  parameter  TSLP_Q               = (51.3:76.8:126.2);
  parameter  TRET_Q               = (46.6:70.3:116.0);
  parameter  TSLP_Wakeup          = 501.0;            
  parameter  TRET_Wakeup          = 472.2;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (55.1:82.2:136.0);
      specparam TDEFAULT    = (55.1:82.2:136.0);
      specparam TAA_12  = (55.1:82.2:136.0);
      specparam TRC  = (55.0:81.5:145.8);
      specparam TRC_12    = (55.0:81.5:145.8);
      specparam THPW = (9.3:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.8:26.5);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (16.1:19.6:33.1);
      specparam TWH  = (4.6:5.7:10.0);
      specparam TDS  = (16.9:21.3:37.1);
      specparam TDH  = (4.9:3.5:3.4);
      specparam TCSS = (16.2:24.0:42.6);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (231.6:326.9:501.0);
      specparam TRET_CSH  = (222.0:304.0:472.2);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.9:101.9:141.4);
      specparam TDVSES  = (16.2:24.0:42.6);
      specparam TDVSEH  = (52.1:82.2:143.2);
      specparam TDVSS   = (16.2:24.0:42.6);
      specparam TDVSH   = (52.1:82.2:143.2);
