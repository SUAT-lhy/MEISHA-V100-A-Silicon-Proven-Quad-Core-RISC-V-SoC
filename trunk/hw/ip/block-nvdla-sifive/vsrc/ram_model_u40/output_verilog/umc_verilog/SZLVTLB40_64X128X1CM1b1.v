...
module SZLVTLB40_64X128X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (51.5:75.1:148.1);
  parameter  Tw2r                 = (59.3:88.7:183.9);
  parameter  TOH                  = (42.1:64.6:114.1);
  parameter  TOH_2                = (43.6:67.3:119.9);
  parameter  TOH_3                = (42.1:64.6:114.1);
  parameter  TOH_4                = (40.3:61.6:107.8);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (59.3:88.7:164.6);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (60.6:92.5:158.9);
      specparam TAA_2  = (62.1:95.2:164.7);
      specparam TAA_3  = (60.6:92.5:158.9);
      specparam TAA_4  = (58.8:89.5:152.6);
      specparam TRC  = (59.3:88.7:164.6);
      specparam TRC_2    = (59.3:88.7:164.6);
      specparam TRC_3    = (59.3:88.7:164.6);
      specparam TRC_4    = (59.3:88.7:164.6);
      ...
      specparam TNAP_CSH  = (24.0:32.1:51.3);
      specparam TDVSES  = (13.1:15.1:22.5);
      specparam TDVSEH  = (37.7:61.5:108.8);
      specparam TDVSS   = (13.1:15.1:22.5);
      specparam TDVSH   = (37.7:61.5:108.8);
