...
module SZLVTLL40_32X32X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (45.5:69.6:135.4);
  parameter  Tw2r                 = (52.2:77.2:156.9);
  parameter  TOH                  = (31.7:48.1:81.5); 
  parameter  TOH_12               = (31.7:48.1:81.5); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (52.2:77.2:137.0);
`else
`endif
  parameter  TSLP_Q               = (72.3:105.9:175.6);
  parameter  TRET_Q               = (67.5:99.7:165.2);
  parameter  TSLP_Wakeup          = 526.7;            
  parameter  TRET_Wakeup          = 500.7;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (51.8:77.2:125.7);
      specparam TDEFAULT    = (51.8:77.2:125.7);
      specparam TAA_12  = (51.8:77.2:125.7);
      specparam TRC  = (52.2:77.2:137.0);
      specparam TRC_12    = (52.2:77.2:137.0);
      ...
      specparam TSLP_CSH  = (246.2:343.2:526.7);
      specparam TRET_CSH  = (240.7:326.2:500.7);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.3:102.2:139.9);
      specparam TDVSES  = (16.9:23.3:41.7);
      specparam TDVSEH  = (43.9:70.6:121.0);
      specparam TDVSS   = (16.9:23.3:41.7);
      specparam TDVSH   = (43.9:70.6:121.0);
