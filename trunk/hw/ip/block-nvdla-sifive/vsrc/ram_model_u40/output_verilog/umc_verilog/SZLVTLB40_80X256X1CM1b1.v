...
module SZLVTLB40_80X256X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (57.7:86.0:162.7);
  parameter  Tw2r                 = (66.4:101.0:200.1);
  parameter  TOH                  = (48.9:74.7:130.8);
  parameter  TOH_2                = (50.7:77.8:137.5);
  parameter  TOH_3                = (48.9:74.7:130.8);
  parameter  TOH_4                = (46.9:71.3:123.6);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (66.4:101.0:183.8);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (68.4:103.8:177.0);
      specparam TAA_2  = (70.2:106.8:183.7);
      specparam TAA_3  = (68.4:103.8:177.0);
      specparam TAA_4  = (66.4:100.3:169.9);
      specparam TRC  = (66.4:101.0:183.8);
      specparam TRC_2    = (66.4:101.0:183.8);
      specparam TRC_3    = (66.4:101.0:183.8);
      specparam TRC_4    = (66.4:101.0:183.8);
      ...
      specparam TNAP_CSH  = (29.3:38.9:56.6);
      specparam TDVSES  = (13.2:15.3:22.7);
      specparam TDVSEH  = (53.1:82.1:139.4);
      specparam TDVSS   = (13.2:15.3:22.7);
      specparam TDVSH   = (53.1:82.1:139.4);
