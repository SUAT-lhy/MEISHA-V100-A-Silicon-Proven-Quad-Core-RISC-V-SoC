...
module SZLVTLB40_80X258X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (57.8:86.1:162.8);
  parameter  Tw2r                 = (66.5:101.2:200.3);
  parameter  TOH                  = (49.0:74.8:131.0);
  parameter  TOH_2                = (50.8:77.9:137.6);
  parameter  TOH_3                = (49.0:74.8:131.0);
  parameter  TOH_4                = (47.0:71.4:123.8);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (66.5:101.2:184.0);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (68.5:103.9:177.2);
      specparam TAA_2  = (70.3:106.9:183.8);
      specparam TAA_3  = (68.5:103.9:177.2);
      specparam TAA_4  = (66.5:100.4:170.0);
      specparam TRC  = (66.5:101.2:184.0);
      specparam TRC_2    = (66.5:101.2:184.0);
      specparam TRC_3    = (66.5:101.2:184.0);
      specparam TRC_4    = (66.5:101.2:184.0);
      specparam THPW = (9.3:15.1:24.9);
      specparam TLPW = (19.7:22.5:35.8);
      specparam TAS  = (13.2:15.3:22.7);
      ...
      specparam TCSS = (20.1:24.3:39.7);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.9);
      specparam TNAP_CSH  = (29.4:39.0:56.7);
      specparam TDVSES  = (13.2:15.3:22.7);
      specparam TDVSEH  = (53.3:82.3:139.6);
      specparam TDVSS   = (13.2:15.3:22.7);
      specparam TDVSH   = (53.3:82.3:139.6);
