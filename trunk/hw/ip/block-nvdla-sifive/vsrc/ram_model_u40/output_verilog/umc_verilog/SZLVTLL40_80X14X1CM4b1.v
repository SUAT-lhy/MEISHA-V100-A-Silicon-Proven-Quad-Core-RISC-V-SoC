...
module SZLVTLL40_80X14X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (46.0:70.4:136.2);
  parameter  Tw2r                 = (53.2:78.4:156.7);
  parameter  TOH                  = (31.8:48.4:82.3); 
  parameter  TOH_12               = (31.8:48.4:82.3); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.2:78.4:139.6);
`else
`endif
  parameter  TSLP_Q               = (59.6:88.4:145.0);
  parameter  TRET_Q               = (54.8:81.8:134.9);
  parameter  TSLP_Wakeup          = 493.9;            
  parameter  TRET_Wakeup          = 468.9;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.2:78.0:127.7);
      specparam TDEFAULT    = (52.2:78.0:127.7);
      specparam TAA_12  = (52.2:78.0:127.7);
      specparam TRC  = (53.2:78.4:139.6);
      specparam TRC_12    = (53.2:78.4:139.6);
      specparam THPW = (9.4:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.8:26.4);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (15.9:19.2:32.4);
      ...
      specparam TSLP_CSH  = (229.4:322.2:493.9);
      specparam TRET_CSH  = (223.6:304.8:468.9);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.4:138.8);
      specparam TDVSES  = (16.2:23.9:42.5);
      specparam TDVSEH  = (45.3:72.8:124.9);
      specparam TDVSS   = (16.2:23.9:42.5);
      specparam TDVSH   = (45.3:72.8:124.9);
