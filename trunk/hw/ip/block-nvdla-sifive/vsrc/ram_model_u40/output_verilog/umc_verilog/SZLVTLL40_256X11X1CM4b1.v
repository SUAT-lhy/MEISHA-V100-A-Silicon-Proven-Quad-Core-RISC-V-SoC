...
module SZLVTLL40_256X11X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (50.0:75.9:141.7);
  parameter  Tw2r                 = (55.4:82.1:164.0);
  parameter  TOH                  = (35.8:54.2:93.0); 
  parameter  TOH_12               = (35.8:54.2:93.0); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (55.4:82.1:146.7);
`else
`endif
  parameter  TSLP_Q               = (56.1:83.5:137.1);
  parameter  TRET_Q               = (51.3:76.9:126.9);
  parameter  TSLP_Wakeup          = 521.6;            
  parameter  TRET_Wakeup          = 489.5;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (55.9:83.3:137.7);
      specparam TDEFAULT    = (55.9:83.3:137.7);
      specparam TAA_12  = (55.9:83.3:137.7);
      specparam TRC  = (55.4:82.1:146.7);
      specparam TRC_12    = (55.4:82.1:146.7);
      specparam THPW = (9.3:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.8:26.5);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (16.0:19.4:32.7);
      specparam TWH  = (4.9:6.0:10.5);
      specparam TDS  = (16.7:21.0:36.6);
      specparam TDH  = (5.2:3.9:4.0);
      specparam TCSS = (16.2:24.0:42.6);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (241.7:341.5:521.6);
      specparam TRET_CSH  = (230.8:315.6:489.5);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.9:101.9:141.4);
      specparam TDVSES  = (16.2:24.0:42.6);
      specparam TDVSEH  = (53.3:84.0:145.9);
      specparam TDVSS   = (16.2:24.0:42.6);
      specparam TDVSH   = (53.3:84.0:145.9);
