...
module SZLVTLL40_256X3X1CM8b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (47.9:72.8:138.1);
  parameter  Tw2r                 = (53.2:78.9:157.7);
  parameter  TOH                  = (33.6:50.9:87.2); 
  parameter  TOH_12               = (33.6:50.9:87.2); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (53.2:78.9:139.9);
`else
`endif
  parameter  TSLP_Q               = (47.8:71.0:116.9);
  parameter  TRET_Q               = (43.1:64.9:106.0);
  parameter  TSLP_Wakeup          = 461.3;            
  parameter  TRET_Wakeup          = 440.1;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (53.7:80.2:131.4);
      specparam TDEFAULT    = (53.7:80.2:131.4);
      specparam TAA_12  = (53.7:80.2:131.4);
      specparam TRC  = (53.2:78.9:139.9);
      specparam TRC_12    = (53.2:78.9:139.9);
      specparam THPW = (9.3:14.8:24.0);
      specparam TLPW = (21.5:25.1:38.2);
      specparam TAS  = (11.8:15.8:26.6);
      specparam TAH  = (13.3:16.6:22.8);
      specparam TWS  = (15.8:19.2:32.4);
      specparam TWH  = (4.4:5.3:9.1);
      specparam TDS  = (17.5:21.6:37.5);
      specparam TDH  = (4.7:3.2:3.0);
      specparam TCSS = (17.1:24.0:42.9);
      specparam TCSH = (17.0:22.8:37.1);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (214.1:300.5:461.3);
      specparam TRET_CSH  = (207.8:284.7:440.1);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.0:101.8:139.9);
      specparam TDVSES  = (17.1:24.0:42.9);
      specparam TDVSEH  = (49.5:77.9:135.4);
      specparam TDVSS   = (17.1:24.0:42.9);
      specparam TDVSH   = (49.5:77.9:135.4);
