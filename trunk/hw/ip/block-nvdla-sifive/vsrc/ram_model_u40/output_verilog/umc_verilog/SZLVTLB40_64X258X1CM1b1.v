...
module SZLVTLB40_64X258X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (56.2:83.3:156.7);
  parameter  Tw2r                 = (65.1:98.7:195.4);
  parameter  TOH                  = (47.3:72.1:125.5);
  parameter  TOH_2                = (48.9:74.7:131.3);
  parameter  TOH_3                = (47.3:72.1:125.5);
  parameter  TOH_4                = (45.5:69.0:119.2);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (65.1:98.7:179.5);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (66.9:101.2:171.7);
      specparam TAA_2  = (68.4:103.8:177.5);
      specparam TAA_3  = (66.9:101.2:171.7);
      specparam TAA_4  = (65.0:98.1:165.4);
      specparam TRC  = (65.1:98.7:179.5);
      specparam TRC_2    = (65.1:98.7:179.5);
      specparam TRC_3    = (65.1:98.7:179.5);
      specparam TRC_4    = (65.1:98.7:179.5);
      ...
      specparam TNAP_CSH  = (28.1:37.0:53.7);
      specparam TDVSES  = (13.1:15.1:22.5);
      specparam TDVSEH  = (51.5:79.4:133.9);
      specparam TDVSS   = (13.1:15.1:22.5);
      specparam TDVSH   = (51.5:79.4:133.9);
