...
module SZLVTLL40_16X14X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (43.8:67.6:129.0);
  parameter  Tw2r                 = (50.7:75.1:153.6);
  parameter  TOH                  = (29.8:45.2:76.8); 
  parameter  TOH_12               = (29.8:45.2:76.8); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (50.7:75.1:133.7);
`else
`endif
  parameter  TSLP_Q               = (56.7:84.0:140.1);
  parameter  TRET_Q               = (51.9:77.9:129.7);
  parameter  TSLP_Wakeup          = 462.4;            
  parameter  TRET_Wakeup          = 446.2;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (49.8:74.2:120.8);
      specparam TDEFAULT    = (49.8:74.2:120.8);
      specparam TAA_12  = (49.8:74.2:120.8);
      specparam TRC  = (50.7:75.1:133.7);
      specparam TRC_12    = (50.7:75.1:133.7);
      specparam THPW = (8.5:14.0:23.2);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (11.3:15.4:26.0);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (15.6:20.1:34.8);
      specparam TWH  = (2.4:4.3:8.7);
      specparam TDS  = (17.5:22.1:38.4);
      specparam TDH  = (5.4:3.9:3.5);
      specparam TCSS = (17.3:23.3:41.8);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.8:33.2);
      specparam TRETH  = (7.6:16.8:33.2);
      specparam TSLP_CSH  = (217.3:299.4:462.4);
      specparam TRET_CSH  = (213.4:290.3:446.2);
      specparam TNAPH  = (7.6:16.8:33.2);
      specparam TNAP_CSH  = (84.3:102.1:139.5);
      specparam TDVSES  = (17.3:23.3:41.8);
      specparam TDVSEH  = (41.2:66.3:113.9);
      specparam TDVSS   = (17.3:23.3:41.8);
      specparam TDVSH   = (41.2:66.3:113.9);
