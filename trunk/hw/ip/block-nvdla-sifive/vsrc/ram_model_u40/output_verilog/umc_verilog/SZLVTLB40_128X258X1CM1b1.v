...
module SZLVTLB40_128X258X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (62.6:94.3:180.9);
  parameter  Tw2r                 = (70.7:108.3:214.8);
  parameter  TOH                  = (53.8:82.9:147.0);
  parameter  TOH_2                = (56.3:87.1:156.2);
  parameter  TOH_3                = (53.8:82.9:147.0);
  parameter  TOH_4                = (51.1:78.2:137.3);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (70.7:108.3:197.4);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (73.3:112.0:193.2);
      specparam TAA_2  = (75.8:116.2:202.4);
      specparam TAA_3  = (73.3:112.0:193.2);
      specparam TAA_4  = (70.6:107.3:183.5);
      specparam TRC  = (70.7:108.3:197.4);
      specparam TRC_2    = (70.7:108.3:197.4);
      specparam TRC_3    = (70.7:108.3:197.4);
      specparam TRC_4    = (70.7:108.3:197.4);
      specparam THPW = (9.3:15.1:24.9);
      specparam TLPW = (19.7:22.5:35.8);
      specparam TAS  = (13.5:15.6:23.2);
      specparam TAH  = (13.1:16.5:23.0);
      specparam TWS  = (11.3:14.8:26.5);
      specparam TWH  = (10.2:13.7:21.2);
      specparam TDS  = (14.9:18.5:32.7);
      specparam TDH  = (9.6:9.5:11.1);
      specparam TCSS = (20.4:24.6:40.2);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.9);
      specparam TNAP_CSH  = (33.2:44.5:65.4);
      specparam TDVSES  = (13.5:15.6:23.2);
      specparam TDVSEH  = (58.4:90.9:156.5);
      specparam TDVSS   = (13.5:15.6:23.2);
      specparam TDVSH   = (58.4:90.9:156.5);
