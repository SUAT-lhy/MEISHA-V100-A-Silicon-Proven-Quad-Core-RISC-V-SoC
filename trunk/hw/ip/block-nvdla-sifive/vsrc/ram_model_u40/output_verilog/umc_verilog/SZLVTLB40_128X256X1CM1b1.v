...
module SZLVTLB40_128X256X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (62.5:94.2:180.8);
  parameter  Tw2r                 = (70.6:108.1:214.6);
  parameter  TOH                  = (53.8:82.8:146.9);
  parameter  TOH_2                = (56.2:87.0:156.1);
  parameter  TOH_3                = (53.8:82.8:146.9);
  parameter  TOH_4                = (51.0:78.2:137.2);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (70.6:108.1:197.2);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (73.3:111.9:193.1);
      specparam TAA_2  = (75.7:116.1:202.3);
      specparam TAA_3  = (73.3:111.9:193.1);
      specparam TAA_4  = (70.5:107.2:183.4);
      specparam TRC  = (70.6:108.1:197.2);
      specparam TRC_2    = (70.6:108.1:197.2);
      specparam TRC_3    = (70.6:108.1:197.2);
      specparam TRC_4    = (70.6:108.1:197.2);
      ...
      specparam TNAP_CSH  = (33.2:44.4:65.3);
      specparam TDVSES  = (13.5:15.6:23.2);
      specparam TDVSEH  = (58.3:90.7:156.2);
      specparam TDVSS   = (13.5:15.6:23.2);
      specparam TDVSH   = (58.3:90.7:156.2);
