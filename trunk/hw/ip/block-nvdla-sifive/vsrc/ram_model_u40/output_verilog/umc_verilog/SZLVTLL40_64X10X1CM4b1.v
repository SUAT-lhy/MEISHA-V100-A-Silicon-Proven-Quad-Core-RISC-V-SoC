...
module SZLVTLL40_64X10X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (44.8:68.8:132.2);
  parameter  Tw2r                 = (52.1:76.7:154.0);
  parameter  TOH                  = (30.7:46.7:79.5); 
  parameter  TOH_12               = (30.7:46.7:79.5); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (52.1:76.7:136.8);
`else
`endif
  parameter  TSLP_Q               = (54.9:81.8:134.3);
  parameter  TRET_Q               = (50.1:75.3:124.2);
  parameter  TSLP_Wakeup          = 469.2;            
  parameter  TRET_Wakeup          = 448.3;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (51.1:76.2:124.7);
      specparam TDEFAULT    = (51.1:76.2:124.7);
      specparam TAA_12  = (51.1:76.2:124.7);
      specparam TRC  = (52.1:76.7:136.8);
      specparam TRC_12    = (52.1:76.7:136.8);
      specparam THPW = (9.0:14.6:23.9);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.3:15.2:25.5);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (16.0:19.4:32.8);
      specparam TWH  = (4.8:5.9:10.3);
      specparam TDS  = (16.7:21.1:36.7);
      specparam TDH  = (5.1:3.7:3.8);
      specparam TCSS = (15.8:23.3:41.6);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (218.8:305.2:469.2);
      specparam TRET_CSH  = (213.8:291.4:448.3);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.4:138.6);
      specparam TDVSES  = (15.8:23.3:41.6);
      specparam TDVSEH  = (43.1:69.4:119.3);
      specparam TDVSS   = (15.8:23.3:41.6);
      specparam TDVSH   = (43.1:69.4:119.3);
