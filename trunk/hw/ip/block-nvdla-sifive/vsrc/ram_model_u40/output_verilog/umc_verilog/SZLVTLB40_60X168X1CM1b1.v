...
module SZLVTLB40_60X168X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (52.5:76.4:149.2);
  parameter  Tw2r                 = (60.7:90.8:185.7);
  parameter  TOH                  = (43.3:66.2:116.2);
  parameter  TOH_2                = (44.8:68.8:121.9);
  parameter  TOH_3                = (43.3:66.2:116.2);
  parameter  TOH_4                = (41.6:63.3:110.1);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (60.7:90.8:168.0);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (62.1:94.5:161.5);
      specparam TAA_2  = (63.5:97.0:167.1);
      specparam TAA_3  = (62.1:94.5:161.5);
      specparam TAA_4  = (60.3:91.5:155.4);
      specparam TRC  = (60.7:90.8:168.0);
      specparam TRC_2    = (60.7:90.8:168.0);
      specparam TRC_3    = (60.7:90.8:168.0);
      specparam TRC_4    = (60.7:90.8:168.0);
      specparam THPW = (9.3:15.1:25.0);
      specparam TLPW = (19.7:22.5:35.8);
      specparam TAS  = (13.1:15.1:22.5);
      specparam TAH  = (13.1:16.5:23.0);
      specparam TWS  = (11.0:14.3:25.8);
      specparam TWH  = (9.8:13.1:20.3);
      specparam TDS  = (15.2:19.0:33.6);
      specparam TDH  = (8.2:7.5:8.2);
      specparam TCSS = (20.0:24.1:39.5);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.8);
      specparam TNAP_CSH  = (25.0:33.1:50.5);
      specparam TDVSES  = (13.1:15.1:22.5);
      specparam TDVSEH  = (41.4:66.2:115.0);
      specparam TDVSS   = (13.1:15.1:22.5);
      specparam TDVSH   = (41.4:66.2:115.0);
