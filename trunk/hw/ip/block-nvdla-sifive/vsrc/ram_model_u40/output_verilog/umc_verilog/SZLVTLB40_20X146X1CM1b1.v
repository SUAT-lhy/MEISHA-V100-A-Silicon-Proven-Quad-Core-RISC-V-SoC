...
module SZLVTLB40_20X146X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (47.4:68.1:131.3);
  parameter  Tw2r                 = (55.9:82.7:170.8);
  parameter  TOH                  = (38.0:57.6:99.7); 
  parameter  TOH_2                = (38.9:59.2:103.2);
  parameter  TOH_3                = (38.0:57.6:99.7); 
  parameter  TOH_4                = (36.9:55.8:95.8); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (55.9:82.7:153.8);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (56.6:85.6:144.6);
      specparam TAA_2  = (57.5:87.2:148.2);
      specparam TAA_3  = (56.6:85.6:144.6);
      specparam TAA_4  = (55.5:83.8:140.8);
      specparam TRC  = (55.9:82.7:153.8);
      specparam TRC_2    = (55.9:82.7:153.8);
      specparam TRC_3    = (55.9:82.7:153.8);
      specparam TRC_4    = (55.9:82.7:153.8);
      specparam THPW = (9.1:14.8:24.6);
      specparam TLPW = (19.7:22.5:35.8);
      specparam TAS  = (12.6:14.2:21.0);
      specparam TAH  = (13.1:16.5:23.0);
      specparam TWS  = (11.0:14.2:25.6);
      specparam TWH  = (9.6:13.0:20.1);
      specparam TDS  = (15.3:19.2:33.8);
      specparam TDH  = (7.8:7.0:7.5);
      specparam TCSS = (19.5:23.2:38.0);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.8);
      specparam TNAP_CSH  = (20.8:27.4:41.3);
      specparam TDVSES  = (12.6:14.2:21.0);
      specparam TDVSEH  = (34.2:55.2:95.2);
      specparam TDVSS   = (12.6:14.2:21.0);
      specparam TDVSH   = (34.2:55.2:95.2);
