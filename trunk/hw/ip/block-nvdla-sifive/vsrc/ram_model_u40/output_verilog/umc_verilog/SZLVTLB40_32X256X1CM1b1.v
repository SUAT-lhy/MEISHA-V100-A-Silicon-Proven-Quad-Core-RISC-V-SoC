...
module SZLVTLB40_32X256X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (52.8:77.5:143.9);
  parameter  Tw2r                 = (62.0:93.6:185.2);
  parameter  TOH                  = (43.8:66.2:114.0);
  parameter  TOH_2                = (45.0:68.1:118.2);
  parameter  TOH_3                = (43.8:66.2:114.0);
  parameter  TOH_4                = (42.5:64.0:109.4);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (62.0:93.6:170.1);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (63.3:95.3:160.2);
      specparam TAA_2  = (64.5:97.2:164.4);
      specparam TAA_3  = (63.3:95.3:160.2);
      specparam TAA_4  = (62.0:93.1:155.6);
      specparam TRC  = (62.0:93.6:170.1);
      specparam TRC_2    = (62.0:93.6:170.1);
      specparam TRC_3    = (62.0:93.6:170.1);
      specparam TRC_4    = (62.0:93.6:170.1);
      ...
      specparam TNAP_CSH  = (24.8:32.4:46.6);
      specparam TDVSES  = (13.1:15.1:22.4);
      specparam TDVSEH  = (47.6:73.1:121.8);
      specparam TDVSS   = (13.1:15.1:22.4);
      specparam TDVSH   = (47.6:73.1:121.8);
