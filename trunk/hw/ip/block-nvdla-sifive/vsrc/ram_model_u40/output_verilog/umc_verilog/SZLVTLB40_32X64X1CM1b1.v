...
module SZLVTLB40_32X64X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (46.5:67.2:131.9);
  parameter  Tw2r                 = (54.1:80.9:169.8);
  parameter  TOH                  = (36.4:55.8:97.8); 
  parameter  TOH_2                = (37.5:57.7:102.0);
  parameter  TOH_3                = (36.4:55.8:97.8); 
  parameter  TOH_4                = (35.2:53.6:93.3); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (54.1:80.9:149.5);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (54.7:83.4:142.3);
      specparam TAA_2  = (55.8:85.3:146.5);
      specparam TAA_3  = (54.7:83.4:142.3);
      specparam TAA_4  = (53.4:81.2:137.7);
      specparam TRC  = (54.1:80.9:149.5);
      specparam TRC_2    = (54.1:80.9:149.5);
      specparam TRC_3    = (54.1:80.9:149.5);
      specparam TRC_4    = (54.1:80.9:149.5);
      ...
      specparam TNAP_CSH  = (20.2:27.7:44.1);
      specparam TDVSES  = (13.1:15.1:22.4);
      specparam TDVSEH  = (28.5:48.2:86.4);
      specparam TDVSS   = (13.1:15.1:22.4);
      specparam TDVSH   = (28.5:48.2:86.4);
