...
module SZLVTLL40_128X18X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (49.4:75.1:143.4);
  parameter  Tw2r                 = (54.6:81.4:165.0);
  parameter  TOH                  = (35.5:53.7:92.0); 
  parameter  TOH_12               = (35.5:53.7:92.0); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (54.6:81.4:144.7);
`else
`endif
  parameter  TSLP_Q               = (60.3:89.0:148.3);
  parameter  TRET_Q               = (55.5:83.0:137.9);
  parameter  TSLP_Wakeup          = 531.0;            
  parameter  TRET_Wakeup          = 499.9;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (55.4:82.3:135.8);
      specparam TDEFAULT    = (55.4:82.3:135.8);
      specparam TAA_12  = (55.4:82.3:135.8);
      specparam TRC  = (54.6:81.4:144.7);
      specparam TRC_12    = (54.6:81.4:144.7);
      specparam THPW = (8.7:14.3:23.2);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (11.7:16.0:27.0);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (15.5:19.9:34.5);
      specparam TWH  = (2.5:4.5:9.0);
      specparam TDS  = (17.4:21.9:38.0);
      specparam TDH  = (5.6:4.2:4.0);
      specparam TCSS = (17.2:23.9:42.7);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (246.5:346.8:531.0);
      specparam TRET_CSH  = (236.2:322.2:499.9);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.4:102.6:142.6);
      specparam TDVSES  = (17.2:23.9:42.7);
      specparam TDVSEH  = (52.1:82.2:142.9);
      specparam TDVSS   = (17.2:23.9:42.7);
      specparam TDVSH   = (52.1:82.2:142.9);
