...
module SZLVTLB40_4X64X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (44.0:63.0:116.2);
  parameter  Tw2r                 = (51.7:76.9:160.4);
  parameter  TOH                  = (34.0:51.6:88.6); 
  parameter  TOH_2                = (35.5:54.4:93.2); 
  parameter  TOH_3                = (34.0:51.6:88.6); 
  parameter  TOH_4                = (33.2:50.2:86.0); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (51.7:76.9:142.7);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (52.2:79.2:133.2);
      specparam TAA_2  = (53.8:82.0:138.6);
      specparam TAA_3  = (52.2:79.2:133.2);
      specparam TAA_4  = (51.4:77.8:130.4);
      specparam TRC  = (51.7:76.9:142.7);
      specparam TRC_2    = (51.7:76.9:142.7);
      specparam TRC_3    = (51.7:76.9:142.7);
      specparam TRC_4    = (51.7:76.9:142.7);
