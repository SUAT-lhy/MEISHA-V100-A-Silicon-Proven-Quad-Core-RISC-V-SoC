...
module SZLVTLL40_160X16X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (49.5:75.2:137.5);
  parameter  Tw2r                 = (54.6:80.6:160.8);
  parameter  TOH                  = (35.6:53.7:91.6); 
  parameter  TOH_12               = (35.6:53.7:91.6); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (54.6:80.6:143.6);
`else
`endif
  parameter  TSLP_Q               = (61.9:91.6:150.3);
  parameter  TRET_Q               = (57.1:85.2:140.2);
  parameter  TSLP_Wakeup          = 522.9;            
  parameter  TRET_Wakeup          = 492.0;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (55.7:82.8:136.5);
      specparam TDEFAULT    = (55.7:82.8:136.5);
      specparam TAA_12  = (55.7:82.8:136.5);
      specparam TRC  = (54.6:80.6:143.6);
      specparam TRC_12    = (54.6:80.6:143.6);
      specparam THPW = (9.4:15.1:24.1);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.7:15.7:26.4);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (15.8:19.1:32.3);
      specparam TWH  = (5.2:6.5:11.2);
      specparam TDS  = (16.5:20.6:36.0);
      specparam TDH  = (5.6:4.4:4.8);
      specparam TCSS = (16.2:23.9:42.5);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (242.8:343.3:522.9);
      specparam TRET_CSH  = (233.8:318.8:492.0);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.6:139.9);
      specparam TDVSES  = (16.2:23.9:42.5);
      specparam TDVSEH  = (52.7:82.9:143.1);
      specparam TDVSS   = (16.2:23.9:42.5);
      specparam TDVSH   = (52.7:82.9:143.1);
