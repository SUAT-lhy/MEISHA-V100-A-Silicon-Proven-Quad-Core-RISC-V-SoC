...
module SZLVTLL40_80X65X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (51.6:78.3:136.0);
  parameter  Tw2r                 = (56.0:82.7:166.1);
  parameter  TOH                  = (39.0:58.5:99.0); 
  parameter  TOH_12               = (39.0:58.5:99.0); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (56.0:82.7:149.5);
`else
`endif
  parameter  TSLP_Q               = (99.1:143.0:235.6);
  parameter  TRET_Q               = (94.3:137.0:225.2);
  parameter  TSLP_Wakeup          = 646.4;            
  parameter  TRET_Wakeup          = 602.5;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (59.1:87.5:143.1);
      specparam TDEFAULT    = (59.1:87.5:143.1);
      specparam TAA_12  = (59.1:87.5:143.1);
      specparam TRC  = (56.0:82.7:149.5);
      specparam TRC_12    = (56.0:82.7:149.5);
      specparam THPW = (8.7:14.3:23.2);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (11.7:15.9:26.8);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (14.9:19.1:33.1);
      specparam TWH  = (4.1:6.7:12.3);
      specparam TDS  = (16.0:19.8:34.6);
      specparam TDH  = (7.9:7.4:9.0);
      specparam TCSS = (16.5:23.9:42.6);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (302.2:428.2:646.4);
      specparam TRET_CSH  = (291.1:393.1:602.5);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.4:102.3:141.0);
      specparam TDVSES  = (16.5:23.9:42.6);
      specparam TDVSEH  = (57.1:89.2:152.8);
      specparam TDVSS   = (16.5:23.9:42.6);
      specparam TDVSH   = (57.1:89.2:152.8);
