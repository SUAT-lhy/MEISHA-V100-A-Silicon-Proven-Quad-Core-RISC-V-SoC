...
module SZLVTLB40_248X258X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (75.1:114.1:224.5);
  parameter  Tw2r                 = (82.2:127.0:251.0);
  parameter  TOH                  = (65.4:102.3:185.7);
  parameter  TOH_2                = (69.5:109.4:201.2);
  parameter  TOH_3                = (65.4:102.3:185.7);
  parameter  TOH_4                = (61.0:94.6:169.7);
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (82.2:127.0:230.1);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (84.9:131.3:231.9);
      specparam TAA_2  = (89.0:138.4:247.4);
      specparam TAA_3  = (84.9:131.3:231.9);
      specparam TAA_4  = (80.5:123.7:215.9);
      specparam TRC  = (82.2:127.0:230.1);
      specparam TRC_2    = (82.2:127.0:230.1);
      specparam TRC_3    = (82.2:127.0:230.1);
      specparam TRC_4    = (82.2:127.0:230.1);
      specparam THPW = (9.3:15.1:24.9);
      specparam TLPW = (19.7:22.5:35.7);
      specparam TAS  = (14.0:16.3:24.3);
      ...
      specparam TCSS = (20.9:25.3:41.3);
      specparam TCSH = (17.2:23.3:39.1);
      specparam TNAPH  = (8.4:18.6:35.9);
      specparam TNAP_CSH  = (42.1:57.0:85.7);
      specparam TDVSES  = (14.0:16.3:24.3);
      specparam TDVSEH  = (70.8:111.4:197.2);
      specparam TDVSS   = (14.0:16.3:24.3);
      specparam TDVSH   = (70.8:111.4:197.2);
