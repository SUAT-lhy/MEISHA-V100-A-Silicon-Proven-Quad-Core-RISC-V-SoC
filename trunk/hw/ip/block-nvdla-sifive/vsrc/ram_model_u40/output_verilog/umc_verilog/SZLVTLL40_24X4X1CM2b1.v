...
module SZLVTLL40_24X4X1CM2b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (43.3:67.9:126.7);
  parameter  Tw2r                 = (50.4:74.7:153.2);
  parameter  TOH                  = (29.1:44.3:75.4); 
  parameter  TOH_12               = (29.1:44.3:75.4); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (50.4:74.7:133.3);
`else
`endif
  parameter  TSLP_Q               = (47.4:70.9:118.8);
  parameter  TRET_Q               = (42.6:64.8:108.3);
  parameter  TSLP_Wakeup          = 432.3;            
  parameter  TRET_Wakeup          = 419.0;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (49.1:73.2:119.4);
      specparam TDEFAULT    = (49.1:73.2:119.4);
      specparam TAA_12  = (49.1:73.2:119.4);
      specparam TRC  = (50.4:74.7:133.3);
      specparam TRC_12    = (50.4:74.7:133.3);
      specparam THPW = (8.4:14.0:23.2);
      specparam TLPW = (21.2:24.9:37.9);
      specparam TAS  = (11.3:15.4:26.0);
      specparam TAH  = (11.3:15.7:22.3);
      specparam TWS  = (15.8:20.4:35.3);
      specparam TWH  = (1.9:3.7:7.8);
      specparam TDS  = (17.9:22.7:39.4);
      specparam TDH  = (4.8:3.2:2.4);
      specparam TCSS = (17.5:23.3:41.7);
      specparam TCSH = (16.9:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.2);
      specparam TRETH  = (7.6:16.9:33.2);
      specparam TSLP_CSH  = (203.1:280.2:432.3);
      specparam TRET_CSH  = (199.0:271.9:419.0);
      specparam TNAPH  = (7.6:16.9:33.2);
      specparam TNAP_CSH  = (84.3:102.1:139.7);
      specparam TDVSES  = (17.5:23.3:41.7);
      specparam TDVSEH  = (40.4:65.1:112.3);
      specparam TDVSS   = (17.5:23.3:41.7);
      specparam TDVSH   = (40.4:65.1:112.3);
