...
module SZLVTLL40_64X14X1CM4b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,RET,SLP,NAP);
  ...
  parameter  Tr2w                 = (45.4:69.7:134.5);
  parameter  Tw2r                 = (52.6:77.3:155.0);
  parameter  TOH                  = (31.3:47.6:80.9); 
  parameter  TOH_12               = (31.3:47.6:80.9); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (52.6:77.3:137.7);
`else
`endif
  parameter  TSLP_Q               = (59.6:88.4:145.0);
  parameter  TRET_Q               = (54.8:81.8:134.8);
  parameter  TSLP_Wakeup          = 487.9;            
  parameter  TRET_Wakeup          = 464.5;            
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (51.7:77.1:126.1);
      specparam TDEFAULT    = (51.7:77.1:126.1);
      specparam TAA_12  = (51.7:77.1:126.1);
      specparam TRC  = (52.6:77.3:137.7);
      specparam TRC_12    = (52.6:77.3:137.7);
      specparam THPW = (9.0:14.7:23.9);
      specparam TLPW = (21.4:24.9:38.1);
      specparam TAS  = (11.3:15.2:25.5);
      specparam TAH  = (11.8:16.1:22.9);
      specparam TWS  = (15.9:19.2:32.5);
      specparam TWH  = (5.0:6.3:10.8);
      specparam TDS  = (16.5:20.8:36.2);
      specparam TDH  = (5.4:4.2:4.4);
      specparam TCSS = (15.8:23.3:41.6);
      specparam TCSH = (17.0:22.8:37.0);
      specparam TSLPH  = (7.6:16.9:33.3);
      specparam TRETH  = (7.6:16.9:33.3);
      specparam TSLP_CSH  = (226.9:317.7:487.9);
      specparam TRET_CSH  = (221.7:301.9:464.5);
      specparam TNAPH  = (7.6:16.9:33.3);
      specparam TNAP_CSH  = (83.8:101.4:138.7);
      specparam TDVSES  = (15.8:23.3:41.6);
      specparam TDVSEH  = (44.1:70.8:121.5);
      specparam TDVSS   = (15.8:23.3:41.6);
      specparam TDVSH   = (44.1:70.8:121.5);
