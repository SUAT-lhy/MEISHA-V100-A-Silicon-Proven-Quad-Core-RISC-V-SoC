...
module SZLVTLB40_32X130X1CM1b1 (A,B,DO,DI,CKA,CKB,CSAN,DVSE,DVS,WEB,CSBN,NAP);
  ...
  parameter  Tr2w                 = (48.4:69.8:135.6);
  parameter  Tw2r                 = (56.6:84.0:174.2);
  parameter  TOH                  = (38.8:59.2:103.1);
  parameter  TOH_2                = (39.9:61.0:107.2);
  parameter  TOH_3                = (38.8:59.2:103.1);
  parameter  TOH_4                = (37.5:57.0:98.5); 
`ifdef TRC_CHECK
  parameter  TRC_PERIOD           = (56.6:84.0:155.9);
`else
`endif
...
`endif
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA    = (57.3:87.1:147.9);
      specparam TAA_2  = (58.4:88.9:152.0);
      specparam TAA_3  = (57.3:87.1:147.9);
      specparam TAA_4  = (56.1:84.9:143.4);
      specparam TRC  = (56.6:84.0:155.9);
      specparam TRC_2    = (56.6:84.0:155.9);
      specparam TRC_3    = (56.6:84.0:155.9);
      specparam TRC_4    = (56.6:84.0:155.9);
      ...
      specparam TDVSEH  = (34.3:55.9:97.4);
      specparam TDVSS   = (13.1:15.1:22.4);
      specparam TDVSH   = (34.3:55.9:97.4);
