...
#define ON_CHIP_SRAM_ADDR _AC(0x50000000,UL)
#define ON_CHIP_SRAM_SIZE _AC(0x80000,UL)
#define SOC_LSYS_ADDR _AC(0x51000000,UL)
#define SOC_LSYS_SIZE _AC(0x1000,UL)
#define SPI1_ADDR _AC(0x52000000,UL)
#define SPI1_SIZE _AC(0x1000,UL)
...
#define SRAM_REG(offset) _REG32(ON_CHIP_SRAM_ADDR, offset)
#define LSYS_REG(offset) _REG32(SOC_LSYS_ADDR, offset)
#define SPI1_REG(offset) _REG32(SPI1_ADDR, offset)
...
#define SRAM_REG64(offset) _REG64(ON_CHIP_SRAM_ADDR, offset)
#define LSYS_REG64(offset) _REG64(SOC_LSYS_ADDR, offset)
#define SPI1_REG64(offset) _REG64(SPI1_ADDR, offset)
