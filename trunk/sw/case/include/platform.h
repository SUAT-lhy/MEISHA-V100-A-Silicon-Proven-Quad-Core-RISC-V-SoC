...
#define AXI_PCIE_CTRL_ADDR _AC(0x2000000000,UL)
#define AXI_PCIE_CTRL_SIZE _AC(0x4000000,UL)
...
#define MEMORY_REG(offset) _REG32(MEMORY_MEM_ADDR, offset)
...
#define MEMORY_REG64(offset) _REG64(MEMORY_MEM_ADDR, offset)
